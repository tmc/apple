...
type NSAccessibilityElementLoading interface {
	...
	AccessibilityElementWithToken(token NSAccessibilityLoadingToken) INSAccessibilityElement
}
...
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityElementLoading/accessibilityElement(withToken:)
func (o NSAccessibilityElementLoadingObject) AccessibilityElementWithToken(token NSAccessibilityLoadingToken) INSAccessibilityElement {
