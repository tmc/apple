...
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityRadioButton
type NSAccessibilityRadioButton interface {
	...
	//
	// SDK narrowing: NSAccessibilityRadioButton declares this as - (nullable NSNumber *)accessibilityValue.
...
func (o NSAccessibilityRadioButtonObject) BaseObject() objectivec.Object {
	return o.Object
}
...
func NSAccessibilityRadioButtonObjectFromID(id objc.ID) NSAccessibilityRadioButtonObject {
	return NSAccessibilityRadioButtonObject{
...
// Go has no covariance, so the base declaration on NSAccessibility (rendered on INSView) is used.
// Convert with foundation.NSNumberFromID(v.GetID()) to recover the narrowed type.
func (o NSAccessibilityRadioButtonObject) AccessibilityValue() objectivec.IObject {
