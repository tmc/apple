...
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilitySwitch
type NSAccessibilitySwitch interface {
	...
	//
	// SDK narrowing: NSAccessibilitySwitch declares this as - (nullable NSString *)accessibilityValue.
...
func (o NSAccessibilitySwitchObject) BaseObject() objectivec.Object {
	return o.Object
}
...
func NSAccessibilitySwitchObjectFromID(id objc.ID) NSAccessibilitySwitchObject {
	return NSAccessibilitySwitchObject{
...
// Go has no covariance, so the base declaration on NSAccessibility (rendered on INSView) is used.
// Convert with foundation.NSStringFromID(v.GetID()) to recover the narrowed type.
func (o NSAccessibilitySwitchObject) AccessibilityValue() objectivec.IObject {
