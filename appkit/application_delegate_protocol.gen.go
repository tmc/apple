...
// reasons, a return value of false is equivalent to [NSTerminateCancel], and
// a return value of true is equivalent to [NSTerminateNow].
//
// # Discussion
//
...
// # Return Value
//
// true if you want the application to perform its normal tasks or false if
// you want the application to do nothing.
//
// # Discussion
//
...
// # Return Value
//
// true to enable automatic shortcut localization for all app-specific menus,
// or false to handle shortcut localization yourself.
//
// # Discussion
//
...
// true, the system automatically remaps all app-specific menu shortcuts that
// are unreachable on the current keyboard. The system doesn’t remap
...
// false to disable the automatic remapping behavior. When you return false,
// the system doesn’t change your app’s shortcuts. Instead, you are
...
// # Return Value
//
// true if you notify the user that your app is about to continue the activity
// or false if you want AppKit to notify the user.
//
// # Discussion
//
...
// # Return Value
//
// true if this method handled continuing the activity; false to have AppKit
// attempt to continue the activity.
//
// # Discussion
//
...
// method returns false, or if it is unimplemented. It does this by creating a
// document of the appropriate type using the URL stored in the [userInfo]
...
// the file `filename`, returning true if the file is successfully opened, and
// false otherwise. If the user started up the application by double-clicking
// a file, the delegate receives the [ApplicationOpenFile] message before
