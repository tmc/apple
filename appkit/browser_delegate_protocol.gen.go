...
// # Return Value
//
// true if the column’s contents are valid; otherwise, false. If false is
// returned, `sender` reloads the column.
//
// # Discussion
//
...
// # Return Value
//
// true to allow the dragging operation to proceed (see discussion for further
// details); false to disallow it.
//
// # Discussion
//
// This method is called after a drag operation has been allowed to start
// ([BrowserCanDragRowsWithIndexesInColumnWithEvent] returns true), but before
// it actually begins.
//
...
// [NSBrowserNoColumnResizing] or [NSBrowserUserColumnResizing] (see
