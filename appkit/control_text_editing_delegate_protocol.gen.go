...
func (o NSControlTextEditingDelegateObject) BaseObject() objectivec.Object {
	return o.Object
}
...
func NSControlTextEditingDelegateObjectFromID(id objc.ID) NSControlTextEditingDelegateObject {
	return NSControlTextEditingDelegateObject{
...
func (o NSControlTextEditingDelegateObject) ControlIsValidObject(control INSControl, obj objectivec.IObject) bool {
...
func (o NSControlTextEditingDelegateObject) ControlDidFailToValidatePartialStringErrorDescription(control INSControl, string_ string, error_ string) {
...
func (o NSControlTextEditingDelegateObject) ControlDidFailToFormatStringErrorDescription(control INSControl, string_ string, error_ string) bool {
...
func (o NSControlTextEditingDelegateObject) ControlTextShouldBeginEditing(control INSControl, fieldEditor INSText) bool {
...
func (o NSControlTextEditingDelegateObject) ControlTextShouldEndEditing(control INSControl, fieldEditor INSText) bool {
...
func (o NSControlTextEditingDelegateObject) ControlTextViewDoCommandBySelector(control INSControl, textView INSTextView, commandSelector objc.SEL) bool {
...
func (o NSControlTextEditingDelegateObject) ControlTextDidBeginEditing(obj foundation.NSNotification) {
...
func (o NSControlTextEditingDelegateObject) ControlTextDidChange(obj foundation.NSNotification) {
...
func (o NSControlTextEditingDelegateObject) ControlTextDidEndEditing(obj foundation.NSNotification) {
...
//
// [Apple Documentation]: https://developer.apple.com/documentation/appkit/nscontroltexteditingdelegate
type NSControlTextEditingDelegateConfig struct {

	// Responding to Text Editing
	// ControlTextShouldBeginEditing — Invoked when the user tries to enter a character in a cell of a control that allows editing of text (such as a text field or form field).
	ControlTextShouldBeginEditing func(control NSControl, fieldEditor NSText) bool
	// ControlTextShouldEndEditing — Invoked when the insertion point tries to leave a cell of the control that has been edited.
	ControlTextShouldEndEditing func(control NSControl, fieldEditor NSText) bool

	// Instance Methods
	// ControlTextDidBeginEditing — Tells the delegate that the control started editing its text content.
	ControlTextDidBeginEditing func(obj foundation.NSNotification)
	// ControlTextDidChange — Tells the delegate that the control made changes to its text content.
	ControlTextDidChange func(obj foundation.NSNotification)
	// ControlTextDidEndEditing — Tells the delegate that the control finished editing its text content and committed the changes.
	ControlTextDidEndEditing func(obj foundation.NSNotification)
}

// NewNSControlTextEditingDelegate creates an Objective-C object implementing the [NSControlTextEditingDelegate] protocol.
//
// Each call registers a unique Objective-C class containing only the methods
// set in config. This means [NSObject.RespondsToSelector] works correctly
// for optional delegate methods — only non-nil callbacks are registered.
//
// The returned [NSControlTextEditingDelegateObject] satisfies the [NSControlTextEditingDelegate] interface
// and can be passed directly to SetDelegate and similar methods.
//
// See [Apple Documentation] for protocol details.
//
// [Apple Documentation]: https://developer.apple.com/documentation/appkit/nscontroltexteditingdelegate
func NewNSControlTextEditingDelegate(config NSControlTextEditingDelegateConfig) NSControlTextEditingDelegateObject {
	n := delegateClassCounter.Add(1)
	className := fmt.Sprintf("GoNSControlTextEditingDelegate_%d", n)

	var methods []objc.MethodDef

	if config.ControlTextShouldBeginEditing != nil {
		fn := config.ControlTextShouldBeginEditing
	...
	if config.ControlTextShouldEndEditing != nil {
		fn := config.ControlTextShouldEndEditing
		methods = append(methods, objc.MethodDef{
	...
	if config.ControlTextDidBeginEditing != nil {
		fn := config.ControlTextDidBeginEditing
		methods = append(methods, objc.MethodDef{
	...
	if config.ControlTextDidChange != nil {
		fn := config.ControlTextDidChange
		methods = append(methods, objc.MethodDef{
	...
	if config.ControlTextDidEndEditing != nil {
		fn := config.ControlTextDidEndEditing
		methods = append(methods, objc.MethodDef{
	...
	proto := objc.GetProtocol("NSControlTextEditingDelegate")
	...
	if err != nil {
		panic(fmt.Sprintf("NewNSControlTextEditingDelegate: RegisterClass %s: %v", className, err))
	}
