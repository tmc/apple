...
func (nc NSButtonClass) Class() objc.Class {
	return nc.class
}
...
// # Discussion
//
// The value of this property is true if the button has three states (on, off,
// and mixed), or false if the button has two states (on and off). The default
// value is false. On and off states (also referred to as alternate and
// normal) indicate that the button is either clicked or not clicked. Mixed
// state is typically used for checkboxes or radio buttons. For example,
