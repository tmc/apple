...
// [ContinueTrackingAtInView] is invoked until either the method returns false
// or the mouse is released. Finally, [StopTrackingAtInViewMouseIsUp] is
// invoked if the mouse is released. If `untilMouseUp` is true, it’s invoked
// when the mouse button goes up while the cursor is anywhere. If
// `untilMouseUp` is false, it’s invoked when the mouse button goes up while
// the cursor is within `cellFrame`. You usually override one or more of these
// methods to respond to specific mouse events.
//
...
// implementation returns true if the cell is set to continuously send action
// messages to its target when the mouse button is down or the mouse is being
// dragged. Subclasses can override this method to provide more sophisticated
// tracking behavior.
//
...
// property, which must not be [NSFocusRingTypeNone] unless you want to
...
// if it does not. This property is mutually exclusive with the [Bezeled]
// property—that is, a cell’s border can be plain or bezeled but not both.
// Changing the value of this property automatically removes any bezel that
...
// value of this property to true is equivalent to setting the [LineBreakMode]
...
// from [Wraps], interprets [NSLineBreakByWordWrapping] and
// [NSLineBreakByCharWrapping] returned by [LineBreakMode] as
...
func (o NSCell) SetAccessibilityContents(accessibilityContents objectivec.IObject) {
...
func (o NSCell) SetAccessibilityChildren(accessibilityChildren objectivec.IObject) {
...
func (o NSCell) AccessibilityChildrenInNavigationOrder() foundation.INSArray {
...
func (o NSCell) SetAccessibilityChildrenInNavigationOrder(accessibilityChildrenInNavigationOrder objectivec.IObject) {
...
func (o NSCell) SetAccessibilitySelectedChildren(accessibilitySelectedChildren objectivec.IObject) {
...
func (o NSCell) SetAccessibilityVisibleChildren(accessibilityVisibleChildren objectivec.IObject) {
...
func (o NSCell) SetAccessibilitySharedFocusElements(accessibilitySharedFocusElements objectivec.IObject) {
...
func (o NSCell) AccessibilityCustomActions() foundation.INSArray {
...
func (o NSCell) SetAccessibilityCustomActions(accessibilityCustomActions objectivec.IObject) {
...
func (o NSCell) AccessibilityCustomRotors() foundation.INSArray {
...
func (o NSCell) SetAccessibilityCustomRotors(accessibilityCustomRotors objectivec.IObject) {
...
func (o NSCell) AccessibilitySelectedTextRanges() foundation.INSArray {
...
func (o NSCell) SetAccessibilitySelectedTextRanges(accessibilitySelectedTextRanges objectivec.IObject) {
...
func (o NSCell) SetAccessibilitySharedTextUIElements(accessibilitySharedTextUIElements objectivec.IObject) {
...
func (o NSCell) SetAccessibilityWindows(accessibilityWindows objectivec.IObject) {
...
func (o NSCell) SetAccessibilityColumnHeaderUIElements(accessibilityColumnHeaderUIElements objectivec.IObject) {
...
func (o NSCell) SetAccessibilityColumns(accessibilityColumns objectivec.IObject) {
...
func (o NSCell) SetAccessibilityColumnTitles(accessibilityColumnTitles objectivec.IObject) {
...
func (o NSCell) SetAccessibilityRowHeaderUIElements(accessibilityRowHeaderUIElements objectivec.IObject) {
...
func (o NSCell) SetAccessibilityRows(accessibilityRows objectivec.IObject) {
...
func (o NSCell) SetAccessibilitySelectedColumns(accessibilitySelectedColumns objectivec.IObject) {
...
func (o NSCell) SetAccessibilitySelectedRows(accessibilitySelectedRows objectivec.IObject) {
...
func (o NSCell) SetAccessibilityVisibleColumns(accessibilityVisibleColumns objectivec.IObject) {
...
func (o NSCell) SetAccessibilityVisibleRows(accessibilityVisibleRows objectivec.IObject) {
...
func (o NSCell) SetAccessibilitySelectedCells(accessibilitySelectedCells objectivec.IObject) {
...
func (o NSCell) SetAccessibilityVisibleCells(accessibilityVisibleCells objectivec.IObject) {
...
func (o NSCell) SetAccessibilityHandles(accessibilityHandles objectivec.IObject) {
...
func (o NSCell) AccessibilityAllowedValues() foundation.INSArray {
...
func (o NSCell) SetAccessibilityAllowedValues(accessibilityAllowedValues objectivec.IObject) {
...
func (o NSCell) SetAccessibilityLabelUIElements(accessibilityLabelUIElements objectivec.IObject) {
...
func (o NSCell) SetAccessibilityLabelValue(accessibilityLabelValue float32) {
...
func (o NSCell) SetAccessibilityNextContents(accessibilityNextContents objectivec.IObject) {
...
func (o NSCell) SetAccessibilityPreviousContents(accessibilityPreviousContents objectivec.IObject) {
...
func (o NSCell) SetAccessibilitySplitters(accessibilitySplitters objectivec.IObject) {
...
func (o NSCell) SetAccessibilityTabs(accessibilityTabs objectivec.IObject) {
...
func (o NSCell) SetAccessibilityMarkerUIElements(accessibilityMarkerUIElements objectivec.IObject) {
...
func (o NSCell) SetAccessibilityLinkedUIElements(accessibilityLinkedUIElements objectivec.IObject) {
...
func (o NSCell) SetAccessibilityServesAsTitleForUIElements(accessibilityServesAsTitleForUIElements objectivec.IObject) {
...
func (o NSCell) AccessibilityAttributedUserInputLabels() foundation.INSArray {
...
func (o NSCell) AccessibilityUserInputLabels() foundation.INSArray {
...
func (o NSCell) SetAccessibilityAttributedUserInputLabels(accessibilityAttributedUserInputLabels objectivec.IObject) {
...
func (o NSCell) SetAccessibilityUserInputLabels(accessibilityUserInputLabels objectivec.IObject) {
