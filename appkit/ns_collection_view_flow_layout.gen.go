...
func (nc NSCollectionViewFlowLayoutClass) Class() objc.Class {
	return nc.class
}
...
// [NSCollectionViewScrollDirectionVertical], the width of the content never
...
// [NSCollectionViewScrollDirectionHorizontal], the height never exceeds the
