...
func (nc NSCollectionViewItemClass) Class() objc.Class {
	return nc.class
}
...
// # Discussion
//
// The value of this property is true when the item is selected or false when
// it is not.
//
...
// the [NSCollectionViewItemHighlightNone] and
// [NSCollectionViewItemHighlightForSelection] states, but other states may be
// applied to indicate transient conditions. For example, the
// [NSCollectionViewItemHighlightForDeselection] state is applied during
// interactive selections when a currently selected item is about to be
// deselected.
//
...
func (o NSCollectionViewItem) SetIdentifier(value NSUserInterfaceItemIdentifier) {
