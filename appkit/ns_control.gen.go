...
// # Discussion
//
// The value of this property is true if the receiver ignores multiple clicks;
// otherwise, false.
//
...
// # Return Value
//
// The class of the cell used to manage the receiver’s contents, or `nil` if
// no cell class has been set for the receiver or its superclasses (up to
// NSControl).
//
