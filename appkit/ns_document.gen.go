...
// # Return Value
//
// false by default; subclasses can override to return true, thereby enabling
...
//
// waitSynchronously: If true, the method does not return until previous activities are complete
// and the passed-in block has been invoked. If false, the method might return
// before passed-in block is invoked. It might instead be invoked later, on
// the main thread, after previous activities are complete.
//
...
// the user was looking at a sheet presented by a previous activity, blocking
// of the main thread would prevent the handling of the user interface events
// necessary to dismiss that sheet and complete that previous activity.
...
// # Return Value
//
// false by default; subclasses can override to return true, thereby causing
// documents of the specified type to be read concurrently.
//
// # Discussion
//
...
// # Discussion
//
// The default value of this property is true, which signifies that the entire
// file is loaded into memory. You can override this property to return false
// if additional data needs to be read from the file. [NSDocument] may use
// this value to do things like prevent volume ejection or warn the user when
...
// # Discussion
//
// The value of this property is true if autosaving is in progress but nothing
// bad would happen if it were cancelled. For example, when periodic
...
// [NSAutosaveAsOperation] save operation type.
//
...
// # Return Value
//
// true if the receiving subclass of [NSDocument] supports Versions; otherwise
// false.
//
// # Discussion
//
...
// iCloud document storage entitlement
...
// true, the system adds new menu items and other UI for iCloud documents, as
// appropriate, and allows documents to be saved or moved into the primary
