...
func (nc NSOutlineViewClass) Class() objc.Class {
	return nc.class
}
...
// `someOutlineItem` and `index` as [NSOutlineViewDropOnItemIndex]. To specify
// a drop between child `2` and `3` of `someOutlineItem`, you specify `item`
// as `someOutlineItem` and `index` as `3` (children are a zero-based index).
// To specify a drop on an un-expandable `someOutlineItem`, you specify `item`
// as `someOutlineItem` and `index` as [NSOutlineViewDropOnItemIndex].
//
...
func (o NSOutlineView) TextDidBeginEditing(notification foundation.NSNotification) {
...
func (o NSOutlineView) TextDidChange(notification foundation.NSNotification) {
...
func (o NSOutlineView) TextShouldBeginEditing(textObject INSText) bool {
...
func (o NSOutlineView) TextShouldEndEditing(textObject INSText) bool {
...
// # Discussion
//
// When the value of this property is true, the indentation marker is indented
// along with the cell contents. When the value is false, the marker is always
// displayed left-justified in the column. The default value of this property
// is true.
//
