...
func (nc NSRuleEditorClass) Class() objc.Class {
	return nc.class
}
...
//
// extend: If false, the selected rows are specified by `indexes`. If true, the rows
// indicated by `indexes` are added to the collection of already selected
