...
func (nc NSScrollerClass) Class() objc.Class {
	return nc.class
}
...
// and later, this method no longer returns [NSScrollerIncrementLine] or
...
//
// flag: If `flag` is true, any scroll arrow button that falls within `slotRect` is
// drawn highlighted; otherwise it’s drawn normally.
//
// # Discussion
//
...
// which assumes a scroller style of [NSScrollerStyleLegacy], and
...
// this method no longer returns [NSScrollerIncrementLine] or
// [NSScrollerDecrementLine].
//
...
// [NSScrollerKnobStyleDefault] is appropriate for a wide range of content,
