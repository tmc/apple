...
func (nc NSScrubberLayoutClass) Class() objc.Class {
	return nc.class
}
...
// # Discussion
//
// If true, the scrubber invalidates its layout in response to a change of the
// visible region, in response to a user scroll action, or to the scrubber
