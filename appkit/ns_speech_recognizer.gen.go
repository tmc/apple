...
func (nc NSSpeechRecognizerClass) Class() objc.Class {
	return nc.class
}
...
// # Discussion
//
// When the value of this property is true, the speech recognizer’s commands
// are only recognized when the speech recognizer’s application is the
// frontmost application—typically the application displaying the menu bar.
// If the value of the property is false, the commands are recognized
...
// this property to true effectively takes over the computer at the expense of
// other applications using speech recognition, so you should use it only in
// circumstances that warrant it, such as when listening for a response
