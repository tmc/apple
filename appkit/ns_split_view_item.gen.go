...
// # Discussion
//
// If the value of this property is true, the split view item can temporarily
// expand during a drag if the user hovers or force clicks its neighboring
// divider.
//
// The default value of this property is false.
//
...
// A Boolean value that determines whether a window resize can collapse the
// child view controller that corresponds to the split view item.
//
// # Discussion
//
...
// # Discussion
//
// This property only applies to [NSSplitViewItemBehaviorSidebar] and
// [NSSplitViewItemBehaviorInspector]. The default value is true.
//
...
// [NSTitlebarSeparatorStyleAutomatic]. The containing window’s preference
