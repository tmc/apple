...
// depends on the value of the stack view’s [userInterfaceLayoutDirection]
...
// [userInterfaceLayoutDirection] method on your stack view instance.
// 
// To specify vertical layout, use the [NSStackView.Orientation] property and the
// [NSUserInterfaceLayoutOrientation.vertical] constant from the
...
// setting the view’s [isHidden] property to [true]), the view detaches from
// the stack view by default. Use the [NSStackView.DetachesHiddenViews] property to change
...
// [NSUserInterfaceLayoutOrientation.vertical]: https://developer.apple.com/documentation/AppKit/NSUserInterfaceLayoutOrientation/vertical
...
// [isHidden]: https://developer.apple.com/documentation/AppKit/NSView/isHidden
...
// [userInterfaceLayoutDirection]: https://developer.apple.com/documentation/AppKit/NSView/userInterfaceLayoutDirection
//
...
// value [false]. The views you provide in the `views` parameter are placed
// into the stack view’s leading gravity area.
//
...
// [NSUserInterfaceLayoutOrientation.horizontal] constant. - To specify
// vertical-axis hugging for any stack view (whether it uses vertical or
// horizontal layout), use the [NSUserInterfaceLayoutOrientation.vertical]
// constant.
// //
// [NSUserInterfaceLayoutOrientation.horizontal]: https://developer.apple.com/documentation/AppKit/NSUserInterfaceLayoutOrientation/horizontal
// [NSUserInterfaceLayoutOrientation.vertical]: https://developer.apple.com/documentation/AppKit/NSUserInterfaceLayoutOrientation/vertical
// [NSUserInterfaceLayoutOrientation]: https://developer.apple.com/documentation/AppKit/NSUserInterfaceLayoutOrientation
//
// # Discussion
...
// # Discussion
// 
// Default value is [NSUserInterfaceLayoutOrientation.horizontal]. For values
...
// [false] (the default) and whose hugging priority is left at [defaultLow]
// (the default), views within a gravity area remain a fixed distance from
// each other (equal to the value of the [Spacing] property), and the distance
...
// to [true] and use the default hugging priority, then the distance between
// all adjacent views, including adjacent views in neighboring gravity areas,
...
// # Discussion
// 
// When the value of this property is [true], setting the [isHidden] property
// of a view to [true] causes the stack view to remove hidden views from its
// view hierarchy and put them in the [DetachedViews] property. Changing the
// view’s [isHidden] property to [false] causes the stack view to add the
// view back to the view hierarchy. When the value of this property is
// [false], views remain in the view hierarchy, even when they are hidden. The
