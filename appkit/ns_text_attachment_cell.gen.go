...
func (t NSTextAttachmentCell) Attachment() INSTextAttachment {
...
func (t NSTextAttachmentCell) CellBaselineOffset() corefoundation.CGPoint {
	rv := objc.Send[corefoundation.CGPoint](t.ID, objc.Sel("cellBaselineOffset"))
...
func (t NSTextAttachmentCell) TrackMouseInRectOfViewAtCharacterIndexUntilMouseUp(theEvent INSEvent, cellFrame corefoundation.CGRect, controlView INSView, charIndex uint, flag bool) bool {
	rv := objc.Send[bool](t.ID, objc.Sel("trackMouse:inRect:ofView:atCharacterIndex:untilMouseUp:"), theEvent, cellFrame, controlView, charIndex, flag)
	return rv
}
...
func (t NSTextAttachmentCell) WantsToTrackMouse() bool {
	rv := objc.Send[bool](t.ID, objc.Sel("wantsToTrackMouse"))
	return rv
}
