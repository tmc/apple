...
// # Discussion
// 
// If the text field isn’t editable, this method returns [false]
// immediately. If the text field is editable and its delegate responds to
...
// and returns the result. If the delegate returns [false], the system beeps
// to indicate that the text field can’t validate the text. See [NSControl]
// for more information about the text delegate method.
//
// [false]: https://developer.apple.com/documentation/Swift/false
...
func (t NSTextField) EncodeWithCoder(coder foundation.INSCoder) {
...
// [Editable] to make the text field selectable and editable. If [false], the
// text is neither editable nor selectable.
//
// [false]: https://developer.apple.com/documentation/Swift/false
// [true]: https://developer.apple.com/documentation/Swift/true
//
...
// # Discussion
// 
// If [true], the user can select and edit text. If [false], the user can’t
// edit text, and the ability to select the text field’s content is
// dependent on the value of [Selectable].
// 
...
// # Discussion
// 
// If [true], the text field accepts dragged images; if [false], it doesn’t.
...
// uneditable text fields is [LineBreakStrategyStandard].
//
...
// # Discussion
// 
// If [true], the text field draws a bezel and sets [DrawsBackground] to
// [false]; if [false], it doesn’t draw a bezeled background.
//
// [false]: https://developer.apple.com/documentation/Swift/false
// [true]: https://developer.apple.com/documentation/Swift/true
//
