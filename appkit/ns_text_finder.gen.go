...
// For [NSTextFinderActionReplaceAll] actions, these methods may be called
...
// of the incremental matches. If false, then the incremental matches will not
// be highlighted automatically, but you can use incrementalMatchRanges to
