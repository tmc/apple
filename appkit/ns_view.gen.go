...
type INSView interface {
	...
	CornerConfiguration() unsafe.Pointer
	...
	EffectiveCornerRadii() unsafe.Pointer
	...
	ExclusiveGestureBehavior() NSViewExclusiveGestureBehavior
	SetExclusiveGestureBehavior(value NSViewExclusiveGestureBehavior)
	...
	TextSelectionManager() unsafe.Pointer
	SetTextSelectionManager(value unsafe.Pointer)
	...
	// Scrolls the view’s closest ancestor [NSClipView](<https://developer.apple.com/documentation/AppKit/NSClipView>) object proportionally to the distance of an event that occurs outside of it.
	...
	// Invalidates all cursor rectangles set up using [addCursorRect(_:cursor:)](<https://developer.apple.com/documentation/AppKit/NSView/addCursorRect(_:cursor:)>).
	DiscardCursorRects()
	// Displays the view and all its subviews if possible, invoking each of the [NSView] methods [lockFocus()](<https://developer.apple.com/documentation/AppKit/NSView/lockFocus()>), [draw(_:)](<https://developer.apple.com/documentation/AppKit/NSView/draw(_:)>), and [unlockFocus()](<https://developer.apple.com/documentation/AppKit/NSView/unlockFocus()>) as necessary.
	Display()
	// Displays the view and all its subviews if any part of the view has been marked as needing display.
	DisplayIfNeeded()
	// Acts as [displayIfNeeded()](<https://developer.apple.com/documentation/AppKit/NSView/displayIfNeeded()>), except that this method doesn’t back up to the first opaque ancestor—it simply causes the view and its descendants to execute their drawing code.
	DisplayIfNeededIgnoringOpacity()
	// Acts as [displayIfNeeded()](<https://developer.apple.com/documentation/AppKit/NSView/displayIfNeeded()>), confining drawing to a specified region of the view.
	DisplayIfNeededInRect(rect corefoundation.CGRect)
	// Acts as [displayIfNeeded()](<https://developer.apple.com/documentation/AppKit/NSView/displayIfNeeded()>), but confining drawing to `aRect` and not backing up to the first opaque ancestor—it simply causes the view and its descendants to execute their drawing code.
	...
	// Acts as [display()](<https://developer.apple.com/documentation/AppKit/NSView/display()>), but confining drawing to a rectangular region of the view.
	...
	// Returns by indirection a list of nonoverlapping rectangles that define the area the view is being asked to draw in [draw(_:)](<https://developer.apple.com/documentation/AppKit/NSView/draw(_:)>).
	...
	// Invoked by [printView(_:)](<https://developer.apple.com/documentation/AppKit/NSView/printView(_:)>) to determine the location of the region of the view being printed on the physical page.
	...
	// Scrolls the view’s closest ancestor [NSClipView](<https://developer.apple.com/documentation/AppKit/NSClipView>) object so a point in the view lies at the origin of the clip view’s bounds rectangle.
	ScrollPoint(point corefoundation.CGPoint)
	// Scrolls the view’s closest ancestor [NSClipView](<https://developer.apple.com/documentation/AppKit/NSClipView>) object the minimum distance needed so a specified region of the view becomes visible in the clip view.
	...
	SortSubviewsUsingFunctionContext(compare func(*NSView, *NSView, unsafe.Pointer) foundation.NSComparisonResult, context unsafe.Pointer)
...
func (v NSView) AccessibilityActivationPoint() corefoundation.CGPoint {
	rv := objc.Send[corefoundation.CGPoint](v.ID, objc.Sel("accessibilityActivationPoint"))
...
func (v NSView) AccessibilityAllowedValues() []foundation.NSNumber {
	rv := objc.Send[[]objc.ID](v.ID, objc.Sel("accessibilityAllowedValues"))
...
func (v NSView) AccessibilityApplicationFocusedUIElement() objectivec.IObject {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilityApplicationFocusedUIElement"))
...
func (v NSView) AccessibilityAttributedStringForRange(range_ foundation.NSRange) foundation.NSAttributedString {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilityAttributedStringForRange:"), range_)
...
func (v NSView) AccessibilityAttributedUserInputLabels() []foundation.NSAttributedString {
	rv := objc.Send[[]objc.ID](v.ID, objc.Sel("accessibilityAttributedUserInputLabels"))
...
func (v NSView) AccessibilityCancelButton() objectivec.IObject {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilityCancelButton"))
	return objectivec.Object{ID: rv}
}
...
func (v NSView) AccessibilityCellForColumnRow(column int, row int) objectivec.IObject {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilityCellForColumn:row:"), column, row)
	return objectivec.Object{ID: rv}
}
...
func (v NSView) AccessibilityChildren() foundation.INSArray {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilityChildren"))
...
func (v NSView) AccessibilityChildrenInNavigationOrder() []objectivec.IObject {
	rv := objc.Send[[]objc.ID](v.ID, objc.Sel("accessibilityChildrenInNavigationOrder"))
...
func (v NSView) AccessibilityClearButton() objectivec.IObject {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilityClearButton"))
	return objectivec.Object{ID: rv}
}
...
func (v NSView) AccessibilityCloseButton() objectivec.IObject {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilityCloseButton"))
	return objectivec.Object{ID: rv}
}
...
func (v NSView) AccessibilityColumnCount() int {
	rv := objc.Send[int](v.ID, objc.Sel("accessibilityColumnCount"))
	return rv
}
...
func (v NSView) AccessibilityColumnHeaderUIElements() foundation.INSArray {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilityColumnHeaderUIElements"))
	return foundation.NSArrayFromID(rv)
}
...
func (v NSView) AccessibilityColumnIndexRange() foundation.NSRange {
	rv := objc.Send[foundation.NSRange](v.ID, objc.Sel("accessibilityColumnIndexRange"))
...
func (v NSView) AccessibilityColumnTitles() foundation.INSArray {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilityColumnTitles"))
	return foundation.NSArrayFromID(rv)
}
...
func (v NSView) AccessibilityColumns() foundation.INSArray {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilityColumns"))
	return foundation.NSArrayFromID(rv)
}
...
func (v NSView) AccessibilityContents() foundation.INSArray {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilityContents"))
	return foundation.NSArrayFromID(rv)
}
...
func (v NSView) AccessibilityCriticalValue() objectivec.IObject {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilityCriticalValue"))
	return objectivec.Object{ID: rv}
}
...
func (v NSView) AccessibilityCustomActions() []NSAccessibilityCustomAction {
	rv := objc.Send[[]objc.ID](v.ID, objc.Sel("accessibilityCustomActions"))
...
func (v NSView) AccessibilityCustomRotors() []NSAccessibilityCustomRotor {
	rv := objc.Send[[]objc.ID](v.ID, objc.Sel("accessibilityCustomRotors"))
...
func (v NSView) AccessibilityDecrementButton() objectivec.IObject {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilityDecrementButton"))
	return objectivec.Object{ID: rv}
}
...
func (v NSView) AccessibilityDefaultButton() objectivec.IObject {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilityDefaultButton"))
	return objectivec.Object{ID: rv}
}
...
func (v NSView) AccessibilityDisclosedByRow() objectivec.IObject {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilityDisclosedByRow"))
	return objectivec.Object{ID: rv}
}
...
func (v NSView) AccessibilityDisclosedRows() objectivec.IObject {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilityDisclosedRows"))
	return objectivec.Object{ID: rv}
}
...
func (v NSView) AccessibilityDisclosureLevel() int {
	rv := objc.Send[int](v.ID, objc.Sel("accessibilityDisclosureLevel"))
	return rv
}
...
func (v NSView) AccessibilityDocument() string {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilityDocument"))
...
func (v NSView) AccessibilityExtrasMenuBar() objectivec.IObject {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilityExtrasMenuBar"))
	return objectivec.Object{ID: rv}
}
...
func (v NSView) AccessibilityFilename() string {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilityFilename"))
	return foundation.NSStringFromID(rv).String()
}
...
func (v NSView) AccessibilityFocusedWindow() objectivec.IObject {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilityFocusedWindow"))
	return objectivec.Object{ID: rv}
}
...
func (v NSView) AccessibilityFrame() corefoundation.CGRect {
	rv := objc.Send[corefoundation.CGRect](v.ID, objc.Sel("accessibilityFrame"))
...
func (v NSView) AccessibilityFrameForRange(range_ foundation.NSRange) corefoundation.CGRect {
	rv := objc.Send[corefoundation.CGRect](v.ID, objc.Sel("accessibilityFrameForRange:"), range_)
	return corefoundation.CGRect(rv)
}
...
func (v NSView) AccessibilityFullScreenButton() objectivec.IObject {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilityFullScreenButton"))
	return objectivec.Object{ID: rv}
}
...
func (v NSView) AccessibilityGrowArea() objectivec.IObject {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilityGrowArea"))
	return objectivec.Object{ID: rv}
}
...
func (v NSView) AccessibilityHandles() foundation.INSArray {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilityHandles"))
	return foundation.NSArrayFromID(rv)
}
...
func (v NSView) AccessibilityHeader() objectivec.IObject {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilityHeader"))
	return objectivec.Object{ID: rv}
}
...
func (v NSView) AccessibilityHelp() string {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilityHelp"))
	return foundation.NSStringFromID(rv).String()
}
...
func (v NSView) AccessibilityHorizontalScrollBar() objectivec.IObject {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilityHorizontalScrollBar"))
	return objectivec.Object{ID: rv}
}
...
func (v NSView) AccessibilityHorizontalUnitDescription() string {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilityHorizontalUnitDescription"))
	return foundation.NSStringFromID(rv).String()
}
...
func (v NSView) AccessibilityHorizontalUnits() NSAccessibilityUnits {
	rv := objc.Send[NSAccessibilityUnits](v.ID, objc.Sel("accessibilityHorizontalUnits"))
...
func (v NSView) AccessibilityIdentifier() string {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilityIdentifier"))
	return foundation.NSStringFromID(rv).String()
}
...
func (v NSView) AccessibilityIncrementButton() objectivec.IObject {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilityIncrementButton"))
	return objectivec.Object{ID: rv}
}
...
func (v NSView) AccessibilityIndex() int {
	rv := objc.Send[int](v.ID, objc.Sel("accessibilityIndex"))
	return rv
}
...
func (v NSView) AccessibilityInsertionPointLineNumber() int {
	rv := objc.Send[int](v.ID, objc.Sel("accessibilityInsertionPointLineNumber"))
	return rv
}
...
func (v NSView) AccessibilityLabel() string {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilityLabel"))
	return foundation.NSStringFromID(rv).String()
}
...
func (v NSView) AccessibilityLabelUIElements() foundation.INSArray {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilityLabelUIElements"))
	return foundation.NSArrayFromID(rv)
}
...
func (v NSView) AccessibilityLabelValue() float32 {
	rv := objc.Send[float32](v.ID, objc.Sel("accessibilityLabelValue"))
	return rv
}
...
func (v NSView) AccessibilityLayoutPointForScreenPoint(point corefoundation.CGPoint) corefoundation.CGPoint {
	rv := objc.Send[corefoundation.CGPoint](v.ID, objc.Sel("accessibilityLayoutPointForScreenPoint:"), point)
	return corefoundation.CGPoint(rv)
}
...
func (v NSView) AccessibilityLayoutSizeForScreenSize(size corefoundation.CGSize) corefoundation.CGSize {
	rv := objc.Send[corefoundation.CGSize](v.ID, objc.Sel("accessibilityLayoutSizeForScreenSize:"), size)
...
func (v NSView) AccessibilityLineForIndex(index int) int {
	rv := objc.Send[int](v.ID, objc.Sel("accessibilityLineForIndex:"), index)
	return rv
}
...
func (v NSView) AccessibilityLinkedUIElements() foundation.INSArray {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilityLinkedUIElements"))
	return foundation.NSArrayFromID(rv)
}
...
func (v NSView) AccessibilityMainWindow() objectivec.IObject {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilityMainWindow"))
	return objectivec.Object{ID: rv}
}
...
func (v NSView) AccessibilityMarkerGroupUIElement() objectivec.IObject {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilityMarkerGroupUIElement"))
	return objectivec.Object{ID: rv}
}
...
func (v NSView) AccessibilityMarkerTypeDescription() string {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilityMarkerTypeDescription"))
	return foundation.NSStringFromID(rv).String()
}
...
func (v NSView) AccessibilityMarkerUIElements() foundation.INSArray {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilityMarkerUIElements"))
	return foundation.NSArrayFromID(rv)
}
...
func (v NSView) AccessibilityMarkerValues() objectivec.IObject {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilityMarkerValues"))
	return objectivec.Object{ID: rv}
}
...
func (v NSView) AccessibilityMaxValue() objectivec.IObject {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilityMaxValue"))
	return objectivec.Object{ID: rv}
}
...
func (v NSView) AccessibilityMenuBar() objectivec.IObject {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilityMenuBar"))
	return objectivec.Object{ID: rv}
}
...
func (v NSView) AccessibilityMinValue() objectivec.IObject {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilityMinValue"))
	return objectivec.Object{ID: rv}
}
...
func (v NSView) AccessibilityMinimizeButton() objectivec.IObject {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilityMinimizeButton"))
	return objectivec.Object{ID: rv}
}
...
func (v NSView) AccessibilityNextContents() foundation.INSArray {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilityNextContents"))
	return foundation.NSArrayFromID(rv)
}
...
func (v NSView) AccessibilityNumberOfCharacters() int {
	rv := objc.Send[int](v.ID, objc.Sel("accessibilityNumberOfCharacters"))
	return rv
}
...
func (v NSView) AccessibilityOrientation() NSAccessibilityOrientation {
	rv := objc.Send[NSAccessibilityOrientation](v.ID, objc.Sel("accessibilityOrientation"))
...
func (v NSView) AccessibilityOverflowButton() objectivec.IObject {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilityOverflowButton"))
	return objectivec.Object{ID: rv}
}
...
func (v NSView) AccessibilityParent() objectivec.IObject {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilityParent"))
	return objectivec.Object{ID: rv}
}
...
func (v NSView) AccessibilityPerformCancel() bool {
	rv := objc.Send[bool](v.ID, objc.Sel("accessibilityPerformCancel"))
	return rv
}
...
func (v NSView) AccessibilityPerformConfirm() bool {
	rv := objc.Send[bool](v.ID, objc.Sel("accessibilityPerformConfirm"))
	return rv
}
...
func (v NSView) AccessibilityPerformDecrement() bool {
	rv := objc.Send[bool](v.ID, objc.Sel("accessibilityPerformDecrement"))
	return rv
}
...
func (v NSView) AccessibilityPerformDelete() bool {
	rv := objc.Send[bool](v.ID, objc.Sel("accessibilityPerformDelete"))
	return rv
}
...
func (v NSView) AccessibilityPerformIncrement() bool {
	rv := objc.Send[bool](v.ID, objc.Sel("accessibilityPerformIncrement"))
	return rv
}
...
func (v NSView) AccessibilityPerformPick() bool {
	rv := objc.Send[bool](v.ID, objc.Sel("accessibilityPerformPick"))
	return rv
}
...
func (v NSView) AccessibilityPerformPress() bool {
	rv := objc.Send[bool](v.ID, objc.Sel("accessibilityPerformPress"))
	return rv
}
...
func (v NSView) AccessibilityPerformRaise() bool {
	rv := objc.Send[bool](v.ID, objc.Sel("accessibilityPerformRaise"))
	return rv
}
...
func (v NSView) AccessibilityPerformShowAlternateUI() bool {
	rv := objc.Send[bool](v.ID, objc.Sel("accessibilityPerformShowAlternateUI"))
	return rv
}
...
func (v NSView) AccessibilityPerformShowDefaultUI() bool {
	rv := objc.Send[bool](v.ID, objc.Sel("accessibilityPerformShowDefaultUI"))
	return rv
}
...
func (v NSView) AccessibilityPerformShowMenu() bool {
	rv := objc.Send[bool](v.ID, objc.Sel("accessibilityPerformShowMenu"))
	return rv
}
...
func (v NSView) AccessibilityPlaceholderValue() string {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilityPlaceholderValue"))
	return foundation.NSStringFromID(rv).String()
}
...
func (v NSView) AccessibilityPreviousContents() foundation.INSArray {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilityPreviousContents"))
	return foundation.NSArrayFromID(rv)
}
...
func (v NSView) AccessibilityProxy() objectivec.IObject {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilityProxy"))
	return objectivec.Object{ID: rv}
}
...
func (v NSView) AccessibilityRTFForRange(range_ foundation.NSRange) foundation.NSData {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilityRTFForRange:"), range_)
...
func (v NSView) AccessibilityRangeForIndex(index int) foundation.NSRange {
	rv := objc.Send[foundation.NSRange](v.ID, objc.Sel("accessibilityRangeForIndex:"), index)
	return foundation.NSRange(rv)
}
...
func (v NSView) AccessibilityRangeForLine(line int) foundation.NSRange {
	rv := objc.Send[foundation.NSRange](v.ID, objc.Sel("accessibilityRangeForLine:"), line)
	return foundation.NSRange(rv)
}
...
func (v NSView) AccessibilityRangeForPosition(point corefoundation.CGPoint) foundation.NSRange {
	rv := objc.Send[foundation.NSRange](v.ID, objc.Sel("accessibilityRangeForPosition:"), point)
	return foundation.NSRange(rv)
}
...
func (v NSView) AccessibilityRole() NSAccessibilityRole {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilityRole"))
...
func (v NSView) AccessibilityRoleDescription() string {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilityRoleDescription"))
	return foundation.NSStringFromID(rv).String()
}
...
func (v NSView) AccessibilityRowCount() int {
	rv := objc.Send[int](v.ID, objc.Sel("accessibilityRowCount"))
	return rv
}
...
func (v NSView) AccessibilityRowHeaderUIElements() foundation.INSArray {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilityRowHeaderUIElements"))
	return foundation.NSArrayFromID(rv)
}
...
func (v NSView) AccessibilityRowIndexRange() foundation.NSRange {
	rv := objc.Send[foundation.NSRange](v.ID, objc.Sel("accessibilityRowIndexRange"))
	return foundation.NSRange(rv)
}
...
func (v NSView) AccessibilityRows() foundation.INSArray {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilityRows"))
	return foundation.NSArrayFromID(rv)
}
...
func (v NSView) AccessibilityRulerMarkerType() NSAccessibilityRulerMarkerType {
	rv := objc.Send[NSAccessibilityRulerMarkerType](v.ID, objc.Sel("accessibilityRulerMarkerType"))
...
func (v NSView) AccessibilityScreenPointForLayoutPoint(point corefoundation.CGPoint) corefoundation.CGPoint {
	rv := objc.Send[corefoundation.CGPoint](v.ID, objc.Sel("accessibilityScreenPointForLayoutPoint:"), point)
	return corefoundation.CGPoint(rv)
}
...
func (v NSView) AccessibilityScreenSizeForLayoutSize(size corefoundation.CGSize) corefoundation.CGSize {
	rv := objc.Send[corefoundation.CGSize](v.ID, objc.Sel("accessibilityScreenSizeForLayoutSize:"), size)
	return corefoundation.CGSize(rv)
}
...
func (v NSView) AccessibilitySearchButton() objectivec.IObject {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilitySearchButton"))
	return objectivec.Object{ID: rv}
}
...
func (v NSView) AccessibilitySearchMenu() objectivec.IObject {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilitySearchMenu"))
	return objectivec.Object{ID: rv}
}
...
func (v NSView) AccessibilitySelectedCells() foundation.INSArray {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilitySelectedCells"))
	return foundation.NSArrayFromID(rv)
}
...
func (v NSView) AccessibilitySelectedChildren() foundation.INSArray {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilitySelectedChildren"))
	return foundation.NSArrayFromID(rv)
}
...
func (v NSView) AccessibilitySelectedColumns() foundation.INSArray {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilitySelectedColumns"))
	return foundation.NSArrayFromID(rv)
}
...
func (v NSView) AccessibilitySelectedRows() foundation.INSArray {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilitySelectedRows"))
	return foundation.NSArrayFromID(rv)
}
...
func (v NSView) AccessibilitySelectedText() string {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilitySelectedText"))
	return foundation.NSStringFromID(rv).String()
}
...
func (v NSView) AccessibilitySelectedTextRange() foundation.NSRange {
	rv := objc.Send[foundation.NSRange](v.ID, objc.Sel("accessibilitySelectedTextRange"))
	return foundation.NSRange(rv)
}
...
func (v NSView) AccessibilitySelectedTextRanges() []foundation.NSValue {
	rv := objc.Send[[]objc.ID](v.ID, objc.Sel("accessibilitySelectedTextRanges"))
...
func (v NSView) AccessibilityServesAsTitleForUIElements() foundation.INSArray {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilityServesAsTitleForUIElements"))
	return foundation.NSArrayFromID(rv)
}
...
func (v NSView) AccessibilitySharedCharacterRange() foundation.NSRange {
	rv := objc.Send[foundation.NSRange](v.ID, objc.Sel("accessibilitySharedCharacterRange"))
	return foundation.NSRange(rv)
}
...
func (v NSView) AccessibilitySharedFocusElements() foundation.INSArray {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilitySharedFocusElements"))
	return foundation.NSArrayFromID(rv)
}
...
func (v NSView) AccessibilitySharedTextUIElements() foundation.INSArray {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilitySharedTextUIElements"))
	return foundation.NSArrayFromID(rv)
}
...
func (v NSView) AccessibilityShownMenu() objectivec.IObject {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilityShownMenu"))
	return objectivec.Object{ID: rv}
}
...
func (v NSView) AccessibilitySortDirection() NSAccessibilitySortDirection {
	rv := objc.Send[NSAccessibilitySortDirection](v.ID, objc.Sel("accessibilitySortDirection"))
...
func (v NSView) AccessibilitySplitters() foundation.INSArray {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilitySplitters"))
	return foundation.NSArrayFromID(rv)
}
...
func (v NSView) AccessibilityStringForRange(range_ foundation.NSRange) string {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilityStringForRange:"), range_)
	return foundation.NSStringFromID(rv).String()
}
...
func (v NSView) AccessibilityStyleRangeForIndex(index int) foundation.NSRange {
	rv := objc.Send[foundation.NSRange](v.ID, objc.Sel("accessibilityStyleRangeForIndex:"), index)
	return foundation.NSRange(rv)
}
...
func (v NSView) AccessibilitySubrole() NSAccessibilitySubrole {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilitySubrole"))
...
func (v NSView) AccessibilityTabs() foundation.INSArray {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilityTabs"))
	return foundation.NSArrayFromID(rv)
}
...
func (v NSView) AccessibilityTitle() string {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilityTitle"))
	return foundation.NSStringFromID(rv).String()
}
...
func (v NSView) AccessibilityTitleUIElement() objectivec.IObject {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilityTitleUIElement"))
	return objectivec.Object{ID: rv}
}
...
func (v NSView) AccessibilityToolbarButton() objectivec.IObject {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilityToolbarButton"))
	return objectivec.Object{ID: rv}
}
...
func (v NSView) AccessibilityTopLevelUIElement() objectivec.IObject {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilityTopLevelUIElement"))
	return objectivec.Object{ID: rv}
}
...
func (v NSView) AccessibilityURL() foundation.NSURL {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilityURL"))
...
func (v NSView) AccessibilityUnitDescription() string {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilityUnitDescription"))
	return foundation.NSStringFromID(rv).String()
}
...
func (v NSView) AccessibilityUnits() NSAccessibilityUnits {
	rv := objc.Send[NSAccessibilityUnits](v.ID, objc.Sel("accessibilityUnits"))
	return NSAccessibilityUnits(rv)
}

// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/accessibilityUserInputLabels()
func (v NSView) AccessibilityUserInputLabels() []string {
	rv := objc.Send[[]objc.ID](v.ID, objc.Sel("accessibilityUserInputLabels"))
...
func (v NSView) AccessibilityValue() objectivec.IObject {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilityValue"))
	return objectivec.Object{ID: rv}
}
...
func (v NSView) AccessibilityValueDescription() string {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilityValueDescription"))
	return foundation.NSStringFromID(rv).String()
}
...
func (v NSView) AccessibilityVerticalScrollBar() objectivec.IObject {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilityVerticalScrollBar"))
	return objectivec.Object{ID: rv}
}
...
func (v NSView) AccessibilityVerticalUnitDescription() string {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilityVerticalUnitDescription"))
	return foundation.NSStringFromID(rv).String()
}
...
func (v NSView) AccessibilityVerticalUnits() NSAccessibilityUnits {
	rv := objc.Send[NSAccessibilityUnits](v.ID, objc.Sel("accessibilityVerticalUnits"))
	return NSAccessibilityUnits(rv)
}
...
func (v NSView) AccessibilityVisibleCells() foundation.INSArray {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilityVisibleCells"))
	return foundation.NSArrayFromID(rv)
}
...
func (v NSView) AccessibilityVisibleCharacterRange() foundation.NSRange {
	rv := objc.Send[foundation.NSRange](v.ID, objc.Sel("accessibilityVisibleCharacterRange"))
	return foundation.NSRange(rv)
}
...
func (v NSView) AccessibilityVisibleChildren() foundation.INSArray {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilityVisibleChildren"))
	return foundation.NSArrayFromID(rv)
}
...
func (v NSView) AccessibilityVisibleColumns() foundation.INSArray {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilityVisibleColumns"))
	return foundation.NSArrayFromID(rv)
}
...
func (v NSView) AccessibilityVisibleRows() foundation.INSArray {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilityVisibleRows"))
	return foundation.NSArrayFromID(rv)
}
...
func (v NSView) AccessibilityWarningValue() objectivec.IObject {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilityWarningValue"))
	return objectivec.Object{ID: rv}
}
...
func (v NSView) AccessibilityWindow() objectivec.IObject {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilityWindow"))
	return objectivec.Object{ID: rv}
}
...
func (v NSView) AccessibilityWindows() foundation.INSArray {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilityWindows"))
	return foundation.NSArrayFromID(rv)
}
...
func (v NSView) AccessibilityZoomButton() objectivec.IObject {
	rv := objc.Send[objc.ID](v.ID, objc.Sel("accessibilityZoomButton"))
	return objectivec.Object{ID: rv}
}
...
func (v NSView) DataWithEPSInsideRect(rect corefoundation.CGRect) foundation.NSData {
...
func (v NSView) DataWithPDFInsideRect(rect corefoundation.CGRect) foundation.NSData {
...
// Invalidates the corner configuration, causing both the configuration and
// its dependencies to be recomputed.
//
// See: https://developer.apple.com/documentation/AppKit/NSView/invalidateCornerConfiguration()
func (v NSView) InvalidateCornerConfiguration() {
	objc.Send[objc.ID](v.ID, objc.Sel("invalidateCornerConfiguration"))
}
...
func (v NSView) IsAccessibilityAlternateUIVisible() bool {
	rv := objc.Send[bool](v.ID, objc.Sel("isAccessibilityAlternateUIVisible"))
	return rv
}
...
func (v NSView) IsAccessibilityDisclosed() bool {
	rv := objc.Send[bool](v.ID, objc.Sel("isAccessibilityDisclosed"))
	return rv
}
...
func (v NSView) IsAccessibilityEdited() bool {
	rv := objc.Send[bool](v.ID, objc.Sel("isAccessibilityEdited"))
	return rv
}
...
func (v NSView) IsAccessibilityElement() bool {
	rv := objc.Send[bool](v.ID, objc.Sel("isAccessibilityElement"))
	return rv
}
...
func (v NSView) IsAccessibilityEnabled() bool {
	rv := objc.Send[bool](v.ID, objc.Sel("isAccessibilityEnabled"))
	return rv
}
...
func (v NSView) IsAccessibilityExpanded() bool {
	rv := objc.Send[bool](v.ID, objc.Sel("isAccessibilityExpanded"))
	return rv
}
...
func (v NSView) IsAccessibilityFocused() bool {
	rv := objc.Send[bool](v.ID, objc.Sel("isAccessibilityFocused"))
	return rv
}
...
func (v NSView) IsAccessibilityFrontmost() bool {
	rv := objc.Send[bool](v.ID, objc.Sel("isAccessibilityFrontmost"))
	return rv
}
...
func (v NSView) IsAccessibilityHidden() bool {
	rv := objc.Send[bool](v.ID, objc.Sel("isAccessibilityHidden"))
	return rv
}
...
func (v NSView) IsAccessibilityMain() bool {
	rv := objc.Send[bool](v.ID, objc.Sel("isAccessibilityMain"))
	return rv
}
...
func (v NSView) IsAccessibilityMinimized() bool {
	rv := objc.Send[bool](v.ID, objc.Sel("isAccessibilityMinimized"))
	return rv
}
...
func (v NSView) IsAccessibilityModal() bool {
	rv := objc.Send[bool](v.ID, objc.Sel("isAccessibilityModal"))
	return rv
}
...
func (v NSView) IsAccessibilityOrderedByRow() bool {
	rv := objc.Send[bool](v.ID, objc.Sel("isAccessibilityOrderedByRow"))
	return rv
}
...
func (v NSView) IsAccessibilityProtectedContent() bool {
	rv := objc.Send[bool](v.ID, objc.Sel("isAccessibilityProtectedContent"))
	return rv
}
...
func (v NSView) IsAccessibilityRequired() bool {
	rv := objc.Send[bool](v.ID, objc.Sel("isAccessibilityRequired"))
	return rv
}
...
func (v NSView) IsAccessibilitySelected() bool {
	rv := objc.Send[bool](v.ID, objc.Sel("isAccessibilitySelected"))
	return rv
}
...
func (v NSView) IsAccessibilitySelectorAllowed(selector objc.SEL) bool {
	rv := objc.Send[bool](v.ID, objc.Sel("isAccessibilitySelectorAllowed:"), selector)
	return rv
}
...
// are one-based—that is pages run from one to N.
//
// # Return Value
//
...
func (v NSView) SetAccessibilityActivationPoint(accessibilityActivationPoint corefoundation.CGPoint) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityActivationPoint:"), accessibilityActivationPoint)
}

// Sets the allowed values for the slider accessibility element.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityAllowedValues(_:)
func (v NSView) SetAccessibilityAllowedValues(accessibilityAllowedValues []foundation.NSNumber) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityAllowedValues:"), objectivec.IObjectSliceToNSArray(accessibilityAllowedValues))
}
...
func (v NSView) SetAccessibilityAlternateUIVisible(accessibilityAlternateUIVisible bool) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityAlternateUIVisible:"), accessibilityAlternateUIVisible)
}

// Sets the child accessibility element with the current focus.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityApplicationFocusedUIElement(_:)
func (v NSView) SetAccessibilityApplicationFocusedUIElement(accessibilityApplicationFocusedUIElement objectivec.IObject) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityApplicationFocusedUIElement:"), accessibilityApplicationFocusedUIElement)
}

// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityAttributedUserInputLabels(_:)
func (v NSView) SetAccessibilityAttributedUserInputLabels(accessibilityAttributedUserInputLabels []foundation.NSAttributedString) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityAttributedUserInputLabels:"), objectivec.IObjectSliceToNSArray(accessibilityAttributedUserInputLabels))
}
...
func (v NSView) SetAccessibilityCancelButton(accessibilityCancelButton objectivec.IObject) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityCancelButton:"), accessibilityCancelButton)
}

// Sets the child accessibility elements in the accessibility hierarchy.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityChildren(_:)
func (v NSView) SetAccessibilityChildren(accessibilityChildren foundation.INSArray) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityChildren:"), accessibilityChildren)
}
...
func (v NSView) SetAccessibilityChildrenInNavigationOrder(accessibilityChildrenInNavigationOrder []objectivec.IObject) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityChildrenInNavigationOrder:"), objectivec.IObjectSliceToNSArray(accessibilityChildrenInNavigationOrder))
}

// Sets the clear button for the search field.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityClearButton(_:)
func (v NSView) SetAccessibilityClearButton(accessibilityClearButton objectivec.IObject) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityClearButton:"), accessibilityClearButton)
}
...
func (v NSView) SetAccessibilityCloseButton(accessibilityCloseButton objectivec.IObject) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityCloseButton:"), accessibilityCloseButton)
}

// Sets the number of columns in the accessibility element’s grid.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityColumnCount(_:)
func (v NSView) SetAccessibilityColumnCount(accessibilityColumnCount int) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityColumnCount:"), accessibilityColumnCount)
}

// Sets the column header accessibility elements for the table or outline.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityColumnHeaderUIElements(_:)
func (v NSView) SetAccessibilityColumnHeaderUIElements(accessibilityColumnHeaderUIElements foundation.INSArray) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityColumnHeaderUIElements:"), accessibilityColumnHeaderUIElements)
}

// Sets the column index range of the cell.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityColumnIndexRange(_:)
func (v NSView) SetAccessibilityColumnIndexRange(accessibilityColumnIndexRange foundation.NSRange) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityColumnIndexRange:"), accessibilityColumnIndexRange)
}

// Sets the column titles for the accessibility element.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityColumnTitles(_:)
func (v NSView) SetAccessibilityColumnTitles(accessibilityColumnTitles foundation.INSArray) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityColumnTitles:"), accessibilityColumnTitles)
}

// Sets the column accessibility elements for the table or outline.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityColumns(_:)
func (v NSView) SetAccessibilityColumns(accessibilityColumns foundation.INSArray) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityColumns:"), accessibilityColumns)
}

// Sets the contents of the current accessibility element.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityContents(_:)
func (v NSView) SetAccessibilityContents(accessibilityContents foundation.INSArray) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityContents:"), accessibilityContents)
}

// Sets the critical value for the level indicator.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityCriticalValue(_:)
func (v NSView) SetAccessibilityCriticalValue(accessibilityCriticalValue objectivec.IObject) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityCriticalValue:"), accessibilityCriticalValue)
}

// Sets the custom actions of the current accessibility element.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityCustomActions(_:)
func (v NSView) SetAccessibilityCustomActions(accessibilityCustomActions []NSAccessibilityCustomAction) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityCustomActions:"), objectivec.IObjectSliceToNSArray(accessibilityCustomActions))
}

// Sets the custom rotors of the current accessibility element.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityCustomRotors(_:)
func (v NSView) SetAccessibilityCustomRotors(accessibilityCustomRotors []NSAccessibilityCustomRotor) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityCustomRotors:"), objectivec.IObjectSliceToNSArray(accessibilityCustomRotors))
}

// Sets the decrement button for the stepper accessibility element.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityDecrementButton(_:)
func (v NSView) SetAccessibilityDecrementButton(accessibilityDecrementButton objectivec.IObject) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityDecrementButton:"), accessibilityDecrementButton)
}
...
func (v NSView) SetAccessibilityDefaultButton(accessibilityDefaultButton objectivec.IObject) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityDefaultButton:"), accessibilityDefaultButton)
}
...
func (v NSView) SetAccessibilityDisclosed(accessibilityDisclosed bool) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityDisclosed:"), accessibilityDisclosed)
}

// Sets the row disclosing the current row.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityDisclosedByRow(_:)
func (v NSView) SetAccessibilityDisclosedByRow(accessibilityDisclosedByRow objectivec.IObject) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityDisclosedByRow:"), accessibilityDisclosedByRow)
}

// Sets the rows that the current row discloses.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityDisclosedRows(_:)
func (v NSView) SetAccessibilityDisclosedRows(accessibilityDisclosedRows objectivec.IObject) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityDisclosedRows:"), accessibilityDisclosedRows)
}

// Sets the indention level for the row.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityDisclosureLevel(_:)
func (v NSView) SetAccessibilityDisclosureLevel(accessibilityDisclosureLevel int) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityDisclosureLevel:"), accessibilityDisclosureLevel)
}

// Sets the URL for the file that the accessibility element represents.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityDocument(_:)
func (v NSView) SetAccessibilityDocument(accessibilityDocument string) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityDocument:"), objc.String(accessibilityDocument))
}
...
func (v NSView) SetAccessibilityEdited(accessibilityEdited bool) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityEdited:"), accessibilityEdited)
}
...
func (v NSView) SetAccessibilityElement(accessibilityElement bool) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityElement:"), accessibilityElement)
}
...
func (v NSView) SetAccessibilityEnabled(accessibilityEnabled bool) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityEnabled:"), accessibilityEnabled)
}
...
func (v NSView) SetAccessibilityExpanded(accessibilityExpanded bool) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityExpanded:"), accessibilityExpanded)
}

// Sets the icon for the app’s menu bar extra.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityExtrasMenuBar(_:)
func (v NSView) SetAccessibilityExtrasMenuBar(accessibilityExtrasMenuBar objectivec.IObject) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityExtrasMenuBar:"), accessibilityExtrasMenuBar)
}

// Sets the filename for the file that the accessibility element represents.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityFilename(_:)
func (v NSView) SetAccessibilityFilename(accessibilityFilename string) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityFilename:"), objc.String(accessibilityFilename))
}
...
func (v NSView) SetAccessibilityFocused(accessibilityFocused bool) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityFocused:"), accessibilityFocused)
}

// Sets the child window with the current focus.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityFocusedWindow(_:)
func (v NSView) SetAccessibilityFocusedWindow(accessibilityFocusedWindow objectivec.IObject) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityFocusedWindow:"), accessibilityFocusedWindow)
}

// Sets the accessibility element’s frame in screen coordinates.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityFrame(_:)
func (v NSView) SetAccessibilityFrame(accessibilityFrame corefoundation.CGRect) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityFrame:"), accessibilityFrame)
}

// Sets a Boolean value that determines whether the app is the frontmost app.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityFrontmost(_:)
func (v NSView) SetAccessibilityFrontmost(accessibilityFrontmost bool) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityFrontmost:"), accessibilityFrontmost)
}
...
func (v NSView) SetAccessibilityFullScreenButton(accessibilityFullScreenButton objectivec.IObject) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityFullScreenButton:"), accessibilityFullScreenButton)
}
...
func (v NSView) SetAccessibilityGrowArea(accessibilityGrowArea objectivec.IObject) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityGrowArea:"), accessibilityGrowArea)
}

// Sets the drag handle accessibility elements for the layout item element.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityHandles(_:)
func (v NSView) SetAccessibilityHandles(accessibilityHandles foundation.INSArray) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityHandles:"), accessibilityHandles)
}

// Sets the header for the table view.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityHeader(_:)
func (v NSView) SetAccessibilityHeader(accessibilityHeader objectivec.IObject) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityHeader:"), accessibilityHeader)
}

// Sets the help text for the accessibility element.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityHelp(_:)
func (v NSView) SetAccessibilityHelp(accessibilityHelp string) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityHelp:"), objc.String(accessibilityHelp))
}

// Sets a Boolean value that determines whether the app is in a hidden state.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityHidden(_:)
func (v NSView) SetAccessibilityHidden(accessibilityHidden bool) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityHidden:"), accessibilityHidden)
}

// Sets the horizontal scroll bar for the scroll view.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityHorizontalScrollBar(_:)
func (v NSView) SetAccessibilityHorizontalScrollBar(accessibilityHorizontalScrollBar objectivec.IObject) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityHorizontalScrollBar:"), accessibilityHorizontalScrollBar)
}

// Sets the description of the layout area’s horizontal units.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityHorizontalUnitDescription(_:)
func (v NSView) SetAccessibilityHorizontalUnitDescription(accessibilityHorizontalUnitDescription string) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityHorizontalUnitDescription:"), objc.String(accessibilityHorizontalUnitDescription))
}

// Sets the units that the layout area uses for horizontal values.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityHorizontalUnits(_:)
func (v NSView) SetAccessibilityHorizontalUnits(accessibilityHorizontalUnits NSAccessibilityUnits) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityHorizontalUnits:"), accessibilityHorizontalUnits)
}

// Sets the accessibility element’s identity.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityIdentifier(_:)
func (v NSView) SetAccessibilityIdentifier(accessibilityIdentifier string) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityIdentifier:"), objc.String(accessibilityIdentifier))
}

// Sets the increment button for the stepper accessibility element.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityIncrementButton(_:)
func (v NSView) SetAccessibilityIncrementButton(accessibilityIncrementButton objectivec.IObject) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityIncrementButton:"), accessibilityIncrementButton)
}
...
func (v NSView) SetAccessibilityIndex(accessibilityIndex int) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityIndex:"), accessibilityIndex)
}

// Sets the line number that contains the insertion point.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityInsertionPointLineNumber(_:)
func (v NSView) SetAccessibilityInsertionPointLineNumber(accessibilityInsertionPointLineNumber int) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityInsertionPointLineNumber:"), accessibilityInsertionPointLineNumber)
}

// Sets a short description of the accessibility element.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityLabel(_:)
func (v NSView) SetAccessibilityLabel(accessibilityLabel string) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityLabel:"), objc.String(accessibilityLabel))
}

// Sets the child label elements for the slider accessibility element.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityLabelUIElements(_:)
func (v NSView) SetAccessibilityLabelUIElements(accessibilityLabelUIElements foundation.INSArray) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityLabelUIElements:"), accessibilityLabelUIElements)
}

// Sets the value of the label accessibility element.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityLabelValue(_:)
func (v NSView) SetAccessibilityLabelValue(accessibilityLabelValue float32) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityLabelValue:"), accessibilityLabelValue)
}

// Sets the elements that have links with the accessibility element.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityLinkedUIElements(_:)
func (v NSView) SetAccessibilityLinkedUIElements(accessibilityLinkedUIElements foundation.INSArray) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityLinkedUIElements:"), accessibilityLinkedUIElements)
}
...
func (v NSView) SetAccessibilityMain(accessibilityMain bool) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityMain:"), accessibilityMain)
}

// Sets the app’s main window.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityMainWindow(_:)
func (v NSView) SetAccessibilityMainWindow(accessibilityMainWindow objectivec.IObject) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityMainWindow:"), accessibilityMainWindow)
}
...
func (v NSView) SetAccessibilityMarkerGroupUIElement(accessibilityMarkerGroupUIElement objectivec.IObject) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityMarkerGroupUIElement:"), accessibilityMarkerGroupUIElement)
}

// Sets the human-readable description of the marker type.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityMarkerTypeDescription(_:)
func (v NSView) SetAccessibilityMarkerTypeDescription(accessibilityMarkerTypeDescription string) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityMarkerTypeDescription:"), objc.String(accessibilityMarkerTypeDescription))
}

// Sets the array of marker accessibility elements for the ruler.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityMarkerUIElements(_:)
func (v NSView) SetAccessibilityMarkerUIElements(accessibilityMarkerUIElements foundation.INSArray) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityMarkerUIElements:"), accessibilityMarkerUIElements)
}

// Sets the marker values for the ruler.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityMarkerValues(_:)
func (v NSView) SetAccessibilityMarkerValues(accessibilityMarkerValues objectivec.IObject) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityMarkerValues:"), accessibilityMarkerValues)
}

// Sets the maximum value for the accessibility element.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityMaxValue(_:)
func (v NSView) SetAccessibilityMaxValue(accessibilityMaxValue objectivec.IObject) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityMaxValue:"), accessibilityMaxValue)
}

// Sets the app’s menu bar.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityMenuBar(_:)
func (v NSView) SetAccessibilityMenuBar(accessibilityMenuBar objectivec.IObject) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityMenuBar:"), accessibilityMenuBar)
}

// Sets the minimum value for the accessibility element.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityMinValue(_:)
func (v NSView) SetAccessibilityMinValue(accessibilityMinValue objectivec.IObject) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityMinValue:"), accessibilityMinValue)
}
...
func (v NSView) SetAccessibilityMinimizeButton(accessibilityMinimizeButton objectivec.IObject) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityMinimizeButton:"), accessibilityMinimizeButton)
}
...
func (v NSView) SetAccessibilityMinimized(accessibilityMinimized bool) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityMinimized:"), accessibilityMinimized)
}

// Sets a Boolean value that determines whether the window is modal.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityModal(_:)
func (v NSView) SetAccessibilityModal(accessibilityModal bool) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityModal:"), accessibilityModal)
}

// Sets the contents that follow the divider accessibility element.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityNextContents(_:)
func (v NSView) SetAccessibilityNextContents(accessibilityNextContents foundation.INSArray) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityNextContents:"), accessibilityNextContents)
}

// Sets the number of characters in the text.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityNumberOfCharacters(_:)
func (v NSView) SetAccessibilityNumberOfCharacters(accessibilityNumberOfCharacters int) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityNumberOfCharacters:"), accessibilityNumberOfCharacters)
}
...
func (v NSView) SetAccessibilityOrderedByRow(accessibilityOrderedByRow bool) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityOrderedByRow:"), accessibilityOrderedByRow)
}

// Sets the orientation of the accessibility element.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityOrientation(_:)
func (v NSView) SetAccessibilityOrientation(accessibilityOrientation NSAccessibilityOrientation) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityOrientation:"), accessibilityOrientation)
}

// Sets the overflow button for the toolbar.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityOverflowButton(_:)
func (v NSView) SetAccessibilityOverflowButton(accessibilityOverflowButton objectivec.IObject) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityOverflowButton:"), accessibilityOverflowButton)
}

// Sets the accessibility element’s parent in the accessibility hierarchy.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityParent(_:)
func (v NSView) SetAccessibilityParent(accessibilityParent objectivec.IObject) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityParent:"), accessibilityParent)
}

// Sets the placeholder value for the accessibility element.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityPlaceholderValue(_:)
func (v NSView) SetAccessibilityPlaceholderValue(accessibilityPlaceholderValue string) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityPlaceholderValue:"), objc.String(accessibilityPlaceholderValue))
}

// Sets the contents that precede the divider accessibility element.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityPreviousContents(_:)
func (v NSView) SetAccessibilityPreviousContents(accessibilityPreviousContents foundation.INSArray) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityPreviousContents:"), accessibilityPreviousContents)
}
...
func (v NSView) SetAccessibilityProtectedContent(accessibilityProtectedContent bool) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityProtectedContent:"), accessibilityProtectedContent)
}
...
func (v NSView) SetAccessibilityProxy(accessibilityProxy objectivec.IObject) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityProxy:"), accessibilityProxy)
}
...
func (v NSView) SetAccessibilityRequired(accessibilityRequired bool) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityRequired:"), accessibilityRequired)
}
...
func (v NSView) SetAccessibilityRole(accessibilityRole NSAccessibilityRole) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityRole:"), objc.String(string(accessibilityRole)))
}
...
func (v NSView) SetAccessibilityRoleDescription(accessibilityRoleDescription string) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityRoleDescription:"), objc.String(accessibilityRoleDescription))
}

// Sets the number of rows in the accessibility element’s grid.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityRowCount(_:)
func (v NSView) SetAccessibilityRowCount(accessibilityRowCount int) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityRowCount:"), accessibilityRowCount)
}

// Sets the row header accessibility elements for the table or outline.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityRowHeaderUIElements(_:)
func (v NSView) SetAccessibilityRowHeaderUIElements(accessibilityRowHeaderUIElements foundation.INSArray) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityRowHeaderUIElements:"), accessibilityRowHeaderUIElements)
}

// Sets the row index range of the cell.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityRowIndexRange(_:)
func (v NSView) SetAccessibilityRowIndexRange(accessibilityRowIndexRange foundation.NSRange) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityRowIndexRange:"), accessibilityRowIndexRange)
}

// Sets the row accessibility elements for the table or outline.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityRows(_:)
func (v NSView) SetAccessibilityRows(accessibilityRows foundation.INSArray) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityRows:"), accessibilityRows)
}

// Sets the type of markers for the ruler.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityRulerMarkerType(_:)
func (v NSView) SetAccessibilityRulerMarkerType(accessibilityRulerMarkerType NSAccessibilityRulerMarkerType) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityRulerMarkerType:"), accessibilityRulerMarkerType)
}

// Sets the search button for the search field.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilitySearchButton(_:)
func (v NSView) SetAccessibilitySearchButton(accessibilitySearchButton objectivec.IObject) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilitySearchButton:"), accessibilitySearchButton)
}

// Sets the search menu for the search field.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilitySearchMenu(_:)
func (v NSView) SetAccessibilitySearchMenu(accessibilitySearchMenu objectivec.IObject) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilitySearchMenu:"), accessibilitySearchMenu)
}
...
func (v NSView) SetAccessibilitySelected(accessibilitySelected bool) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilitySelected:"), accessibilitySelected)
}

// Sets the currently selected cells for the table.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilitySelectedCells(_:)
func (v NSView) SetAccessibilitySelectedCells(accessibilitySelectedCells foundation.INSArray) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilitySelectedCells:"), accessibilitySelectedCells)
}

// Sets the accessibility element’s currently selected children.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilitySelectedChildren(_:)
func (v NSView) SetAccessibilitySelectedChildren(accessibilitySelectedChildren foundation.INSArray) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilitySelectedChildren:"), accessibilitySelectedChildren)
}

// Sets the currently selected columns for the table or outline.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilitySelectedColumns(_:)
func (v NSView) SetAccessibilitySelectedColumns(accessibilitySelectedColumns foundation.INSArray) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilitySelectedColumns:"), accessibilitySelectedColumns)
}

// Sets the currently selected rows for the table or outline.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilitySelectedRows(_:)
func (v NSView) SetAccessibilitySelectedRows(accessibilitySelectedRows foundation.INSArray) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilitySelectedRows:"), accessibilitySelectedRows)
}

// Sets the currently selected text.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilitySelectedText(_:)
func (v NSView) SetAccessibilitySelectedText(accessibilitySelectedText string) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilitySelectedText:"), objc.String(accessibilitySelectedText))
}

// Sets the range of the currently selected text.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilitySelectedTextRange(_:)
func (v NSView) SetAccessibilitySelectedTextRange(accessibilitySelectedTextRange foundation.NSRange) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilitySelectedTextRange:"), accessibilitySelectedTextRange)
}

// Sets an array of ranges for the currently selected text.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilitySelectedTextRanges(_:)
func (v NSView) SetAccessibilitySelectedTextRanges(accessibilitySelectedTextRanges []foundation.NSValue) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilitySelectedTextRanges:"), objectivec.IObjectSliceToNSArray(accessibilitySelectedTextRanges))
}

// Sets the list of elements that the accessibility element is a title for.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityServesAsTitleForUIElements(_:)
func (v NSView) SetAccessibilityServesAsTitleForUIElements(accessibilityServesAsTitleForUIElements foundation.INSArray) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityServesAsTitleForUIElements:"), accessibilityServesAsTitleForUIElements)
}

// Sets the range of characters that the accessibility element displays.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilitySharedCharacterRange(_:)
func (v NSView) SetAccessibilitySharedCharacterRange(accessibilitySharedCharacterRange foundation.NSRange) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilitySharedCharacterRange:"), accessibilitySharedCharacterRange)
}
...
func (v NSView) SetAccessibilitySharedFocusElements(accessibilitySharedFocusElements foundation.INSArray) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilitySharedFocusElements:"), accessibilitySharedFocusElements)
}

// Sets the other elements that share text with the accessibility element.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilitySharedTextUIElements(_:)
func (v NSView) SetAccessibilitySharedTextUIElements(accessibilitySharedTextUIElements foundation.INSArray) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilitySharedTextUIElements:"), accessibilitySharedTextUIElements)
}

// Sets the menu currently displaying for the accessibility element.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityShownMenu(_:)
func (v NSView) SetAccessibilityShownMenu(accessibilityShownMenu objectivec.IObject) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityShownMenu:"), accessibilityShownMenu)
}

// Sets the accessibility element’s sort direction.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilitySortDirection(_:)
func (v NSView) SetAccessibilitySortDirection(accessibilitySortDirection NSAccessibilitySortDirection) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilitySortDirection:"), accessibilitySortDirection)
}
...
func (v NSView) SetAccessibilitySplitters(accessibilitySplitters foundation.INSArray) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilitySplitters:"), accessibilitySplitters)
}
...
func (v NSView) SetAccessibilitySubrole(accessibilitySubrole NSAccessibilitySubrole) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilitySubrole:"), objc.String(string(accessibilitySubrole)))
}

// Sets the tab accessibility elements for the tab view.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityTabs(_:)
func (v NSView) SetAccessibilityTabs(accessibilityTabs foundation.INSArray) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityTabs:"), accessibilityTabs)
}

// Sets the title of the accessibility element.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityTitle(_:)
func (v NSView) SetAccessibilityTitle(accessibilityTitle string) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityTitle:"), objc.String(accessibilityTitle))
}
...
func (v NSView) SetAccessibilityTitleUIElement(accessibilityTitleUIElement objectivec.IObject) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityTitleUIElement:"), accessibilityTitleUIElement)
}
...
func (v NSView) SetAccessibilityToolbarButton(accessibilityToolbarButton objectivec.IObject) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityToolbarButton:"), accessibilityToolbarButton)
}

// Sets the top-level element that contains the accessibility element.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityTopLevelUIElement(_:)
func (v NSView) SetAccessibilityTopLevelUIElement(accessibilityTopLevelUIElement objectivec.IObject) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityTopLevelUIElement:"), accessibilityTopLevelUIElement)
}

// Sets the URL for the accessibility element.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityURL(_:)
func (v NSView) SetAccessibilityURL(accessibilityURL foundation.NSURL) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityURL:"), accessibilityURL)
}

// Sets the human-readable description of the ruler’s units.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityUnitDescription(_:)
func (v NSView) SetAccessibilityUnitDescription(accessibilityUnitDescription string) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityUnitDescription:"), objc.String(accessibilityUnitDescription))
}

// Sets the units used for the ruler.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityUnits(_:)
func (v NSView) SetAccessibilityUnits(accessibilityUnits NSAccessibilityUnits) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityUnits:"), accessibilityUnits)
}

// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityUserInputLabels(_:)
func (v NSView) SetAccessibilityUserInputLabels(accessibilityUserInputLabels []string) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityUserInputLabels:"), objectivec.StringSliceToNSArray(accessibilityUserInputLabels))
}

// Sets the accessibility element’s value.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityValue(_:)
func (v NSView) SetAccessibilityValue(accessibilityValue objectivec.IObject) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityValue:"), accessibilityValue)
}

// Sets the human-readable description of the accessibility element’s value.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityValueDescription(_:)
func (v NSView) SetAccessibilityValueDescription(accessibilityValueDescription string) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityValueDescription:"), objc.String(accessibilityValueDescription))
}

// Sets the vertical scroll bar for the scroll view.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityVerticalScrollBar(_:)
func (v NSView) SetAccessibilityVerticalScrollBar(accessibilityVerticalScrollBar objectivec.IObject) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityVerticalScrollBar:"), accessibilityVerticalScrollBar)
}

// Sets the description of the layout area’s vertical units.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityVerticalUnitDescription(_:)
func (v NSView) SetAccessibilityVerticalUnitDescription(accessibilityVerticalUnitDescription string) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityVerticalUnitDescription:"), objc.String(accessibilityVerticalUnitDescription))
}

// Sets the units that the layout area uses for vertical values.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityVerticalUnits(_:)
func (v NSView) SetAccessibilityVerticalUnits(accessibilityVerticalUnits NSAccessibilityUnits) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityVerticalUnits:"), accessibilityVerticalUnits)
}

// Sets the visible cells for the table.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityVisibleCells(_:)
func (v NSView) SetAccessibilityVisibleCells(accessibilityVisibleCells foundation.INSArray) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityVisibleCells:"), accessibilityVisibleCells)
}

// Sets the range of visible characters in the document.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityVisibleCharacterRange(_:)
func (v NSView) SetAccessibilityVisibleCharacterRange(accessibilityVisibleCharacterRange foundation.NSRange) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityVisibleCharacterRange:"), accessibilityVisibleCharacterRange)
}

// Sets the accessibility element’s visible child accessibility elements.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityVisibleChildren(_:)
func (v NSView) SetAccessibilityVisibleChildren(accessibilityVisibleChildren foundation.INSArray) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityVisibleChildren:"), accessibilityVisibleChildren)
}

// Sets the visible columns for the table or outline.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityVisibleColumns(_:)
func (v NSView) SetAccessibilityVisibleColumns(accessibilityVisibleColumns foundation.INSArray) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityVisibleColumns:"), accessibilityVisibleColumns)
}

// Sets the visible rows for the table or outline.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityVisibleRows(_:)
func (v NSView) SetAccessibilityVisibleRows(accessibilityVisibleRows foundation.INSArray) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityVisibleRows:"), accessibilityVisibleRows)
}

// Sets the warning value for the level indicator.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityWarningValue(_:)
func (v NSView) SetAccessibilityWarningValue(accessibilityWarningValue objectivec.IObject) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityWarningValue:"), accessibilityWarningValue)
}

// Sets the window that contains the accessibility element.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityWindow(_:)
func (v NSView) SetAccessibilityWindow(accessibilityWindow objectivec.IObject) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityWindow:"), accessibilityWindow)
}

// Sets the array that contains all the app’s windows.
//
// See: https://developer.apple.com/documentation/AppKit/NSAccessibilityProtocol/setAccessibilityWindows(_:)
func (v NSView) SetAccessibilityWindows(accessibilityWindows foundation.INSArray) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityWindows:"), accessibilityWindows)
}
...
func (v NSView) SetAccessibilityZoomButton(accessibilityZoomButton objectivec.IObject) {
	objc.Send[objc.ID](v.ID, objc.Sel("setAccessibilityZoomButton:"), accessibilityZoomButton)
}
...
func (v NSView) SortSubviewsUsingFunctionContext(compare func(*NSView, *NSView, unsafe.Pointer) foundation.NSComparisonResult, context unsafe.Pointer) {
...
// Informs the view that its effective corner radii changed. This method
// should be overridden to apply the corner radii to the view as required.
//
// See: https://developer.apple.com/documentation/AppKit/NSView/viewDidChangeEffectiveCornerRadii()
func (v NSView) ViewDidChangeEffectiveCornerRadii() {
	objc.Send[objc.ID](v.ID, objc.Sel("viewDidChangeEffectiveCornerRadii"))
}
...
// Defines the corner styles (e.g., square, capsule, concentric, etc) for the
// view’s corners.
//
// See: https://developer.apple.com/documentation/AppKit/NSView/cornerConfiguration
func (v NSView) CornerConfiguration() unsafe.Pointer {
	rv := objc.Send[unsafe.Pointer](v.ID, objc.Sel("cornerConfiguration"))
	return rv
}
...
// The effective radius of each corner in the view, calculated based on the
// corner configuration (`cornerConfiguration`). This value is `nil` when the
// corner configuration is `nil`.
//
// See: https://developer.apple.com/documentation/AppKit/NSView/effectiveCornerRadii
func (v NSView) EffectiveCornerRadii() unsafe.Pointer {
	rv := objc.Send[unsafe.Pointer](v.ID, objc.Sel("effectiveCornerRadii"))
	return rv
}
...
// Declares whether gesture recognizers should be exclusive in this view and
// its subviews.
//
// # Discussion
//
// When a view is set to `XCUIElementTypeExclusive`, and one or more of its
// gesture recognizers is active, a second input event will not activate any
// further gesture recognizers, unless that event hit tests to this view or
// its subviews.
//
// Defaults to `XCUIElementTypeInherit`.
//
// See: https://developer.apple.com/documentation/AppKit/NSView/exclusiveGestureBehavior-swift.property
func (v NSView) ExclusiveGestureBehavior() NSViewExclusiveGestureBehavior {
	rv := objc.Send[NSViewExclusiveGestureBehavior](v.ID, objc.Sel("exclusiveGestureBehavior"))
	return NSViewExclusiveGestureBehavior(rv)
}
func (v NSView) SetExclusiveGestureBehavior(value NSViewExclusiveGestureBehavior) {
	objc.Send[struct{}](v.ID, objc.Sel("setExclusiveGestureBehavior:"), value)
}
...
// # Discussion
//
// Setting this property installs gesture recognizers and configures the view
// to handle text selection interactions. Setting it to `nil` removes text
// selection support. The default value is `nil`.
//
// See: https://developer.apple.com/documentation/AppKit/NSView/textSelectionManager
func (v NSView) TextSelectionManager() unsafe.Pointer {
	rv := objc.Send[unsafe.Pointer](v.ID, objc.Sel("textSelectionManager"))
	return rv
}
func (v NSView) SetTextSelectionManager(value unsafe.Pointer) {
	objc.Send[struct{}](v.ID, objc.Sel("setTextSelectionManager:"), value)
}
...
//
// See: https://developer.apple.com/documentation/AppKit/NSAnimatablePropertyContainer/animations
func (o NSView) SetAnimations(value foundation.INSDictionary) {
...
//
// See: https://developer.apple.com/documentation/AppKit/NSAppearanceCustomization/appearance
func (o NSView) SetAppearance(value INSAppearance) {
