...
func (nc NSWindowControllerClass) Class() objc.Class {
	return nc.class
}
...
// associated document when the window it manages is closed, false otherwise.
...
// cascade in relation to other document windows, false otherwise. The default
// value is true.
//
