...
// allow the drag to happen by returning false and allow it by returning true.
// By default, the pasteboard automatically has the following types on it:
// [NSStringPboardType], [NSURLPboardType] (if there is a URL value for the
// cell being dragged), and [NSFilenamesPboardType] (if the URL value returns
// true from -[isFileURL]). You can customize the types placed on the
// pasteboard at this time, if desired. Implementation of this method is
// optional.
//
