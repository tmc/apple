...
func (o NSSharingServiceDelegateObject) SharingServiceDidFailToShareItemsError(sharingService INSSharingService, items foundation.INSArray, error_ foundation.NSError) {
...
type NSSharingServiceDelegateConfig struct {
	...
	// Other Methods
	// AnchoringViewForSharingServiceShowRelativeToRectPreferredEdge — The method invoked when the service is performed and wants to display its contents in a popover.
