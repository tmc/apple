...
// # Return Value
//
// true to allow the table view to change its selection (typically a row being
// edited), false to deny selection change.
//
// # Discussion
//
...
// called with a `newColumnIndex` value of `-1`. Returning false will disallow
// that column from being reordered at all. Returning true allows it to be
// reordered, and the delegate will be called again when the column reaches a
// new location.
//
...
// [NSTableRowActionEdgeLeading]. Swiping to the left results in an edge value
// of [NSTableRowActionEdgeTrailing].
//
// # Return Value
//
