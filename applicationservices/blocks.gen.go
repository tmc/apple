...
func NewAXObserverCallbackBlock(handler AXObserverCallback) (objc.ID, func()) {
	...
	block := objc.NewBlock(func(b objc.Block, primitive AXObserverRef, extra0 AXUIElementRef, extra1 corefoundation.CFString, extra2 unsafe.Pointer) {
...
func NewAXObserverCallbackWithInfoBlock(handler AXObserverCallbackWithInfo) (objc.ID, func()) {
	...
	block := objc.NewBlock(func(b objc.Block, primitive AXObserverRef, extra0 AXUIElementRef, extra1 corefoundation.CFString, extra2 corefoundation.CFDictionaryRef, extra3 unsafe.Pointer) {
...
func NewQDLineProcPtrBlock(handler QDLineProcPtr) (objc.ID, func()) {
	...
	block := objc.NewBlock(func(b objc.Block, primitiveVal corefoundation.CGPoint) {
...
func NewQDTextProcPtrBlock(handler QDTextProcPtr) (objc.ID, func()) {
	...
	block := objc.NewBlock(func(b objc.Block, primitive int16, extra0 unsafe.Pointer, extra1 corefoundation.CGPoint, extra2 corefoundation.CGPoint) {
		handler(primitive, extra0, extra1, extra2)
	})
	return objc.ID(block), func() { block.Release() }
}
...
func NewSpeechErrorProcPtrBlock(handler SpeechErrorProcPtr) (objc.ID, func()) {
	...
	block := objc.NewBlock(func(b objc.Block, primitive *SpeechChannelRecord, extra0 uintptr, extra1 int16, extra2 int) {
		handler(primitive, extra0, extra1, extra2)
	})
	return objc.ID(block), func() { block.Release() }
}
...
func NewSpeechWordCFProcPtrBlock(handler SpeechWordCFProcPtr) (objc.ID, func()) {
	...
	block := objc.NewBlock(func(b objc.Block, primitive *SpeechChannelRecord, extra0 uintptr, extra1 corefoundation.CFString, extra2 corefoundation.CFRange) {
		handler(primitive, extra0, extra1, extra2)
	})
	return objc.ID(block), func() { block.Release() }
}
