...
// 
// Returning [true] from this method, implies only that the receiver will
// load, or at least attempt to load, the resource. In some implementations,
// the actual work of loading the resource might be initiated on another
// thread, running asynchronously to the resource loading delegate; whether
// the work begins immediately or merely soon is an implementation detail of
...
// 
// Return [true] if you expect a response either subsequently or immediately
// to the authenticationChallenger object’s sender.
// 
