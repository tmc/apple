...
// is [AVCaptureLensStabilizationStatusUnsupported]. If OIS is supported, but
// this captured photo is not from a bracketed capture where OIS was
// requested, this property’s value is
// [AVCaptureLensStabilizationStatusOff]. Otherwise, this property indicates
// how the device applied OIS across the duration of the bracketed capture.
//
