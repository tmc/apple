...
// [AVCaptureFlashModeAuto] or [AVCaptureFlashModeOn] as the flash mode,
...
// value of this property is [AVCapturePhotoQualityPrioritizationBalanced]. If
// you instead attach it to an [AVCaptureMultiCamSession], the default value
// is [AVCapturePhotoQualityPrioritizationSpeed].
//
