...
// # Discussion
// 
// If [AppleProRAWSupported] returns [true], you can enable Apple ProRAW
// capture by setting this property to [true]. Compared to photos taken in
// Bayer RAW format, the system demosaics and partially processes Apple ProRAW
// photos. They’re still scene-referred, however, and allow capturing RAW
// photos in modes that don’t have a traditional Bayer RAW format available,
// such as modes that rely on fusing multiple captures.
// 
...
// in a change to this property value. When the property changes from [true]
// to [false], [ContentAwareDistortionCorrectionEnabled] also reverts to
// [false].
// 
// This property is key-value observable.
//
...
// [StartRunning] on the capture session.
//
// [true]: https://developer.apple.com/documentation/Swift/true
//
...
// [CaptureFlashModeOff], this property’s value is always [false].
// 
// This property supports key-value observing.
//
// [false]: https://developer.apple.com/documentation/Swift/false
...
// property of this photo settings object to [CaptureFlashModeOff], the photo
// output’s [IsFlashScene] property reports [false] regardless of lighting
// conditions in the visible scene. If you set this photo settings object’s
// [FlashMode] property to [CaptureFlashModeAuto] or [CaptureFlashModeOn], the
// photo output’s [IsFlashScene] property reverts to its default behavior of
// returning [true] or [false] based on the visible light level.
// 
// The default value is an [AVCapturePhotoSettings] object with the following
// settings:
// 
// - [FlashMode]: [CaptureFlashModeAuto] -
...
// [DualCameraDualPhotoDeliveryEnabled] property’s value also becomes
// [false].
// 
// This property is key-value observable.
//
