...
// method. - The [isHighResolutionPhotoEnabled] setting may be [true] or
// [false], but that setting applies only to the separate processed image.
// 
...
// # Discussion
// 
// The default value is [false]. Enabling this setting introduces a small
// amount of latency when processing the photo request.
//
// [false]: https://developer.apple.com/documentation/Swift/false
//
...
// [CaptureFlashModeOn] setting. If you explicitly enable the flash, the photo
// output ignores your image stabilization setting, and the
...
// 
// - The photo output’s [LivePhotoCaptureEnabled] property must be [true],
// and its and [LivePhotoCaptureSuspended] property must be [false]. - The URL
// you specify must be a file URL to an accessible location in your app’s
...
// # Discussion
// 
// When this property is [false] (the default), the capture output produces
// only photo data and metadata.
// 
...
// # Discussion
// 
// When this property is [true] (the default), and depth data capture is
// enabled with the [DepthDataDeliveryEnabled] property, the [AVCapturePhoto]
// class includes the depth map as an embedded attachment when you flatten the
// photo data for output in compatible file formats.
// 
...
// 
// When this property is [true] (the default), and depth data capture is
// enabled with the [DepthDataDeliveryEnabled] property, the capture system
// smooths noise and fills in missing values (caused by low light or lens
// occlusion) in depth data maps by temporally interpolating between previous
// and subsequent frames of captured depth data.
// 
...
// represented as [NaN].) Set this property to [false] to disable filtering
...
// [false]. AV Foundation includes the portrait effects matte only if both
// this property and [PortraitEffectsMatteDeliveryEnabled] are set to [true].
//
// [false]: https://developer.apple.com/documentation/Swift/false
// [true]: https://developer.apple.com/documentation/Swift/true
//
