...
// [FlashMode].
// 
// If you specify a flash mode of [CaptureFlashModeAuto] when requesting a
...
// 
// When this value is [true], the device automatically applies stabilization
// in low-light conditions to counteract hand shake. Automatic stabilization
