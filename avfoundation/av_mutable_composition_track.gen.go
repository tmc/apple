...
type IAVMutableCompositionTrack interface {
	...
	InsertTimeRangeOfTrackAtTimeError(timeRange objectivec.IObject, track IAVAssetTrack, startTime objectivec.IObject) (bool, error)
	// Inserts the time ranges of multiple source tracks into a track of a composition.
	InsertTimeRangesOfTracksAtTimeError(timeRanges []foundation.NSValue, tracks []AVAssetTrack, startTime objectivec.IObject) (bool, error)
	...
	ReplaceFormatDescriptionWithFormatDescription(originalFormatDescription objectivec.IObject, replacementFormatDescription objectivec.IObject)
...
func (m AVMutableCompositionTrack) InsertEmptyTimeRange(timeRange objectivec.IObject) {
...
func (m AVMutableCompositionTrack) InsertTimeRangeOfTrackAtTimeError(timeRange objectivec.IObject, track IAVAssetTrack, startTime objectivec.IObject) (bool, error) {
...
func (m AVMutableCompositionTrack) InsertTimeRangesOfTracksAtTimeError(timeRanges []foundation.NSValue, tracks []AVAssetTrack, startTime objectivec.IObject) (bool, error) {
	var errorPtr objc.ID
...
func (m AVMutableCompositionTrack) RemoveTimeRange(timeRange objectivec.IObject) {
...
func (m AVMutableCompositionTrack) ScaleTimeRangeToDuration(timeRange objectivec.IObject, duration objectivec.IObject) {
...
//
// originalFormatDescription is a [coremedia.CMFormatDescriptionRef].
//
// replacementFormatDescription is a [coremedia.CMFormatDescriptionRef].
//
// See: https://developer.apple.com/documentation/AVFoundation/AVMutableCompositionTrack/replaceFormatDescription(_:with:)
func (m AVMutableCompositionTrack) ReplaceFormatDescriptionWithFormatDescription(originalFormatDescription objectivec.IObject, replacementFormatDescription objectivec.IObject) {
