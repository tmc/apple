...
type IAVPlayer interface {
	...
	SourceClock() objectivec.IObject
	SetSourceClock(value objectivec.IObject)
	// The host clock for item time bases.
	MasterClock() objectivec.IObject
	SetMasterClock(value objectivec.IObject)
...
func (p AVPlayer) CurrentTime() objectivec.IObject {
...
func (p AVPlayer) AddPeriodicTimeObserverForIntervalQueueUsingBlock(interval objectivec.IObject, queue dispatch.Queue, block CMTimeHandler) objectivec.IObject {
...
func (p AVPlayer) SeekToTime(time objectivec.IObject) {
...
func (p AVPlayer) SeekToTimeCompletionHandler(time objectivec.IObject, completionHandler BoolHandler) {
...
func (p AVPlayer) SeekToTimeToleranceBeforeToleranceAfter(time objectivec.IObject, toleranceBefore objectivec.IObject, toleranceAfter objectivec.IObject) {
...
func (p AVPlayer) SeekToTimeToleranceBeforeToleranceAfterCompletionHandler(time objectivec.IObject, toleranceBefore objectivec.IObject, toleranceAfter objectivec.IObject, completionHandler BoolHandler) {
...
func (p AVPlayer) SetRateTimeAtHostTime(rate float32, itemTime objectivec.IObject, hostClockTime objectivec.IObject) {
...
func (p AVPlayer) SourceClock() objectivec.IObject {
	rv := objc.Send[objc.ID](p.ID, objc.Sel("sourceClock"))
	return objectivec.Object{ID: rv}
}
func (p AVPlayer) SetSourceClock(value objectivec.IObject) {
...
func (p AVPlayer) MasterClock() objectivec.IObject {
	rv := objc.Send[objc.ID](p.ID, objc.Sel("masterClock"))
	return objectivec.Object{ID: rv}
}
func (p AVPlayer) SetMasterClock(value objectivec.IObject) {
...
func (p AVPlayer) AddPeriodicTimeObserverForIntervalQueueUsingBlockSync(ctx context.Context, interval objectivec.IObject, queue dispatch.Queue) (objectivec.IObject, error) {
...
// It blocks until the completion handler fires or the context is cancelled.
func (p AVPlayer) SeekToTimeSync(ctx context.Context, time objectivec.IObject) (bool, error) {
...
// It blocks until the completion handler fires or the context is cancelled.
func (p AVPlayer) SeekToTimeToleranceBeforeToleranceAfterSync(ctx context.Context, time objectivec.IObject, toleranceBefore objectivec.IObject, toleranceAfter objectivec.IObject) (bool, error) {
	done := make(chan bool, 1)
