...
func (ac AVPlayerItemSegmentClass) Class() objc.Class {
	return ac.class
}
...
//   - [AVPlayerItemSegment.LoadedTimeRanges]: The time ranges for the segment that have media data is readily available.
...
//   - [IAVPlayerItemSegment.LoadedTimeRanges]: The time ranges for the segment that have media data is readily available.
...
func (p AVPlayerItemSegment) StartDate() foundation.NSDate {
