...
func (o AVCaptureFileOutputDelegateObject) CaptureOutputDidOutputSampleBufferFromConnection(output IAVCaptureFileOutput, sampleBuffer coremedia.CMSampleBufferRef, connection IAVCaptureConnection) {
