...
type CFAllocatorContext struct {
	Version         CFIndex                            // An integer of type [CFIndex]. Assign the version number of the allocator. Currently the only valid value is 0.
	...
	Deallocate      CFAllocatorDeallocateCallBack      // A prototype for a function callback that deallocates a given block of memory. In implementing this function, make the block of memory pointed to by `ptr` available for subsequent reuse by the allocator but unavailable for continued use by the program. The `ptr` parameter cannot be [NULL] and if the `ptr` parameter is not a block of memory that has been previously allocated by the allocator, the results are undefined; abnormal program termination can occur. You can set this callback to [NULL], in which case the [CFAllocatorDeallocate(_:_:)](<https://developer.apple.com/documentation/CoreFoundation/CFAllocatorDeallocate(_:_:)>) function has no effect.
...
type CFArrayCallBacks struct {
	Version         CFIndex                        // The version number of this structure. If not one of the defined version numbers for this opaque type, the behavior is undefined. The current version of this structure is 0.
	Retain          CFArrayRetainCallBack          // The callback used to retain each value as they are added to the collection. If [NULL], values are not retained. See [CFArrayRetainCallBack](<https://developer.apple.com/documentation/CoreFoundation/CFArrayRetainCallBack>) for a description of this callback.
	Release         CFArrayReleaseCallBack         // The callback used to release values as they are removed from the collection. If [NULL], values are not released. See [CFArrayReleaseCallBack](<https://developer.apple.com/documentation/CoreFoundation/CFArrayReleaseCallBack>) for a description of this callback.
	CopyDescription CFArrayCopyDescriptionCallBack // The callback used to create a descriptive string representation of each value in the collection. If [NULL], the collection will create a simple description of each value. See [CFArrayCopyDescriptionCallBack](<https://developer.apple.com/documentation/CoreFoundation/CFArrayCopyDescriptionCallBack>) for a description of this callback.
	Equal           CFArrayEqualCallBack           // The callback used to compare values in the array for equality for some operations. If [NULL], the collection will use pointer equality to compare values in the collection. See [CFArrayEqualCallBack](<https://developer.apple.com/documentation/CoreFoundation/CFArrayEqualCallBack>) for a description of this callback.
...
type CFBagCallBacks struct {
	Version         CFIndex                      // The version number of this structure. If not one of the defined version numbers for this opaque type, the behavior is undefined. The current version of this structure is 0.
	Retain          CFBagRetainCallBack          // The callback used to retain each value as they are added to the collection. If [NULL], values are not retained. See [CFBagRetainCallBack](<https://developer.apple.com/documentation/CoreFoundation/CFBagRetainCallBack>) for a descriptions of this function’s parameters.
	Release         CFBagReleaseCallBack         // The callback used to release values as they are removed from the collection. If [NULL], values are not released. See [CFBagReleaseCallBack](<https://developer.apple.com/documentation/CoreFoundation/CFBagReleaseCallBack>) for a description of this callback.
	CopyDescription CFBagCopyDescriptionCallBack // The callback used to create a descriptive string representation of each value in the collection. If [NULL], the collection will create a simple description of each value. See [CFBagCopyDescriptionCallBack](<https://developer.apple.com/documentation/CoreFoundation/CFBagCopyDescriptionCallBack>) for a description of this callback.
	Equal           CFBagEqualCallBack           // The callback used to compare values in the collection for equality for some operations. If [NULL], the collection will use pointer equality to compare values in the collection. See [CFBagEqualCallBack](<https://developer.apple.com/documentation/CoreFoundation/CFBagEqualCallBack>) for a description of this callback.
	Hash            CFBagHashCallBack            // The callback used to compute a hash code for values in a collection. If [NULL], the collection computes a hash code by converting the pointer value to an integer. See [CFBagHashCallBack](<https://developer.apple.com/documentation/CoreFoundation/CFBagHashCallBack>) for a description of this callback.
...
type CFBinaryHeapCallBacks struct {
	Version         CFIndex                                                                 // The version number of the structure type being passed in as a parameter to the [CFBinaryHeap] creation functions. This structure is version `0`.
	Retain          func(CFAllocatorRef, unsafe.Pointer) CFTypeRef                          // Callback function used to retain a value being added to a binary heap.
	Release         func(CFAllocatorRef, unsafe.Pointer)                                    // Callback function used to release a value before it is removed from a binary heap.
	CopyDescription func(unsafe.Pointer) CFStringRef                                        // Callback function used to get a description of a value in a binary heap.
...
type CFBinaryHeapCompareContext struct {
	Version         CFIndex
	Info            unsafe.Pointer
	Retain          func(unsafe.Pointer) CFTypeRef
	Release         func(unsafe.Pointer)
	CopyDescription func(unsafe.Pointer) CFStringRef
}
...
type CFDictionaryKeyCallBacks struct {
	Version         CFIndex                             // The version number of this structure. If not one of the defined version numbers for this opaque type, the behavior is undefined. The current version of this structure is 0.
	Retain          CFDictionaryRetainCallBack          // The callback used to retain each key as they are added to the collection. This callback returns the value to use as the key in the dictionary, which is usually the value parameter passed to this callback, but may be a different value if a different value should be used as the key. If [NULL], keys are not retained. See [CFDictionaryRetainCallBack](<https://developer.apple.com/documentation/CoreFoundation/CFDictionaryRetainCallBack>) for a descriptions of this function’s parameters.
	Release         CFDictionaryReleaseCallBack         // The callback used to release keys as they are removed from the dictionary. If [NULL], keys are not released. See [CFDictionaryReleaseCallBack](<https://developer.apple.com/documentation/CoreFoundation/CFDictionaryReleaseCallBack>) for a description of this callback.
	CopyDescription CFDictionaryCopyDescriptionCallBack // The callback used to create a descriptive string representation of each key in the dictionary. If [NULL], the collection will create a simple description of each key. See [CFDictionaryCopyDescriptionCallBack](<https://developer.apple.com/documentation/CoreFoundation/CFDictionaryCopyDescriptionCallBack>) for a description of this callback.
	Equal           CFDictionaryEqualCallBack           // The callback used to compare keys in the dictionary for equality. If [NULL], the collection will use pointer equality to compare keys in the collection. See [CFDictionaryEqualCallBack](<https://developer.apple.com/documentation/CoreFoundation/CFDictionaryEqualCallBack>) for a description of this callback.
	Hash            CFDictionaryHashCallBack            // The callback used to compute a hash code for keys as they are used to access, add, or remove values in the dictionary. If [NULL], the collection computes a hash code by converting the pointer value to an integer. See [CFDictionaryHashCallBack](<https://developer.apple.com/documentation/CoreFoundation/CFDictionaryHashCallBack>) for a description of this callback.
...
type CFDictionaryValueCallBacks struct {
	...
	Release         CFDictionaryReleaseCallBack         // The callback used to release values as they are removed from the dictionary. If [NULL], values are not released. See [CFDictionaryReleaseCallBack](<https://developer.apple.com/documentation/CoreFoundation/CFDictionaryReleaseCallBack>) for a description of this callback.
...
type CFFileDescriptorContext struct {
	Version         CFIndex // The version number of this structure. If not one of the defined version numbers for this opaque type, the behavior is undefined. The current version of this structure is 0.
	Info            unsafe.Pointer
	Retain          func(unsafe.Pointer) LPVOID      // The retain callback used by the CFFileDescriptor.
	Release         func(unsafe.Pointer)             // The release callback used by the CFFileDescriptor.
	CopyDescription func(unsafe.Pointer) CFStringRef // The callback used to create a descriptive string representation of the CFFileDescriptor.
...
type CFMachPortContext struct {
	Version         CFIndex                          // Version number of the structure. Must be `0`.
	...
	Retain          func(unsafe.Pointer) CFTypeRef   // A retain callback for your program-defined `info` pointer. Can be [NULL].
	Release         func(unsafe.Pointer)             // A release callback for your program-defined `info` pointer. Can be [NULL].
	CopyDescription func(unsafe.Pointer) CFStringRef // A copy description callback for your program-defined `info` pointer. Can be [NULL].
...
type CFRange struct {
	Location CFIndex // An integer representing the starting location of the range. For type compatibility with the rest of the system, `LONG_MAX` is the maximum value you should use for location.
	Length   CFIndex // An integer representing the number of items in the range. For type compatibility with the rest of the system, `LONG_MAX` is the maximum value you should use for length.
...
type CFRunLoopSourceContext struct {
	...
	Schedule        func(unsafe.Pointer, CFRunLoopRef, CFStringRef) // A scheduling callback for the run loop source. This callback is called when the source is added to a run loop mode. Can be [NULL].
	Cancel          func(unsafe.Pointer, CFRunLoopRef, CFStringRef)
...
type CFRunLoopSourceContext1 struct {
	Version         CFIndex                                                          // Version number of the structure. Must be 1.
	...
	Equal           func(unsafe.Pointer, unsafe.Pointer) uint8                       // An equality test callback for your program-defined `info` pointer. Can be [NULL].
	Hash            func(unsafe.Pointer) uint                                        // A hash calculation callback for your program-defined `info` pointer. Can be [NULL].
	GetPort         func(unsafe.Pointer) uint32                                      // A callback to retrieve the native Mach port represented by the source. This callback is called when the source is either added to or removed from a run loop mode.
	Perform         func(unsafe.Pointer, int, CFAllocatorRef, unsafe.Pointer) LPVOID // A perform callback for the run loop source. This callback is called when the source has fired.
...
type CFSetCallBacks struct {
	Version         CFIndex                      // The version number of this structure. If not one of the defined version numbers for this opaque type, the behavior is undefined. The current version of this structure is `0`.
	Retain          CFSetRetainCallBack          // The callback used to retain each value as they are added to the collection. If [NULL], values are not retained. See [CFSetRetainCallBack](<https://developer.apple.com/documentation/CoreFoundation/CFSetRetainCallBack>) for a descriptions of this function’s parameters.
	Release         CFSetReleaseCallBack         // The callback used to release values as they are removed from the collection. If [NULL], values are not released. See [CFSetReleaseCallBack](<https://developer.apple.com/documentation/CoreFoundation/CFSetReleaseCallBack>) for a description of this callback.
	CopyDescription CFSetCopyDescriptionCallBack // The callback used to create a descriptive string representation of each value in the collection. If [NULL], the collection will create a simple description of each value. See [CFSetCopyDescriptionCallBack](<https://developer.apple.com/documentation/CoreFoundation/CFSetCopyDescriptionCallBack>) for a description of this callback.
	Equal           CFSetEqualCallBack           // The callback used to compare values in the collection for equality for some operations. If [NULL], the collection will use pointer equality to compare values in the collection. See [CFSetEqualCallBack](<https://developer.apple.com/documentation/CoreFoundation/CFSetEqualCallBack>) for a description of this callback.
	Hash            CFSetHashCallBack            // The callback used to compute a hash code for values in a collection. If [NULL], the collection computes a hash code by converting the pointer value to an integer. See [CFSetHashCallBack](<https://developer.apple.com/documentation/CoreFoundation/CFSetHashCallBack>) for a description of this callback.
...
type CFStreamClientContext struct {
	Version         CFIndex                          // Version number of the structure. Must be `0`.
	Info            unsafe.Pointer                   // An arbitrary pointer to program-defined data, which can be associated with the client. This pointer is passed to the callbacks defined in the context and to the client callback function [CFReadStreamClientCallBack](<https://developer.apple.com/documentation/CoreFoundation/CFReadStreamClientCallBack>).
	Retain          func(unsafe.Pointer) LPVOID      // A retain callback for your program-defined `info` pointer. Can be [NULL].
	Release         func(unsafe.Pointer)             // A release callback for your program-defined `info` pointer. Can be [NULL].
	CopyDescription func(unsafe.Pointer) CFStringRef // A copy description callback for your program-defined `info` pointer. Can be [NULL].

}

// CFStreamError - The structure returned by [CFReadStreamGetError(_:)](<https://developer.apple.com/documentation/CoreFoundation/CFReadStreamGetError(_:)>) and [CFWriteStreamGetError(_:)](<https://developer.apple.com/documentation/CoreFoundation/CFWriteStreamGetError(_:)>).
//
// [Full Topic]
// [Full Topic]: https://developer.apple.com/documentation/CoreFoundation/CFStreamError
type CFStreamError struct {
	Domain CFIndex // The error domain that should be used to interpret the error. See [CFStreamErrorDomain](<https://developer.apple.com/documentation/CoreFoundation/CFStreamErrorDomain>) for possible values.
...
type CFTreeContext struct {
	Version         CFIndex                       // The version number of the structure type being passed in as a parameter to a CFTree creation function. This structure is version `0`.
...
type CFXMLAttributeListDeclarationInfo struct {
	NumberOfAttributes CFIndex                        // The number of attributes in the array.
...
type CFXMLDocumentInfo struct {
	...
	Encoding  CFStringEncoding // The text encoding of the XML document.
...
type CFXMLParserCallBacks struct {
	Version               CFIndex                                  // Version number. Must be `0`.
...
type CFXMLParserContext struct {
	Version         CFIndex                            // Version number of this structure. Must be 0.
	Info            unsafe.Pointer                     // An arbitrary program-defined value passed to all the callbacks in this structure and in the [CFXMLParserCallBacks](<https://developer.apple.com/documentation/CoreFoundation/CFXMLParserCallBacks>) structure.
...
type CGVector struct {
	Dx CGFloat // The x component of the vector.
	Dy CGFloat // The y component of the vector.
...
type IUnknownVTbl struct {
	...
	QueryInterface func(unsafe.Pointer, CFUUIDBytes, unsafe.Pointer) int32
