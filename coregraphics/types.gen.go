...
type CGDataConsumerCallbacks struct {
	PutBytes        CGDataConsumerPutBytesCallback    // A pointer to a function that copies data to the data consumer. For more information, see [CGDataConsumerPutBytesCallback](<https://developer.apple.com/documentation/CoreGraphics/CGDataConsumerPutBytesCallback>).
...
type CGDataProviderDirectCallbacks struct {
	Version            uint32                                   // The version of this structure. It should be set to 0.
	GetBytePointer     CGDataProviderGetBytePointerCallback     // A pointer to a function that returns a pointer to the provider’s data. For more information, see [CGDataProviderGetBytePointerCallback](<https://developer.apple.com/documentation/CoreGraphics/CGDataProviderGetBytePointerCallback>).
	...
	ReleaseInfo        CGDataProviderReleaseInfoCallback        // A pointer to a function that handles clean-up for the data provider, or [NULL]. For more information, see [CGDataProviderReleaseInfoCallback](<https://developer.apple.com/documentation/CoreGraphics/CGDataProviderReleaseInfoCallback>).
...
type CGDataProviderSequentialCallbacks struct {
	Version     uint32                            // The version of this structure. It should be set to 0.
	GetBytes    CGDataProviderGetBytesCallback    // A pointer to a function that copies data from the provider. For more information, see [CGDataProviderGetBytesCallback](<https://developer.apple.com/documentation/CoreGraphics/CGDataProviderGetBytesCallback>).
	...
	Rewind      CGDataProviderRewindCallback      // A pointer to a function Core Graphics calls to return the provider to the beginning of the data stream. For more information, see [CGDataProviderRewindCallback](<https://developer.apple.com/documentation/CoreGraphics/CGDataProviderRewindCallback>).
	ReleaseInfo CGDataProviderReleaseInfoCallback // A pointer to a function that handles clean-up for the data provider, or [NULL]. For more information, see [CGDataProviderReleaseInfoCallback](<https://developer.apple.com/documentation/CoreGraphics/CGDataProviderReleaseInfoCallback>).
...
type CGFunctionCallbacks struct {
	Version     uint32                        // The structure version number. For this structure,the version should be `0`.
...
type CGPSConverterCallbacks struct {
	Version       uint32                             // The version number of the structure passed in as a parameter to the converter creation functions. The structure defined below is version `0`.
...
type CGPatternCallbacks struct {
	Version     uint32                       // The version of the structure passed in as a parameterto the [init(info:bounds:matrix:xStep:yStep:tiling:isColored:callbacks:)](<https://developer.apple.com/documentation/CoreGraphics/CGPattern/init(info:bounds:matrix:xStep:yStep:tiling:isColored:callbacks:)>). Forthis version of the structure, you should set this value to zero.
	DrawPattern CGPatternDrawPatternCallback // A pointer to a custom function that draws thepattern. For information about this callback function, see [CGPatternDrawPatternCallback](<https://developer.apple.com/documentation/CoreGraphics/CGPatternDrawPatternCallback>).
	ReleaseInfo CGPatternReleaseInfoCallback // An optional pointer to a custom function that’sinvoked when the pattern is released. [CGPatternReleaseInfoCallback](<https://developer.apple.com/documentation/CoreGraphics/CGPatternReleaseInfoCallback>).
