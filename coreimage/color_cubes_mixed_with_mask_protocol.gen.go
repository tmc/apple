...
type CIColorCubesMixedWithMask interface {
	...
	Cube0Data() foundation.NSData
	SetCube0Data(value foundation.NSData)

	// The cube texture data to use as a color lookup table.
	//
	// See: https://developer.apple.com/documentation/CoreImage/CIColorCubesMixedWithMask/cube1Data
	Cube1Data() foundation.NSData
	SetCube1Data(value foundation.NSData)
...
//
// See: https://developer.apple.com/documentation/CoreImage/CIColorCubesMixedWithMask/cube0Data
func (o CIColorCubesMixedWithMaskObject) Cube0Data() foundation.NSData {
	rv := objc.Send[objc.ID](o.ID, objc.Sel("cube0Data"))
	return foundation.NSDataFromID(rv)
}

func (o CIColorCubesMixedWithMaskObject) SetCube0Data(value foundation.NSData) {
...
//
// See: https://developer.apple.com/documentation/CoreImage/CIColorCubesMixedWithMask/cube1Data
func (o CIColorCubesMixedWithMaskObject) Cube1Data() foundation.NSData {
	rv := objc.Send[objc.ID](o.ID, objc.Sel("cube1Data"))
	return foundation.NSDataFromID(rv)
}

func (o CIColorCubesMixedWithMaskObject) SetCube1Data(value foundation.NSData) {
