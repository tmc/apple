...
const (
	...
	KCMAudioFormatDescriptionMask_All KCMAudioFormatDescriptionMask = 1
...
const (
	...
	KCMBlockBufferAlwaysCopyDataFlag KCMBlockBuffer = 2
	...
	KCMBlockBufferAssureMemoryNowFlag KCMBlockBuffer = 1
	// KCMBlockBufferBadCustomBlockSourceErr: An error code that indicates the custom block source is invalid.
	KCMBlockBufferBadCustomBlockSourceErr KCMBlockBuffer = -12702
	...
	KCMBlockBufferBadLengthParameterErr KCMBlockBuffer = -12704
	...
	KCMBlockBufferBadOffsetParameterErr KCMBlockBuffer = -12703
	// KCMBlockBufferBadPointerParameterErr: An error code that indicates the block buffer reference is invalid.
	KCMBlockBufferBadPointerParameterErr KCMBlockBuffer = -12705
	...
	KCMBlockBufferInsufficientSpaceErr KCMBlockBuffer = -12708
	...
	KCMBlockBufferPermitEmptyReferenceFlag KCMBlockBuffer = 8
	...
	KCMBlockBufferStructureAllocationFailedErr KCMBlockBuffer = -12700
	// KCMBlockBufferUnallocatedBlockErr: An error code that indicates the system encountered an unallocated memory block.
	KCMBlockBufferUnallocatedBlockErr KCMBlockBuffer = -12707
)
...
func (e KCMBlockBuffer) String() string {
	...
	case KCMBlockBufferAssureMemoryNowFlag:
...
const (
	...
	KCMMediaType_Audio            KCMMediaType = 's'<<24 | 'o'<<16 | 'u'<<8 | 'n' // 'soun'
	KCMMediaType_AuxiliaryPicture KCMMediaType = 'a'<<24 | 'u'<<16 | 'x'<<8 | 'v' // 'auxv'
	// KCMMediaType_ClosedCaption: Closed-caption media.
	KCMMediaType_ClosedCaption KCMMediaType = 'c'<<24 | 'l'<<16 | 'c'<<8 | 'p' // 'clcp'
	// KCMMediaType_Metadata: Meta data.
	KCMMediaType_Metadata KCMMediaType = 'm'<<24 | 'e'<<16 | 't'<<8 | 'a' // 'meta'
	// KCMMediaType_Muxed: Muxed media.
	KCMMediaType_Muxed KCMMediaType = 'm'<<24 | 'u'<<16 | 'x'<<8 | 'x' // 'muxx'
	// KCMMediaType_Subtitle: Subtitle media.
	KCMMediaType_Subtitle KCMMediaType = 's'<<24 | 'b'<<16 | 't'<<8 | 'l' // 'sbtl'
	// KCMMediaType_TaggedBufferGroup: Media containing a tagged buffer group.
	KCMMediaType_TaggedBufferGroup KCMMediaType = 't'<<24 | 'b'<<16 | 'g'<<8 | 'r' // 'tbgr'
	// KCMMediaType_Text: Text media.
	KCMMediaType_Text KCMMediaType = 't'<<24 | 'e'<<16 | 'x'<<8 | 't' // 'text'
	// KCMMediaType_TimeCode: Time code media.
	KCMMediaType_TimeCode KCMMediaType = 't'<<24 | 'm'<<16 | 'c'<<8 | 'd' // 'tmcd'
	// KCMMediaType_Video: Video media.
	KCMMediaType_Video KCMMediaType = 'v'<<24 | 'i'<<16 | 'd'<<8 | 'e' // 'vide'
)
