...
var _cMIOSampleBufferCreateNoDataMarker func(allocator corefoundation.CFAllocatorRef, noDataEvent uint32, formatDescription uintptr, sequenceNumber uint64, discontinuityFlags uint32, sBufOut *coremedia.CMSampleBufferRef) int32
var _cMIOSampleBufferCreateNoDataMarkerErr error

func tryCMIOSampleBufferCreateNoDataMarker(allocator corefoundation.CFAllocatorRef, noDataEvent uint32, formatDescription uintptr, sequenceNumber uint64, discontinuityFlags uint32, sBufOut *coremedia.CMSampleBufferRef) (int32, error) {
