...
func NewAEDisposeExternalProcPtrBlock(handler AEDisposeExternalProcPtr) (objc.ID, func()) {
	...
	block := objc.NewBlock(func(b objc.Block, primitive unsafe.Pointer, extra0 corefoundation.CGSize, extra1 uintptr) {
...
func NewFSEventStreamCallbackBlock(handler FSEventStreamCallback) (objc.ID, func()) {
	...
	block := objc.NewBlock(func(b objc.Block, primitive ConstFSEventStreamRef, extra0 unsafe.Pointer, extra1 int, extra2 unsafe.Pointer, extra3 unsafe.Pointer, extra4 unsafe.Pointer) {
