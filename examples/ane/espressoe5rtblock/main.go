// Command espressoe5rtblock runs a transformer block on the Neural Engine through the
...
// this one.
//
//	go run ./examples/ane/espressoe5rtblock
//	go run ./examples/ane/espressoe5rtblock -dim 128 -heads 8 -seq 32 -hidden 256
package main
