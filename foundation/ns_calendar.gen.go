...
//
// If you specify a “wrap” option ([NSCalendarWrapComponents]), the
...
// can set the value to true to stop further processing of the array. The stop
...
//
// If you specify a strict matching option ([NSCalendarMatchStrictly]), this
...
// day is used. - If [NSCalendarMatchPreviousTimePreservingSmallerUnits] is
// specified, “1:37AM” would be used instead, if that time exists. - If
// [NSCalendarMatchNextTimePreservingSmallerUnits] is specified, the date at
// the time “3:37AM” would be used instead, if that time exists. - If
// [NSCalendarMatchNextTime] is specified, the date at the time “3:00AM”
...
// [NSCalendarMatchFirst] was specified.
//
...
// day. The [NSCalendarMatchFirst] and [NSCalendarMatchLast] search options
// return the first and last occurrence of these times.
//
// [media-2852012]
//
// Forward & Backward Search
//
// If you specify a backward search option ([NSCalendarSearchBackwards]), this
...
// ([NSCalendarSearchBackwards]), the starting date and time interval range of
...
// # Return Value
//
// true if both dates have equal date component for all units greater than or
// equal to the given unit, otherwise false.
//
