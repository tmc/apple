...
//
// [NSAggregateExpressionType] allows you to create predicates containing
...
//
// The [NSSubqueryExpressionType] creates a subexpression that returns a
// subset of a collection of objects. This allows you to create sophisticated
// queries across relationships, such as a search for multiple correlated
// values on the destination object of a relationship.
//
// # Set Expressions
//
// The set expressions ([NSUnionSetExpressionType],
// [NSIntersectSetExpressionType], and [NSMinusSetExpressionType]) combine
// results in a manner similar to the [NSSet] methods.
//
