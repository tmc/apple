...
//
// You must set a predicate with the [NSMetadataQuery.Predicate] property
...
type INSMetadataQuery interface {
	...
	EnumerateResultsUsingBlock(block IObjectUintBoolHandler)
	// Enumerates the current set of results using the given options and block.
	EnumerateResultsWithOptionsUsingBlock(opts NSEnumerationOptions, block IObjectUintBoolHandler)
...
//
// A query may fail to start if it does not specify a
// [NSMetadataQuery.Predicate], or if the query has already been started.
//
// # Discussion
//
...
//
// This method must be called from the receiver’s
// [NSMetadataQuery.OperationQueue] or on the main thread. For example:
//
...
// rather than the array returned by [NSMetadataQuery.Results].
//
...
// it upon completion. Use
// [NSMetadataQuery.EnumerateResultsWithOptionsUsingBlock] if you want to use
// concurrent or reverse iteration.
//
...
// attribute must be specified in [NSMetadataQuery.ValueListAttributes], as a
// sorting key in a specified sort descriptor, or as one of the grouping
// attributes specified set for the query.
//
...
// # Discussion
//
// Unless you use [NSMetadataQuery.EnumerateResultsUsingBlock] or
// [NSMetadataQuery.EnumerateResultsWithOptionsUsingBlock], you should invoke
// this method after you’re done iterating over the query results.
//
...
// Unless you use [NSMetadataQuery.EnumerateResultsUsingBlock] or
// [NSMetadataQuery.EnumerateResultsWithOptionsUsingBlock], you should invoke
// this method before iterating over query results that could change due to
// live updates.
//
...
// result array elements, use the [NSMetadataQuery.ResultCount] and
// [NSMetadataQuery.ResultAtIndex] methods.
//
...
// `count` on [NSMetadataQuery.Results].
//
