...
func NSMetadataQueryFromID(id objc.ID) NSMetadataQuery {
	return NSMetadataQuery{objectivec.Object{id}}
}
...
type INSMetadataQuery interface {
	...
	EnumerateResultsUsingBlock(block bool)
	// Enumerates the current set of results using the given options and block.
	EnumerateResultsWithOptionsUsingBlock(opts NSEnumerationOptions, block bool)
...
func (m NSMetadataQuery) EnumerateResultsUsingBlock(block bool) {
	objc.Send[objc.ID](m.ID, objc.Sel("enumerateResultsUsingBlock:"), block)
}
...
func (m NSMetadataQuery) EnumerateResultsWithOptionsUsingBlock(opts NSEnumerationOptions, block bool) {
	objc.Send[objc.ID](m.ID, objc.Sel("enumerateResultsWithOptions:usingBlock:"), opts, block)
}
