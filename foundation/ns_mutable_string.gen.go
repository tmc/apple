...
func (nc NSMutableStringClass) Class() objc.Class {
	return nc.class
}
...
// method—[NSMutableString.ReplaceCharactersInRangeWithString]—to the
// basic string-handling behavior inherited from [NSString]. All other methods
// that modify a string work through this method. For example,
// [NSMutableString.InsertStringAtIndex] simply replaces the characters in a
// range of `0` length, while [NSMutableString.DeleteCharactersInRange]
...
// [Formatting String Objects]: https://developer.apple.com/library/archive/documentation/Cocoa/Conceptual/Strings/Articles/FormatStrings.html#//apple_ref/doc/uid/20000943
// [String Format Specifiers]: https://developer.apple.com/library/archive/documentation/CoreFoundation/Conceptual/CFStrings/formatSpecifiers.html#//apple_ref/doc/uid/TP40004265
func NewMutableStringWithFormatArguments(format string, argList kernel.VaList) NSMutableString {
	instance := getNSMutableStringClass().Alloc()
...
func NewMutableStringWithFormatLocaleArguments(format string, locale objectivec.IObject, argList kernel.VaList) NSMutableString {
	instance := getNSMutableStringClass().Alloc()
...
func NewMutableStringWithValidatedFormatValidFormatSpecifiersArgumentsError(format string, validFormatSpecifiers string, argList kernel.VaList) (NSMutableString, error) {
	var errorPtr objc.ID
	instance := getNSMutableStringClass().Alloc()
...
func NewMutableStringWithValidatedFormatValidFormatSpecifiersLocaleArgumentsError(format string, validFormatSpecifiers string, locale objectivec.IObject, argList kernel.VaList) (NSMutableString, error) {
	var errorPtr objc.ID
	instance := getNSMutableStringClass().Alloc()
