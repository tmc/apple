...
// you can include the [ActivityLatencyCritical] flag (using a bitwise [OR]).
// You should only use this flag for activities like audio or video recording
// that require high priority I/O.
// 
...
// [EnableSuddenTermination] during your application launch. This allows the
// system to terminate the process immediately. You can still override this
// behavior by invoking [DisableSuddenTermination].
// 
...
func ProcessInfoFromID(id objc.ID) ProcessInfo {
	return NSProcessInfo{objectivec.Object{id}}
}
...
// # Return Value
// 
// [true] if the operating system on which the process is executing is the
// same or later than the given version; otherwise [false].
//
...
// running on a Mac. The value of the property is [false] for all other apps
// on the Mac, including Mac apps built using Mac Catalyst. The property is
// also [false] for processes running on platforms other than macOS.
//
// [false]: https://developer.apple.com/documentation/Swift/false
// [true]: https://developer.apple.com/documentation/Swift/true
//
...
// other apps on visionOS. The property is also [false] for processes running
// on platforms other than visonOS.
//
// [false]: https://developer.apple.com/documentation/Swift/false
// [true]: https://developer.apple.com/documentation/Swift/true
//
