...
// # Discussion
//
// To donate a user activity to Siri Shortcuts, set
// [NSUserActivity.EligibleForPrediction] to true and make the user activity
// current. To make the user activity current, call the activity’s
// [NSUserActivity.BecomeCurrent] method, or assign it to the [userActivity]
// property on a [UIViewController] or [UIResponder] object. For more
// information, see [Donating Shortcuts].
//
...
// [NSUserActivity.NdefMessagePayload] returns a message that contains only
// one [NFCNDEFPayload] record. That record has a [typeNameFormat] of
