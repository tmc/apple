...
// [NSURLBookmarkResolutionWithSecurityScope] option is not supported by this
// method.
//
// # Return Value
//
...
// [NSURLBookmarkCreationWithSecurityScope] flag. When you later resolve the
...
// [NSURLBookmarkCreationWithSecurityScope] option and the
// [NSURLBookmarkCreationSecurityScopeAllowOnlyReadAccess] option.
//
...
// parameter) the [NSURLBookmarkResolutionWithSecurityScope] option.
//
// relativeURL: The base URL that the bookmark data is relative to.
//
...
// # Discussion
//
// The property’s value is true if the receiver uses the file scheme, false
