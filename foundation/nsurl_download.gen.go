...
// # Discussion
//
// If `allowOverwrite` is false and a file already exists at `path`, a unique
// filename will be created for the downloaded file by appending a number to
// the filename. The delegate can implement the [DownloadDidCreateDestination]
// delegate method to determine the filename used when the file is written to
// disk.
//
...
// # Return Value
//
// true if the URL download object can resume a download that was decoded with
// the specified MIME type, false otherwise.
//
// # Discussion
//
...
// # Return Value
//
// true if partially downloaded files should be deleted when a download stops
// prematurely, false otherwise. The default is true.
//
