...
// # Return Value
//
// true if the registration is successful, false otherwise. The only failure
// condition is if `protocolClass` is not a subclass of [NSURLProtocol].
//
// # Discussion
//
...
// # Return Value
//
// true if `aRequest` and `bRequest` are equivalent for cache purposes, false
// otherwise.
//
// # Discussion
//
