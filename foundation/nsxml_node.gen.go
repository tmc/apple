...
func XMLNodeFromID(id objc.ID) XMLNode {
	return NSXMLNode{objectivec.Object{ID: id}}
}
...
//
// resolve: true to resolve character references, predefined entities, and user-defined
// entities as declared in the associated DTD; false otherwise. Namespace and
// processing-instruction nodes have their entities resolved even if `resolve`
// is false.
//
// # Discussion
//
