...
type INSXPCInterface interface {
	...
	SetXPCTypeForSelectorArgumentIndexOfReply(type_ xpc.Xpc_type_t, sel objc.SEL, arg uint, ofReply bool)
	XPCTypeForSelectorArgumentIndexOfReply(sel objc.SEL, arg uint, ofReply bool) xpc.Xpc_type_t
}
...
func NewXPCInterfaceWithProtocol(protocol_ *objectivec.Protocol) NSXPCInterface {
	rv := objc.Send[objc.ID](objc.ID(getNSXPCInterfaceClass().class), objc.Sel("interfaceWithProtocol:"), protocol_.ID)
...
// # Discussion
//
// See [NSXPCInterface.SetClassesForSelectorArgumentIndexOfReply] for more
// explanation.
//
...
// # Discussion
//
// See [NSXPCInterface.SetInterfaceForSelectorArgumentIndexOfReply] for more
// explanation.
//
...
func (x NSXPCInterface) SetXPCTypeForSelectorArgumentIndexOfReply(type_ xpc.Xpc_type_t, sel objc.SEL, arg uint, ofReply bool) {
...
func (x NSXPCInterface) XPCTypeForSelectorArgumentIndexOfReply(sel objc.SEL, arg uint, ofReply bool) xpc.Xpc_type_t {
	rv := objc.Send[xpc.Xpc_type_t](x.ID, objc.Sel("XPCTypeForSelector:argumentIndex:ofReply:"), sel, arg, ofReply)
	return xpc.Xpc_type_t(rv)
}
