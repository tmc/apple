...
//
// See: https://developer.apple.com/documentation/Foundation/URLSessionStreamDelegate
...
// NSURLSessionStreamDelegateObject wraps an existing Objective-C object that conforms to the NSURLSessionStreamDelegate protocol.
type NSURLSessionStreamDelegateObject struct {
	objectivec.Object
}

func (o NSURLSessionStreamDelegateObject) BaseObject() objectivec.Object {
	return o.Object
}

// NSURLSessionStreamDelegateObjectFromID constructs a [NSURLSessionStreamDelegateObject] from an objc.ID.
// The object is determined to conform to the protocol at runtime.
func NSURLSessionStreamDelegateObjectFromID(id objc.ID) NSURLSessionStreamDelegateObject {
	return NSURLSessionStreamDelegateObject{
		Object: objectivec.ObjectFromID(id),
	}
}

// Tells the delegate that a better route to the host has been detected for
// the stream.
//
...
// # Discussion
//
// This method is called when the URL loading system determines that a better
// route to the endpoint host is available. For example, this method may be
// called when a Wi-Fi interface becomes available.
//
// You should consider completing pending work and creating a new stream task
// in order to take advantage of better routes when they become available.
//
// See: https://developer.apple.com/documentation/Foundation/URLSessionStreamDelegate/urlSession(_:betterRouteDiscoveredFor:)
func (o NSURLSessionStreamDelegateObject) URLSessionBetterRouteDiscoveredForStreamTask(session INSURLSession, streamTask INSURLSessionStreamTask) {
	objc.Send[struct{}](o.ID, objc.Sel("URLSession:betterRouteDiscoveredForStreamTask:"), session, streamTask)
}

// Tells the delegate that the stream task has been completed as a result of
// the stream task calling the [NSURLSessionStreamTask.CaptureStreams] method.
//
...
// # Discussion
//
// This delegate method will only be called after all enqueued reads and
// writes for the stream task have been completed.
//
// See: https://developer.apple.com/documentation/Foundation/URLSessionStreamDelegate/urlSession(_:streamTask:didBecome:outputStream:)
func (o NSURLSessionStreamDelegateObject) URLSessionStreamTaskDidBecomeInputStreamOutputStream(session INSURLSession, streamTask INSURLSessionStreamTask, inputStream INSInputStream, outputStream INSOutputStream) {
	objc.Send[struct{}](o.ID, objc.Sel("URLSession:streamTask:didBecomeInputStream:outputStream:"), session, streamTask, inputStream, outputStream)
}

// Tells the delegate that the read side of the underlying socket has been
// closed.
//
...
// # Discussion
//
// This method may be called even if no reads are currently in progress. This
// method does not indicate that the stream reached end-of-file (EOF), such
// that no more data can be read.
//
// See: https://developer.apple.com/documentation/Foundation/URLSessionStreamDelegate/urlSession(_:readClosedFor:)
func (o NSURLSessionStreamDelegateObject) URLSessionReadClosedForStreamTask(session INSURLSession, streamTask INSURLSessionStreamTask) {
	objc.Send[struct{}](o.ID, objc.Sel("URLSession:readClosedForStreamTask:"), session, streamTask)
}

// Tells the delegate that the write side of the underlying socket has been
// closed.
//
...
//
// See: https://developer.apple.com/documentation/Foundation/URLSessionStreamDelegate/urlSession(_:writeClosedFor:)
func (o NSURLSessionStreamDelegateObject) URLSessionWriteClosedForStreamTask(session INSURLSession, streamTask INSURLSessionStreamTask) {
	objc.Send[struct{}](o.ID, objc.Sel("URLSession:writeClosedForStreamTask:"), session, streamTask)
}
...
func (o NSURLSessionStreamDelegateObject) URLSessionDidBecomeInvalidWithError(session INSURLSession, error_ INSError) {
...
func (o NSURLSessionStreamDelegateObject) URLSessionDidFinishEventsForBackgroundURLSession(session INSURLSession) {
...
func (o NSURLSessionStreamDelegateObject) URLSessionDidReceiveChallengeCompletionHandler(session INSURLSession, challenge INSURLAuthenticationChallenge, completionHandler NSURLSessionAuthChallengeDispositionURLCredentialHandler) {
...
func (o NSURLSessionStreamDelegateObject) URLSessionTaskDidCompleteWithError(session INSURLSession, task INSURLSessionTask, error_ INSError) {
...
func (o NSURLSessionStreamDelegateObject) URLSessionTaskWillPerformHTTPRedirectionNewRequestCompletionHandler(session INSURLSession, task INSURLSessionTask, response INSHTTPURLResponse, request INSURLRequest, completionHandler URLRequestHandler) {
...
func (o NSURLSessionStreamDelegateObject) URLSessionTaskDidSendBodyDataTotalBytesSentTotalBytesExpectedToSend(session INSURLSession, task INSURLSessionTask, bytesSent int64, totalBytesSent int64, totalBytesExpectedToSend int64) {
...
func (o NSURLSessionStreamDelegateObject) URLSessionTaskNeedNewBodyStream(session INSURLSession, task INSURLSessionTask, completionHandler InputStreamHandler) {
...
func (o NSURLSessionStreamDelegateObject) URLSessionTaskDidReceiveChallengeCompletionHandler(session INSURLSession, task INSURLSessionTask, challenge INSURLAuthenticationChallenge, completionHandler NSURLSessionAuthChallengeDispositionURLCredentialHandler) {
...
func (o NSURLSessionStreamDelegateObject) URLSessionTaskWillBeginDelayedRequestCompletionHandler(session INSURLSession, task INSURLSessionTask, request INSURLRequest, completionHandler NSURLSessionDelayedRequestDispositionURLRequestHandler) {
...
func (o NSURLSessionStreamDelegateObject) URLSessionTaskIsWaitingForConnectivity(session INSURLSession, task INSURLSessionTask) {
...
func (o NSURLSessionStreamDelegateObject) URLSessionTaskDidFinishCollectingMetrics(session INSURLSession, task INSURLSessionTask, metrics INSURLSessionTaskMetrics) {
...
func (o NSURLSessionStreamDelegateObject) URLSessionDidCreateTask(session INSURLSession, task INSURLSessionTask) {
...
func (o NSURLSessionStreamDelegateObject) URLSessionTaskDidReceiveInformationalResponse(session INSURLSession, task INSURLSessionTask, response INSHTTPURLResponse) {
...
func (o NSURLSessionStreamDelegateObject) URLSessionTaskNeedNewBodyStreamFromOffsetCompletionHandler(session INSURLSession, task INSURLSessionTask, offset int64, completionHandler InputStreamHandler) {
...
// NSURLSessionStreamDelegateConfig holds optional typed callbacks for [NSURLSessionStreamDelegate] methods.
...
//
// [Apple Documentation]: https://developer.apple.com/documentation/foundation/nsurlsessionstreamdelegate
type NSURLSessionStreamDelegateConfig struct {

	// Other Methods
	// URLSessionBetterRouteDiscoveredForStreamTask — Tells the delegate that a better route to the host has been detected for the stream.
	URLSessionBetterRouteDiscoveredForStreamTask func(session NSURLSession, streamTask NSURLSessionStreamTask)
	// URLSessionStreamTaskDidBecomeInputStreamOutputStream — Tells the delegate that the stream task has been completed as a result of the stream task calling the [captureStreams()](<https://developer.apple.com/documentation/Foundation/URLSessionStreamTask/captureStreams()>) method.
	URLSessionStreamTaskDidBecomeInputStreamOutputStream func(session NSURLSession, streamTask NSURLSessionStreamTask, inputStream NSInputStream, outputStream NSOutputStream)
	// URLSessionReadClosedForStreamTask — Tells the delegate that the read side of the underlying socket has been closed.
	URLSessionReadClosedForStreamTask func(session NSURLSession, streamTask NSURLSessionStreamTask)
	// URLSessionWriteClosedForStreamTask — Tells the delegate that the write side of the underlying socket has been closed.
	URLSessionWriteClosedForStreamTask func(session NSURLSession, streamTask NSURLSessionStreamTask)
}

// NewNSURLSessionStreamDelegate creates an Objective-C object implementing the [NSURLSessionStreamDelegate] protocol.
//
// Each call registers a unique Objective-C class containing only the methods
// set in config. This means [NSObject.RespondsToSelector] works correctly
// for optional delegate methods — only non-nil callbacks are registered.
//
// The returned [NSURLSessionStreamDelegateObject] satisfies the [NSURLSessionStreamDelegate] interface
// and can be passed directly to SetDelegate and similar methods.
//
// See [Apple Documentation] for protocol details.
//
// [Apple Documentation]: https://developer.apple.com/documentation/foundation/nsurlsessionstreamdelegate
func NewNSURLSessionStreamDelegate(config NSURLSessionStreamDelegateConfig) NSURLSessionStreamDelegateObject {
	n := delegateClassCounter.Add(1)
	className := fmt.Sprintf("GoNSURLSessionStreamDelegate_%d", n)

	var methods []objc.MethodDef

	if config.URLSessionBetterRouteDiscoveredForStreamTask != nil {
		fn := config.URLSessionBetterRouteDiscoveredForStreamTask
		methods = append(methods, objc.MethodDef{
			Cmd: objc.RegisterName("URLSession:betterRouteDiscoveredForStreamTask:"),
			Fn: func(self objc.ID, _cmd objc.SEL, sessionID objc.ID, streamTaskID objc.ID) {
				...
				defer func() {
					if !_delegateDone {
						objc.NoteDelegatePanic("NSURLSessionStreamDelegate", "URLSession:betterRouteDiscoveredForStreamTask:")
					}
				}()
				session := NSURLSessionFromID(sessionID)
				streamTask := NSURLSessionStreamTaskFromID(streamTaskID)
				fn(session, streamTask)
				_delegateDone = true
			},
		})
	}

	if config.URLSessionStreamTaskDidBecomeInputStreamOutputStream != nil {
		fn := config.URLSessionStreamTaskDidBecomeInputStreamOutputStream
		methods = append(methods, objc.MethodDef{
			Cmd: objc.RegisterName("URLSession:streamTask:didBecomeInputStream:outputStream:"),
			Fn: func(self objc.ID, _cmd objc.SEL, sessionID objc.ID, streamTaskID objc.ID, inputStreamID objc.ID, outputStreamID objc.ID) {
				// Names which delegate was running if a panic unwinds out of
				// it. The frames between here and the Objective-C caller are
				// runtime and purego dispatch, so without this the traceback
				// never says which selector dispatched. Deliberately no
				...
				defer func() {
					if !_delegateDone {
						objc.NoteDelegatePanic("NSURLSessionStreamDelegate", "URLSession:streamTask:didBecomeInputStream:outputStream:")
					}
				}()
				session := NSURLSessionFromID(sessionID)
				streamTask := NSURLSessionStreamTaskFromID(streamTaskID)
				...
				fn(session, streamTask, inputStream, outputStream)
				_delegateDone = true
			},
		})
	}

	if config.URLSessionReadClosedForStreamTask != nil {
		fn := config.URLSessionReadClosedForStreamTask
		methods = append(methods, objc.MethodDef{
			Cmd: objc.RegisterName("URLSession:readClosedForStreamTask:"),
			Fn: func(self objc.ID, _cmd objc.SEL, sessionID objc.ID, streamTaskID objc.ID) {
				// Names which delegate was running if a panic unwinds out of
				// it. The frames between here and the Objective-C caller are
				// runtime and purego dispatch, so without this the traceback
				...
				defer func() {
					if !_delegateDone {
						objc.NoteDelegatePanic("NSURLSessionStreamDelegate", "URLSession:readClosedForStreamTask:")
					}
				}()
				session := NSURLSessionFromID(sessionID)
				streamTask := NSURLSessionStreamTaskFromID(streamTaskID)
	...
	if config.URLSessionWriteClosedForStreamTask != nil {
		fn := config.URLSessionWriteClosedForStreamTask
		methods = append(methods, objc.MethodDef{
			Cmd: objc.RegisterName("URLSession:writeClosedForStreamTask:"),
			Fn: func(self objc.ID, _cmd objc.SEL, sessionID objc.ID, streamTaskID objc.ID) {
				// Names which delegate was running if a panic unwinds out of
				// it. The frames between here and the Objective-C caller are
				// runtime and purego dispatch, so without this the traceback
				...
				defer func() {
					if !_delegateDone {
						objc.NoteDelegatePanic("NSURLSessionStreamDelegate", "URLSession:writeClosedForStreamTask:")
					}
				}()
				session := NSURLSessionFromID(sessionID)
				streamTask := NSURLSessionStreamTaskFromID(streamTaskID)
	...
	proto := objc.GetProtocol("NSURLSessionStreamDelegate")
	...
	if err != nil {
		panic(fmt.Sprintf("NewNSURLSessionStreamDelegate: RegisterClass %s: %v", className, err))
	}

	instance := objc.ID(cls).Send(objc.RegisterName("alloc")).Send(objc.RegisterName("init"))
	return NSURLSessionStreamDelegateObjectFromID(instance)
}
