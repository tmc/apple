...
func NewIOAsyncCallbackBlock(handler IOAsyncCallback) (objc.ID, func()) {
	...
	block := objc.NewBlock(func(b objc.Block, primitive unsafe.Pointer, extra0 int32, extra1 unsafe.Pointer, extra2 uint32) {
...
func NewIOAsyncCallback0Block(handler IOAsyncCallback0) (objc.ID, func()) {
	...
	block := objc.NewBlock(func(b objc.Block, primitive unsafe.Pointer, extra0 int32) {
...
func NewIOAsyncCallback1Block(handler IOAsyncCallback1) (objc.ID, func()) {
	...
	block := objc.NewBlock(func(b objc.Block, primitive unsafe.Pointer, extra0 int32, extra1 unsafe.Pointer) {
...
func NewIOAsyncCallback2Block(handler IOAsyncCallback2) (objc.ID, func()) {
	...
	block := objc.NewBlock(func(b objc.Block, primitive unsafe.Pointer, extra0 int32, extra1 unsafe.Pointer, extra2 unsafe.Pointer) {
		handler(primitive, extra0, extra1, extra2)
	})
	return objc.ID(block), func() { block.Release() }
}
...
func NewIOServiceInterestCallbackBlock(handler IOServiceInterestCallback) (objc.ID, func()) {
	...
	block := objc.NewBlock(func(b objc.Block, primitive unsafe.Pointer, extra0 uint32, extra1 uint32, extra2 unsafe.Pointer) {
		handler(primitive, extra0, extra1, extra2)
	})
	return objc.ID(block), func() { block.Release() }
}
...
func NewIOServiceMatchingCallbackBlock(handler IOServiceMatchingCallback) (objc.ID, func()) {
	...
	block := objc.NewBlock(func(b objc.Block, primitive unsafe.Pointer, extra0 uint32) {
		handler(primitive, extra0)
	})
	return objc.ID(block), func() { block.Release() }
}
