...
type HIDReportCommandType = unsafe.Pointer
...
type IOCFPlugInInterface = unsafe.Pointer

// See: https://developer.apple.com/documentation/iokit/iocsrkeytype
type IOCSRKeyType = unsafe.Pointer
...
type IOConfigKeyType = unsafe.Pointer
...
type IOFWDCLNotificationType = unsafe.Pointer
...
type IOFireWireAsyncStreamCommandInterface = unsafe.Pointer
...
type IOFireWireCompareSwapCommandInterface = unsafe.Pointer

// See: https://developer.apple.com/documentation/iokit/iofirewirecompareswapcommandinterface_v3
type IOFireWireCompareSwapCommandInterface_v3 = unsafe.Pointer
...
type IOFireWireDCLCommandPoolInterface = unsafe.Pointer
...
type IOFireWireLibIRMAllocationInterface = unsafe.Pointer
...
type IOFireWireLocalUnitDirectoryInterface = unsafe.Pointer
...
type IOFireWireNubInterface = unsafe.Pointer

// See: https://developer.apple.com/documentation/iokit/iofirewirephycommandinterface
type IOFireWirePHYCommandInterface = unsafe.Pointer
...
type IOFireWirePseudoAddressSpaceInterface = unsafe.Pointer
...
type IOFireWireRemoteIsochPortInterface = unsafe.Pointer
...
type IOFireWireUnitInterface = unsafe.Pointer
...
type IOFramebufferInformation = unsafe.Pointer
...
type IOGraphicsAcceleratorInterface = unsafe.Pointer
...
type IOHIDAccessType = unsafe.Pointer

// See: https://developer.apple.com/documentation/iokit/iohidbuttonmodes
type IOHIDButtonModes = unsafe.Pointer
...
type IOHIDDeviceTimeStampedDeviceInterface = unsafe.Pointer
...
type IOHIDElementCommitDirection = unsafe.Pointer
...
type IOHIDEventStruct = unsafe.Pointer
...
type IOHIDRequestType = unsafe.Pointer
...
type IOI2CBusTiming = unsafe.Pointer
...
type IOI2CRequest = unsafe.Pointer
...
type IONVMeSMARTInterface = unsafe.Pointer

// See: https://developer.apple.com/documentation/iokit/ionetworkstats
type IONetworkStats = unsafe.Pointer
...
type IOOutputQueueStats = unsafe.Pointer
...
type IOPMUserActiveType = unsafe.Pointer
...
type IOStreamInterface = unsafe.Pointer
...
type IOUPSPlugInInterface_v140 = unsafe.Pointer
...
type IOUSBDeviceInterface100 = unsafe.Pointer
...
type IOUSBDeviceInterface400 = unsafe.Pointer
...
type IOUSBDeviceInterface650 = unsafe.Pointer

// See: https://developer.apple.com/documentation/iokit/iousbdeviceinterface942
type IOUSBDeviceInterface942 = unsafe.Pointer
...
type IOUSBInterfaceInterface100 = unsafe.Pointer
...
type NXMouseButton = unsafe.Pointer
...
type SCSICmd_INQUIRY_Page00_Header = unsafe.Pointer
...
type SCSICmd_INQUIRY_Page80_Header = unsafe.Pointer
...
type SCSICmd_INQUIRY_Page89_Data = unsafe.Pointer
...
type SCSICmd_INQUIRY_PageB1_Data = unsafe.Pointer
...
type SCSICmd_INQUIRY_StandardData = unsafe.Pointer

// See: https://developer.apple.com/documentation/iokit/scsicmd_inquiry_standarddataall
type SCSICmd_INQUIRY_StandardDataAll = unsafe.Pointer
...
type SCSI_Capacity_Data = unsafe.Pointer

// See: https://developer.apple.com/documentation/iokit/scsi_capacity_data_long
type SCSI_Capacity_Data_Long = unsafe.Pointer
...
type USBPowerRequestTypes = unsafe.Pointer
...
type EvsioEVSIOCCSIndices = unsafe.Pointer

// See: https://developer.apple.com/documentation/iokit/evsioevsioscsindices
type EvsioEVSIOSCSIndices = unsafe.Pointer
...
type KUSBConnectable = unsafe.Pointer

// See: https://developer.apple.com/documentation/iokit/kusbhostconnectortype
type KUSBHostConnectorType = unsafe.Pointer
