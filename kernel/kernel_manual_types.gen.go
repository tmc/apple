...
// Msg represents struct msg from <sys/msg.h> (SDK build 25F70).
type Msg = unsafe.Pointer

// Attrlist matches struct attrlist from <sys/attr.h> (SDK build 25F70).
...
// Stat64 matches struct stat64 from <sys/stat.h> (SDK build 25F70).
type Stat64 struct {
	St_dev           int32
	St_mode          uint16
	St_nlink         uint16
