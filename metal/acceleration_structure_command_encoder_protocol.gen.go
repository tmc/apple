...
// ignores render targets (textures that specify a
// [MTLTextureUsageRenderTarget] usage option) and writable textures (textures
// that specify a [MTLTextureUsageShaderWrite] usage option) within the heap.
// To use these resources, you need to call the [UseResourceUsage] method
// instead.
//
// See: https://developer.apple.com/documentation/Metal/MTLAccelerationStructureCommandEncoder/useHeap(_:)
...
// [MTLTextureUsageRenderTarget] usage option) and writable textures (textures
// that specify a [MTLTextureUsageShaderWrite] usage option) within the array
// of heaps. To use these resources, you need to call the [UseResourceUsage]
// method instead.
//
// See: https://developer.apple.com/documentation/Metal/MTLAccelerationStructureCommandEncoder/useHeaps:count:
