...
// [MTLBlitOptionStencilFromDepthStencil], but not both.
//
...
// with a [StorageMode] property that’s equal to [MTLStorageModeManaged].
//
// # Discussion
//
...
// create with [MTLStorageModeManaged], the CPU and GPU each have a copy of
...
// you create with [MTLStorageModeManaged], the CPU and GPU each have a copy
// of that resource. As the GPU modifies its copy, the CPU’s copy remains
// unchanged until you synchronize with a command, such as this one.
//
