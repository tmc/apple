...
// # Discussion
//
// You can create a shared texture but only with
// [MTLResourceStorageModePrivate]. You can share the texture with another
// process by:
//
...
// # Discussion
//
// The property’s default value is false. You can retrieve the number of
// concurrent CPU threads the device is currently using by checking the
...
//
// The property is typically true for integrated GPUs and false for discrete
// GPUs. However, an Apple silicon GPU on a Mac sets the property to false
// because it doesn’t need to lower its performance to conserve energy.
//
// See: https://developer.apple.com/documentation/Metal/MTLDevice/isLowPower
//
