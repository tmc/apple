...
// is an [MTLTextureType2DMultisample] type color texture), you can create
...
//
// When this value is false, no fragments are processed and the vertex shader
...
// # Discussion
//
// The default value is [MTLTessellationControlPointIndexTypeNone]; use this
// value when drawing patches without a control point index buffer. This value
// needs to be either [MTLTessellationControlPointIndexTypeUInt16] or
// [MTLTessellationControlPointIndexTypeUInt32] when drawing patches with
// indexed control points.
//
...
// # Discussion
//
// The default value is [MTLTessellationPartitionModePow2].
//
