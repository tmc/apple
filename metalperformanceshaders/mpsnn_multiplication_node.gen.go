...
func (mc MPSNNMultiplicationNodeClass) Class() objc.Class {
	return mc.class
}
...
//
// See: https://developer.apple.com/documentation/MetalPerformanceShaders/MPSNNMultiplicationNode
...
// NOTE: MPSNNMultiplicationNode adopts protocols; skip strict compile-time interface assertion.
...
func NewMultiplicationNodeWithLeftSourceRightSource(left IMPSNNImageNode, right IMPSNNImageNode) MPSNNMultiplicationNode {
...
func NewMultiplicationNodeWithSources(sourceNodes []MPSNNImageNode) MPSNNMultiplicationNode {
	instance := getMPSNNMultiplicationNodeClass().Alloc()
