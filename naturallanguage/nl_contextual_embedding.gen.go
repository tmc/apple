...
//
//   - [NLContextualEmbedding.Dimension]: The dimensionality of the embedding vectors generated by the model.
//   - [NLContextualEmbedding.HasAvailableAssets]: A Boolean value that indicates whether assets are available on-device.
...
// # Inspecting the contextual embedding
//
//   - [INLContextualEmbedding.Dimension]: The dimensionality of the embedding vectors generated by the model.
//   - [INLContextualEmbedding.HasAvailableAssets]: A Boolean value that indicates whether assets are available on-device.
...
// Returns contextual embedding models that match the specified language,
// script, or revision criteria.
//
