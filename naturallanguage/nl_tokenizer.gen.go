...
// [NLTokenizer.EnumerateTokensInRangeUsingBlock] method provides the ranges
// of the tokens in the string based on the tokenization unit.
//
...
// `range` is 0, this return value is equivalent to
