...
func (o OS_nw_data_transfer_reportObject) BaseObject() objectivec.Object {
	return o.Object
}

// OS_nw_data_transfer_reportObjectFromID constructs a [OS_nw_data_transfer_reportObject] from an objc.ID.
// The object is determined to conform to the protocol at runtime.
func OS_nw_data_transfer_reportObjectFromID(id objc.ID) OS_nw_data_transfer_reportObject {
	return OS_nw_data_transfer_reportObject{
