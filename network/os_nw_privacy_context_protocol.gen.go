...
func (o OS_nw_privacy_contextObject) BaseObject() objectivec.Object {
	return o.Object
}

// OS_nw_privacy_contextObjectFromID constructs a [OS_nw_privacy_contextObject] from an objc.ID.
// The object is determined to conform to the protocol at runtime.
func OS_nw_privacy_contextObjectFromID(id objc.ID) OS_nw_privacy_contextObject {
	return OS_nw_privacy_contextObject{
