...
type NWBrowseResultEnumerateInterface = func(NWInterface) bool
...
type NWBrowserBrowseResultsChangedHandler = func(NWBrowseResult, NWBrowseResult, bool)
...
type NWConnectionGroupNewConnectionHandler = func(NWConnection)
...
type NWConnectionGroupReceiveHandler = func(objectivec.Object, NWContentContext, bool)
...
func NWConnectionGroupFromID(id objc.ID) NWConnectionGroup {
	return NWConnectionGroup{objectivec.Object{ID: id}}
}
...
type NWConnectionPathEventHandler = func(NWPath)
...
type NWConnectionReceiveCompletion = func(content objectivec.Object, context NWContentContext, is_complete bool, error_ NWError)
...
func NWContentContextFromID(id objc.ID) NWContentContext {
	return NWContentContext{objectivec.Object{ID: id}}
}
...
type NWDataTransferReportCollectBlock = func(NWDataTransferReport)
...
type NWDataTransferReport struct {
	objectivec.Object
}
...
func NWDataTransferReportFromID(id objc.ID) NWDataTransferReport {
	return NWDataTransferReport{objectivec.Object{ID: id}}
}
...
type NWEstablishmentReportAccessBlock = func(NWEstablishmentReport)
...
type NWEstablishmentReport struct {
	objectivec.Object
}
...
func NWEthernetChannelFromID(id objc.ID) NWEthernetChannel {
	return NWEthernetChannel{objectivec.Object{ID: id}}
}
...
type NWFramerCleanupHandler = func(NWFramer)
...
type NWFramerInputHandler = func(NWFramer) uint64
...
type NWFramerOutputHandler = func(framer NWFramer, message NWProtocolMetadata, message_length uint32, is_complete bool)
...
type NWFramerParseCompletion = func(buffer *uint8, buffer_length uint32, is_complete bool) uint64
...
type NWFramerStartHandler = func(NWFramer) NWFramerStartResult
...
type NWFramerStopHandler = func(NWFramer) bool
...
type NWFramerWakeupHandler = func(NWFramer)
...
type NWGroupDescriptorEnumerateEndpointsBlock = func(NWEndpoint) bool
...
func NWGroupDescriptorFromID(id objc.ID) NWGroupDescriptor {
	return NWGroupDescriptor{objectivec.Object{ID: id}}
}
...
type NWListenerAdvertisedEndpointChangedHandler = func(NWEndpoint, bool)

// See: https://developer.apple.com/documentation/Network/nw_listener_new_connection_group_handler_t
type NWListenerNewConnectionGroupHandler = func(NWConnectionGroup)
...
type NWListenerNewConnectionHandler = func(NWConnection)
...
type NWParametersConfigureProtocolBlock = func(NWProtocolOptions)
...
type NWParametersIterateInterfacesBlock = func(NWInterface) bool
...
type NWPathEnumerateGatewaysBlock = func(NWEndpoint) bool
...
type NWPathEnumerateInterfacesBlock = func(NWInterface) bool
...
type NWPathMonitorUpdateHandler = func(NWPath)
...
func NWPrivacyContextFromID(id objc.ID) NWPrivacyContext {
	return NWPrivacyContext{objectivec.Object{ID: id}}
}
...
type NWProtocolDefinition struct {
	objectivec.Object
}
...
func NWProtocolDefinitionFromID(id objc.ID) NWProtocolDefinition {
	return NWProtocolDefinition{objectivec.Object{ID: id}}
}
...
type NWProtocolMetadata struct {
	objectivec.Object
}
...
func NWProtocolMetadataFromID(id objc.ID) NWProtocolMetadata {
	return NWProtocolMetadata{objectivec.Object{ID: id}}
}
...
func NWProtocolOptionsFromID(id objc.ID) NWProtocolOptions {
	return NWProtocolOptions{objectivec.Object{ID: id}}
}
...
type NWProtocolStackIterateProtocolsBlock = func(NWProtocolOptions)
...
type NWReportProtocolEnumerator = func(NWProtocolDefinition, uint64, uint64) bool
...
type NWReportResolutionEnumerator = func(NWReportResolutionSource, uint64, uint32, NWEndpoint, NWEndpoint) bool
...
type NWReportResolutionReportEnumerator = func(NWResolutionReport) bool
...
type NWResolutionReport struct {
	objectivec.Object
}
...
func NWResolutionReportFromID(id objc.ID) NWResolutionReport {
	return NWResolutionReport{objectivec.Object{ID: id}}
}
...
func NWResolverConfigFromID(id objc.ID) NWResolverConfig {
	return NWResolverConfig{objectivec.Object{ID: id}}
}
...
type NWWsClientRequestHandler = func(NWWsRequest) NWWsResponse
