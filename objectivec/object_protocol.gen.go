...
type NSObject interface {
	...
	//
	// See: https://developer.apple.com/documentation/ObjectiveC/NSObject-c.protocol/class
	Class() objc.Class
...
// # Return Value
//
// YES if the receiver is an instance of `aClass` or an instance of any class
// that inherits from `aClass`, otherwise NO.
//
// # Discussion
//
...
// unchanged.
//
// If the receiver is a class object, this method returns YES if `aClass` is a
// Class object of the same type, NO otherwise.
//
// See: https://developer.apple.com/documentation/ObjectiveC/NSObjectProtocol/isKind(of:)
//
...
//
// See: https://developer.apple.com/documentation/ObjectiveC/NSObject-c.protocol/class
func (o NSObjectObject) Class() objc.Class {
	rv := objc.Send[objc.Class](o.ID, objc.Sel("class"))
	return rv
}
...
// # Discussion
//
// This method is of no value in debugging memory management issues. Because
// any number of framework objects may have retained an object in order to
// hold references to it, while at the same time autorelease pools may be
// holding any number of deferred releases on an object, it is very unlikely
// that you can get useful information from this method.
//
...
//
// - The [Clang Static analyzer] can typically find memory management problems
// even before you run your program. - The Object Alloc instrument in the
// Instruments application (see [Instruments User Guide]) can track object
// allocation and destruction.
//
// See: https://developer.apple.com/documentation/ObjectiveC/NSObject-c.protocol/retainCount
//
// [Clang Static analyzer]: http://clang-analyzer.llvm.org
// [Instruments User Guide]: https://developer.apple.com/library/archive/documentation/DeveloperTools/Conceptual/InstrumentsUserGuide/index.html#//apple_ref/doc/uid/TP40004652
// [Memory Management Policy]: https://developer.apple.com/library/archive/documentation/Cocoa/Conceptual/MemoryMgmt/Articles/mmRules.html#//apple_ref/doc/uid/20000994
