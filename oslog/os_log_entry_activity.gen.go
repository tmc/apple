...
type IOSLogEntryActivity interface {
	...
	ParentActivityIdentifier() os.OSActivityID
...
func (o OSLogEntryActivity) ActivityIdentifier() os.OSActivityID {
...
func (o OSLogEntryActivity) ParentActivityIdentifier() os.OSActivityID {
	rv := objc.Send[os.OSActivityID](o.ID, objc.Sel("parentActivityIdentifier"))
	return os.OSActivityID(rv)
}
