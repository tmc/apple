...
func (ac ANECloneHelperClass) Alloc() ANECloneHelper {
	rv := objc.SendIfResponds[ANECloneHelper](objc.ID(ac.class), objc.Sel("alloc"))
	return rv
}
...
func (a ANECloneHelper) Init() ANECloneHelper {
	rv := objc.SendIfResponds[ANECloneHelper](a.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (a ANECloneHelper) Autorelease() ANECloneHelper {
	rv := objc.SendIfResponds[ANECloneHelper](a.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewANECloneHelper() ANECloneHelper {
	...
	rv := objc.SendIfResponds[ANECloneHelper](objc.ID(class.class), objc.Sel("new"))
	return rv
}
...
func (_ANECloneHelperClass ANECloneHelperClass) CloneIfWritableIsEncryptedModelCloneDirectory(writable objectivec.IObject, model bool, directory objectivec.IObject) objectivec.IObject {
	rv := objc.SendIfResponds[objc.ID](objc.ID(_ANECloneHelperClass.class), objc.Sel("cloneIfWritable:isEncryptedModel:cloneDirectory:"), writable, model, directory)
