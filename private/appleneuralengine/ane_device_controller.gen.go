...
func (ac ANEDeviceControllerClass) Alloc() ANEDeviceController {
	rv := objc.SendIfResponds[ANEDeviceController](objc.ID(ac.class), objc.Sel("alloc"))
	return rv
}
...
func (a ANEDeviceController) Init() ANEDeviceController {
	rv := objc.SendIfResponds[ANEDeviceController](a.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (a ANEDeviceController) Autorelease() ANEDeviceController {
	rv := objc.SendIfResponds[ANEDeviceController](a.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewANEDeviceController() ANEDeviceController {
	...
	rv := objc.SendIfResponds[ANEDeviceController](objc.ID(class.class), objc.Sel("new"))
	return rv
}

func NewANEDeviceControllerWithANEPrivilegedVM(vm bool) ANEDeviceController {
	instance := getANEDeviceControllerClass().Alloc()
	rv := objc.SendIfResponds[objc.ID](instance.ID, objc.Sel("initWithANEPrivilegedVM:"), vm)
...
func NewANEDeviceControllerWithProgramHandlePriviledged(handle uint64, priviledged bool) ANEDeviceController {
	instance := getANEDeviceControllerClass().Alloc()
	rv := objc.SendIfResponds[objc.ID](instance.ID, objc.Sel("initWithProgramHandle:priviledged:"), handle, priviledged)
	return ANEDeviceControllerFromID(rv)
}

func (a ANEDeviceController) Start() {
	objc.SendIfResponds[objc.ID](a.ID, objc.Sel("start"))
}
func (a ANEDeviceController) Stop() {
	objc.SendIfResponds[objc.ID](a.ID, objc.Sel("stop"))
}
func (a ANEDeviceController) InitWithANEPrivilegedVM(vm bool) ANEDeviceController {
	rv := objc.SendIfResponds[ANEDeviceController](a.ID, objc.Sel("initWithANEPrivilegedVM:"), vm)
	return rv
}
func (a ANEDeviceController) InitWithProgramHandlePriviledged(handle uint64, priviledged bool) ANEDeviceController {
	rv := objc.SendIfResponds[ANEDeviceController](a.ID, objc.Sel("initWithProgramHandle:priviledged:"), handle, priviledged)
	return rv
}

func (_ANEDeviceControllerClass ANEDeviceControllerClass) ControllerWithPrivilegedVM(vm bool) objectivec.IObject {
	rv := objc.SendIfResponds[objc.ID](objc.ID(_ANEDeviceControllerClass.class), objc.Sel("controllerWithPrivilegedVM:"), vm)
...
func (_ANEDeviceControllerClass ANEDeviceControllerClass) ControllerWithProgramHandle(handle uint64) objectivec.IObject {
	rv := objc.SendIfResponds[objc.ID](objc.ID(_ANEDeviceControllerClass.class), objc.Sel("controllerWithProgramHandle:"), handle)
	return objectivec.Object{ID: rv}
}
func (_ANEDeviceControllerClass ANEDeviceControllerClass) SharedPrivilegedConnection() ANEDeviceController {
	rv := objc.SendIfResponds[objc.ID](objc.ID(_ANEDeviceControllerClass.class), objc.Sel("sharedPrivilegedConnection"))
	return ANEDeviceControllerFromID(rv)
}

func (a ANEDeviceController) Device() *ANEDeviceStruct {
	rv := objc.SendIfResponds[unsafe.Pointer](a.ID, objc.Sel("device"))
	return (*ANEDeviceStruct)(rv)
}
func (a ANEDeviceController) SetDevice(value *ANEDeviceStruct) {
	objc.SendIfResponds[struct{}](a.ID, objc.Sel("setDevice:"), value)
}
func (a ANEDeviceController) IsPrivileged() bool {
	rv := objc.SendIfResponds[bool](a.ID, objc.Sel("isPrivileged"))
	return rv
}
...
func (a ANEDeviceController) Usecount() int64 {
	rv := objc.SendIfResponds[int64](a.ID, objc.Sel("usecount"))
	return rv
}
func (a ANEDeviceController) SetUsecount(value int64) {
	objc.SendIfResponds[struct{}](a.ID, objc.Sel("setUsecount:"), value)
}
