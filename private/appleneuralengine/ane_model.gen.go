...
func (a ANEModel) L() Os_unfair_lock_s {
	rv := objc.Send[Os_unfair_lock_s](a.ID, objc.Sel("l"))
	return Os_unfair_lock_s(rv)
}
func (a ANEModel) SetL(value Os_unfair_lock_s) {
