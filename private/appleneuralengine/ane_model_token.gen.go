...
func (ac ANEModelTokenClass) Alloc() ANEModelToken {
	rv := objc.SendIfResponds[ANEModelToken](objc.ID(ac.class), objc.Sel("alloc"))
	return rv
}
...
func (a ANEModelToken) Init() ANEModelToken {
	rv := objc.SendIfResponds[ANEModelToken](a.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (a ANEModelToken) Autorelease() ANEModelToken {
	rv := objc.SendIfResponds[ANEModelToken](a.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewANEModelToken() ANEModelToken {
	...
	rv := objc.SendIfResponds[ANEModelToken](objc.ID(class.class), objc.Sel("new"))
	return rv
}
...
func (a ANEModelToken) TeamIdentity() string {
	rv := objc.SendIfResponds[objc.ID](a.ID, objc.Sel("teamIdentity"))
	return foundation.NSStringFromID(rv).String()
}
