...
func NewAVAudioInputNodeWithIOUnitIsInput(iOUnit unsafe.Pointer, input bool) AVAudioInputNode {
...
func NewAVAudioInputNodeWithImpl(impl unsafe.Pointer) AVAudioInputNode {
	instance := getAVAudioInputNodeClass().Alloc()
