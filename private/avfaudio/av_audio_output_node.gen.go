...
func (ac AVAudioOutputNodeClass) Alloc() AVAudioOutputNode {
	rv := objc.SendIfResponds[AVAudioOutputNode](objc.ID(ac.class), objc.Sel("alloc"))
	return rv
}
...
func (a AVAudioOutputNode) Init() AVAudioOutputNode {
	rv := objc.SendIfResponds[AVAudioOutputNode](a.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (a AVAudioOutputNode) Autorelease() AVAudioOutputNode {
	rv := objc.SendIfResponds[AVAudioOutputNode](a.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewAVAudioOutputNode() AVAudioOutputNode {
	...
	rv := objc.SendIfResponds[AVAudioOutputNode](objc.ID(class.class), objc.Sel("new"))
	return rv
}
...
func (a AVAudioOutputNode) ManualRenderingFormat() objectivec.IObject {
	rv := objc.SendIfResponds[objc.ID](a.ID, objc.Sel("manualRenderingFormat"))
	return objectivec.Object{ID: rv}
}
func (a AVAudioOutputNode) ManualRenderingMaximumFrameCount() uint32 {
	rv := objc.SendIfResponds[uint32](a.ID, objc.Sel("manualRenderingMaximumFrameCount"))
	return rv
}
func (a AVAudioOutputNode) SetManualRenderingPCMFormatMaximumFrameCount(pCMFormat objectivec.IObject, count uint32) bool {
	rv := objc.SendIfResponds[bool](a.ID, objc.Sel("setManualRenderingPCMFormat:maximumFrameCount:"), pCMFormat, count)
	return rv
}
