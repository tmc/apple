...
func (ac AVAudioTimeClass) Alloc() AVAudioTime {
	rv := objc.SendIfResponds[AVAudioTime](objc.ID(ac.class), objc.Sel("alloc"))
	return rv
}
...
func (a AVAudioTime) Init() AVAudioTime {
	rv := objc.SendIfResponds[AVAudioTime](a.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (a AVAudioTime) Autorelease() AVAudioTime {
	rv := objc.SendIfResponds[AVAudioTime](a.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewAVAudioTime() AVAudioTime {
	...
	rv := objc.SendIfResponds[AVAudioTime](objc.ID(class.class), objc.Sel("new"))
	return rv
}

func (a AVAudioTime) HostTimeValid() bool {
	rv := objc.SendIfResponds[bool](a.ID, objc.Sel("hostTimeValid"))
	return rv
}
func (a AVAudioTime) SampleTimeValid() bool {
	rv := objc.SendIfResponds[bool](a.ID, objc.Sel("sampleTimeValid"))
	return rv
}
