...
func (ac AVMusicEventClass) Alloc() AVMusicEvent {
	rv := objc.SendIfResponds[AVMusicEvent](objc.ID(ac.class), objc.Sel("alloc"))
	return rv
}
...
func (a AVMusicEvent) Init() AVMusicEvent {
	rv := objc.SendIfResponds[AVMusicEvent](a.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (a AVMusicEvent) Autorelease() AVMusicEvent {
	rv := objc.SendIfResponds[AVMusicEvent](a.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewAVMusicEvent() AVMusicEvent {
	...
	rv := objc.SendIfResponds[AVMusicEvent](objc.ID(class.class), objc.Sel("new"))
	return rv
}
