...
func (o EndpointerObject) ConfigureWithASBDAndFrameRate(asbd coreaudiotypes.AudioStreamBasicDescription, rate uint32) bool {
	rv := objc.SendIfResponds[bool](o.ID, objc.Sel("configureWithASBD:andFrameRate:"), asbd, rate)
	return rv
}
func (o EndpointerObject) ConfigureWithSampleRateAndFrameRate(rate float64, rate2 uint32) bool {
	rv := objc.SendIfResponds[bool](o.ID, objc.Sel("configureWithSampleRate:andFrameRate:"), rate, rate2)
	return rv
}
func (o EndpointerObject) EndWaitTime() float64 {
	rv := objc.SendIfResponds[float64](o.ID, objc.Sel("endWaitTime"))
	return rv
}
func (o EndpointerObject) EndpointMode() int {
	rv := objc.SendIfResponds[int](o.ID, objc.Sel("endpointMode"))
	return rv
}
func (o EndpointerObject) GetStatus(status audiotoolbox.AudioQueueBuffer) int {
	rv := objc.SendIfResponds[int](o.ID, objc.Sel("getStatus:"), status)
	return rv
}
func (o EndpointerObject) InterspeechWaitTime() float64 {
	rv := objc.SendIfResponds[float64](o.ID, objc.Sel("interspeechWaitTime"))
	return rv
}
...
func (o EndpointerObject) SetEndWaitTime(time float64) {
	objc.SendIfResponds[struct{}](o.ID, objc.Sel("setEndWaitTime:"), time)
}
func (o EndpointerObject) SetEndpointMode(mode int) {
	objc.SendIfResponds[struct{}](o.ID, objc.Sel("setEndpointMode:"), mode)
}
func (o EndpointerObject) SetInterspeechWaitTime(time float64) {
	objc.SendIfResponds[struct{}](o.ID, objc.Sel("setInterspeechWaitTime:"), time)
}
func (o EndpointerObject) SetStartWaitTime(time float64) {
	objc.SendIfResponds[struct{}](o.ID, objc.Sel("setStartWaitTime:"), time)
}
func (o EndpointerObject) StartWaitTime() float64 {
	rv := objc.SendIfResponds[float64](o.ID, objc.Sel("startWaitTime"))
	return rv
}
