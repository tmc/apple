...
type MLFeatureProviderErrorHandler = func(*unsafe.Pointer, error)
...
//   - [MLMultiArray.InitWithMultiArrayBufferMutableShapedBufferProvider]
...
//   - [MLMultiArrayView.InitWithMultiArrayBufferMutableShapedBufferProvider]
