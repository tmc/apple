...
//
// See: https://developer.apple.com/documentation/CoreML/ETDataProvider
type ETDataProvider interface {
	objectivec.IObject

	// NumberOfDataPoints protocol.
	//
	// See: https://developer.apple.com/documentation/CoreML/ETDataProvider/numberOfDataPoints
	NumberOfDataPoints() uint64

	// PrepareForEpoch protocol.
	//
	// See: https://developer.apple.com/documentation/CoreML/ETDataProvider/prepareForEpoch
	PrepareForEpoch()
}
...
// See: https://developer.apple.com/documentation/CoreML/ETDataProvider/dataPointAtIndex:error:
