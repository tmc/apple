...
func (mc MLAppleAudioFeatureExtractorParametersClass) Alloc() MLAppleAudioFeatureExtractorParameters {
	rv := objc.SendIfResponds[MLAppleAudioFeatureExtractorParameters](objc.ID(mc.class), objc.Sel("alloc"))
	return rv
}
...
func (m MLAppleAudioFeatureExtractorParameters) Init() MLAppleAudioFeatureExtractorParameters {
	rv := objc.SendIfResponds[MLAppleAudioFeatureExtractorParameters](m.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (m MLAppleAudioFeatureExtractorParameters) Autorelease() MLAppleAudioFeatureExtractorParameters {
	rv := objc.SendIfResponds[MLAppleAudioFeatureExtractorParameters](m.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewMLAppleAudioFeatureExtractorParameters() MLAppleAudioFeatureExtractorParameters {
	...
	rv := objc.SendIfResponds[MLAppleAudioFeatureExtractorParameters](objc.ID(class.class), objc.Sel("new"))
	return rv
}
...
func (m MLAppleAudioFeatureExtractorParameters) InitWithSoundPrintParameters(parameters objectivec.IObject) MLAppleAudioFeatureExtractorParameters {
	rv := objc.SendIfResponds[MLAppleAudioFeatureExtractorParameters](m.ID, objc.Sel("initWithSoundPrintParameters:"), parameters)
	return rv
}
