...
func (mc MLBatchedTensorsHolderClass) Alloc() MLBatchedTensorsHolder {
	rv := objc.SendIfResponds[MLBatchedTensorsHolder](objc.ID(mc.class), objc.Sel("alloc"))
	return rv
}
...
func (m MLBatchedTensorsHolder) Init() MLBatchedTensorsHolder {
	rv := objc.SendIfResponds[MLBatchedTensorsHolder](m.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (m MLBatchedTensorsHolder) Autorelease() MLBatchedTensorsHolder {
	rv := objc.SendIfResponds[MLBatchedTensorsHolder](m.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewMLBatchedTensorsHolder() MLBatchedTensorsHolder {
	...
	rv := objc.SendIfResponds[MLBatchedTensorsHolder](objc.ID(class.class), objc.Sel("new"))
	return rv
}
...
func (m MLBatchedTensorsHolder) InitWithBatchedTensorsNumberOfTensors(tensors objectivec.IObject, tensors2 uint64) MLBatchedTensorsHolder {
	rv := objc.SendIfResponds[MLBatchedTensorsHolder](m.ID, objc.Sel("initWithBatchedTensors:numberOfTensors:"), tensors, tensors2)
	return rv
}

func (m MLBatchedTensorsHolder) BatchedTensors() foundation.INSDictionary {
	rv := objc.SendIfResponds[objc.ID](m.ID, objc.Sel("batchedTensors"))
	return foundation.NSDictionaryFromID(objc.ID(rv))
}
func (m MLBatchedTensorsHolder) NumberOfTensors() uint64 {
	rv := objc.SendIfResponds[uint64](m.ID, objc.Sel("numberOfTensors"))
	return rv
}
