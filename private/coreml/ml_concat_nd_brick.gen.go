...
func (mc MLConcatNDBrickClass) Alloc() MLConcatNDBrick {
	rv := objc.SendIfResponds[MLConcatNDBrick](objc.ID(mc.class), objc.Sel("alloc"))
	return rv
}
...
func (m MLConcatNDBrick) Init() MLConcatNDBrick {
	rv := objc.SendIfResponds[MLConcatNDBrick](m.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (m MLConcatNDBrick) Autorelease() MLConcatNDBrick {
	rv := objc.SendIfResponds[MLConcatNDBrick](m.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewMLConcatNDBrick() MLConcatNDBrick {
	...
	rv := objc.SendIfResponds[MLConcatNDBrick](objc.ID(class.class), objc.Sel("new"))
	return rv
}
...
func (m MLConcatNDBrick) InitWithParameters(parameters objectivec.IObject) MLConcatNDBrick {
	rv := objc.SendIfResponds[MLConcatNDBrick](m.ID, objc.Sel("initWithParameters:"), parameters)
	return rv
}
