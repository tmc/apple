...
func (mc MLCustomModelLoaderClass) Alloc() MLCustomModelLoader {
	rv := objc.SendIfResponds[MLCustomModelLoader](objc.ID(mc.class), objc.Sel("alloc"))
	return rv
}
...
func (m MLCustomModelLoader) Init() MLCustomModelLoader {
	rv := objc.SendIfResponds[MLCustomModelLoader](m.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (m MLCustomModelLoader) Autorelease() MLCustomModelLoader {
	rv := objc.SendIfResponds[MLCustomModelLoader](m.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewMLCustomModelLoader() MLCustomModelLoader {
	...
	rv := objc.SendIfResponds[MLCustomModelLoader](objc.ID(class.class), objc.Sel("new"))
	return rv
}
