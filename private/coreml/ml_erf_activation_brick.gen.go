...
func (mc MLErfActivationBrickClass) Alloc() MLErfActivationBrick {
	rv := objc.SendIfResponds[MLErfActivationBrick](objc.ID(mc.class), objc.Sel("alloc"))
	return rv
}
...
func (m MLErfActivationBrick) Init() MLErfActivationBrick {
	rv := objc.SendIfResponds[MLErfActivationBrick](m.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (m MLErfActivationBrick) Autorelease() MLErfActivationBrick {
	rv := objc.SendIfResponds[MLErfActivationBrick](m.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewMLErfActivationBrick() MLErfActivationBrick {
	...
	rv := objc.SendIfResponds[MLErfActivationBrick](objc.ID(class.class), objc.Sel("new"))
	return rv
}
...
func (m MLErfActivationBrick) InitWithParameters(parameters objectivec.IObject) MLErfActivationBrick {
	rv := objc.SendIfResponds[MLErfActivationBrick](m.ID, objc.Sel("initWithParameters:"), parameters)
	return rv
}
...
func (m MLErfActivationBrick) Superclass() objectivec.Class {
