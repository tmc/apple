...
func (mc MLInternalSettingsClass) Alloc() MLInternalSettings {
	rv := objc.SendIfResponds[MLInternalSettings](objc.ID(mc.class), objc.Sel("alloc"))
	return rv
}
...
func (m MLInternalSettings) Init() MLInternalSettings {
	rv := objc.SendIfResponds[MLInternalSettings](m.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (m MLInternalSettings) Autorelease() MLInternalSettings {
	rv := objc.SendIfResponds[MLInternalSettings](m.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewMLInternalSettings() MLInternalSettings {
	...
	rv := objc.SendIfResponds[MLInternalSettings](objc.ID(class.class), objc.Sel("new"))
	return rv
}

func NewMLInternalSettingsWithCoder(coder objectivec.IObject) MLInternalSettings {
...
func (m MLInternalSettings) InitWithCoder(coder foundation.INSCoder) MLInternalSettings {
	rv := objc.SendIfResponds[MLInternalSettings](m.ID, objc.Sel("initWithCoder:"), coder)
	return rv
}

func (_MLInternalSettingsClass MLInternalSettingsClass) DeviceHasANE() bool {
	rv := objc.SendIfResponds[bool](objc.ID(_MLInternalSettingsClass.class), objc.Sel("deviceHasANE"))
	return rv
}
func (_MLInternalSettingsClass MLInternalSettingsClass) GlobalSettings() objectivec.IObject {
	rv := objc.SendIfResponds[objc.ID](objc.ID(_MLInternalSettingsClass.class), objc.Sel("globalSettings"))
...
func (_MLInternalSettingsClass MLInternalSettingsClass) GlobalSettingsFromSettings(settings objectivec.IObject) objectivec.IObject {
	rv := objc.SendIfResponds[objc.ID](objc.ID(_MLInternalSettingsClass.class), objc.Sel("globalSettingsFromSettings:"), settings)
	return objectivec.Object{ID: rv}
}
func (_MLInternalSettingsClass MLInternalSettingsClass) SupportsSecureCoding() bool {
	rv := objc.SendIfResponds[bool](objc.ID(_MLInternalSettingsClass.class), objc.Sel("supportsSecureCoding"))
	return rv
}

func (m MLInternalSettings) IsNeuralNetworkGPUPathForbidden() bool {
	rv := objc.SendIfResponds[bool](m.ID, objc.Sel("isNeuralNetworkGPUPathForbidden"))
	return rv
}
func (m MLInternalSettings) RestrictNeuralNetworksFromUsingANE() bool {
	rv := objc.SendIfResponds[bool](m.ID, objc.Sel("restrictNeuralNetworksFromUsingANE"))
	return rv
}
func (m MLInternalSettings) SetRestrictNeuralNetworksFromUsingANE(value bool) {
	objc.SendIfResponds[struct{}](m.ID, objc.Sel("setRestrictNeuralNetworksFromUsingANE:"), value)
}
func (m MLInternalSettings) RestrictNeuralNetworksToUseCPUOnly() bool {
	rv := objc.SendIfResponds[bool](m.ID, objc.Sel("restrictNeuralNetworksToUseCPUOnly"))
	return rv
}
func (m MLInternalSettings) SetRestrictNeuralNetworksToUseCPUOnly(value bool) {
	objc.SendIfResponds[struct{}](m.ID, objc.Sel("setRestrictNeuralNetworksToUseCPUOnly:"), value)
}
