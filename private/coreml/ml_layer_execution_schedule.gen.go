...
func (mc MLLayerExecutionScheduleClass) Alloc() MLLayerExecutionSchedule {
	rv := objc.SendIfResponds[MLLayerExecutionSchedule](objc.ID(mc.class), objc.Sel("alloc"))
	return rv
}
...
func (m MLLayerExecutionSchedule) Init() MLLayerExecutionSchedule {
	rv := objc.SendIfResponds[MLLayerExecutionSchedule](m.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (m MLLayerExecutionSchedule) Autorelease() MLLayerExecutionSchedule {
	rv := objc.SendIfResponds[MLLayerExecutionSchedule](m.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewMLLayerExecutionSchedule() MLLayerExecutionSchedule {
	...
	rv := objc.SendIfResponds[MLLayerExecutionSchedule](objc.ID(class.class), objc.Sel("new"))
	return rv
}
...
func (m MLLayerExecutionSchedule) InitWithComputeUnitsLayerNameLayerErrorLayerTypeNameSupportedComputeUnitsLayerIndex(units uint64, name objectivec.IObject, error_ int64, name2 objectivec.IObject, units2 uint64, index int64) MLLayerExecutionSchedule {
	rv := objc.SendIfResponds[MLLayerExecutionSchedule](m.ID, objc.Sel("initWithComputeUnits:layerName:layerError:layerTypeName:supportedComputeUnits:layerIndex:"), units, name, error_, name2, units2, index)
	return rv
}
func (m MLLayerExecutionSchedule) InitWithComputeUnitsLayerNameLayerErrorLayerTypeNameSupportedComputeUnitsLayerIndexSupportMessagesComputeTimeRatio(units uint64, name objectivec.IObject, error_ int64, name2 objectivec.IObject, units2 uint64, index int64, messages objectivec.IObject, ratio float64) MLLayerExecutionSchedule {
	rv := objc.SendIfResponds[MLLayerExecutionSchedule](m.ID, objc.Sel("initWithComputeUnits:layerName:layerError:layerTypeName:supportedComputeUnits:layerIndex:supportMessages:computeTimeRatio:"), units, name, error_, name2, units2, index, messages, ratio)
	return rv
}
func (m MLLayerExecutionSchedule) InitWithLayerError(error_ int64) MLLayerExecutionSchedule {
	rv := objc.SendIfResponds[MLLayerExecutionSchedule](m.ID, objc.Sel("initWithLayerError:"), error_)
	return rv
}

func (m MLLayerExecutionSchedule) ComputeTimeRatio() float64 {
	rv := objc.SendIfResponds[float64](m.ID, objc.Sel("computeTimeRatio"))
	return rv
}
func (m MLLayerExecutionSchedule) LayerError() int64 {
	rv := objc.SendIfResponds[int64](m.ID, objc.Sel("layerError"))
	return rv
}
func (m MLLayerExecutionSchedule) LayerIndex() int64 {
	rv := objc.SendIfResponds[int64](m.ID, objc.Sel("layerIndex"))
	return rv
}
...
func (m MLLayerExecutionSchedule) LayerTypeName() string {
	rv := objc.SendIfResponds[objc.ID](m.ID, objc.Sel("layerTypeName"))
	return foundation.NSStringFromID(rv).String()
}
func (m MLLayerExecutionSchedule) PreferredComputeUnit() uint64 {
	rv := objc.SendIfResponds[uint64](m.ID, objc.Sel("preferredComputeUnit"))
	return rv
}
func (m MLLayerExecutionSchedule) SupportMessagesPerComputeUnit() foundation.INSDictionary {
	rv := objc.SendIfResponds[objc.ID](m.ID, objc.Sel("supportMessagesPerComputeUnit"))
	return foundation.NSDictionaryFromID(objc.ID(rv))
}
func (m MLLayerExecutionSchedule) SupportedComputeUnits() uint64 {
	rv := objc.SendIfResponds[uint64](m.ID, objc.Sel("supportedComputeUnits"))
	return rv
}
