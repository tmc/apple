...
func (mc MLLinkedModelClass) Alloc() MLLinkedModel {
	rv := objc.SendIfResponds[MLLinkedModel](objc.ID(mc.class), objc.Sel("alloc"))
	return rv
}
...
func (m MLLinkedModel) Init() MLLinkedModel {
	rv := objc.SendIfResponds[MLLinkedModel](m.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (m MLLinkedModel) Autorelease() MLLinkedModel {
	rv := objc.SendIfResponds[MLLinkedModel](m.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewMLLinkedModel() MLLinkedModel {
	...
	rv := objc.SendIfResponds[MLLinkedModel](objc.ID(class.class), objc.Sel("new"))
	return rv
}
...
func NewLinkedModelDescriptionOnlyWithSpecificationConfigurationError(specification unsafe.Pointer, configuration objectivec.IObject) (MLLinkedModel, error) {
	...
	if rv == 0 {
		return MLLinkedModel{}, objc.ErrInitFailed
	}
...
func (m MLLinkedModel) UpdateParameterDescriptionsByUnarchivingSpecification(specification unsafe.Pointer) {
	objc.SendIfResponds[objc.ID](m.ID, objc.Sel("updateParameterDescriptionsByUnarchivingSpecification:"), specification)
}
func (m MLLinkedModel) InitWithLinkedModelModelFileNameModelSearchPathConfiguration(model objectivec.IObject, name objectivec.IObject, path objectivec.IObject, configuration objectivec.IObject) MLLinkedModel {
	rv := objc.SendIfResponds[MLLinkedModel](m.ID, objc.Sel("initWithLinkedModel:modelFileName:modelSearchPath:configuration:"), model, name, path, configuration)
	return rv
}
...
func (_MLLinkedModelClass MLLinkedModelClass) FindFileInSearchPathBasePath(file objectivec.IObject, path objectivec.IObject, path2 objectivec.IObject) objectivec.IObject {
	rv := objc.SendIfResponds[objc.ID](objc.ID(_MLLinkedModelClass.class), objc.Sel("findFile:inSearchPath:basePath:"), file, path, path2)
...
func (m MLLinkedModel) LinkedModel() IMLModel {
	rv := objc.SendIfResponds[objc.ID](m.ID, objc.Sel("linkedModel"))
	return MLModelFromID(objc.ID(rv))
}
func (m MLLinkedModel) SetLinkedModel(value IMLModel) {
	objc.SendIfResponds[struct{}](m.ID, objc.Sel("setLinkedModel:"), value)
}
func (m MLLinkedModel) ModelFileName() string {
	rv := objc.SendIfResponds[objc.ID](m.ID, objc.Sel("modelFileName"))
	return foundation.NSStringFromID(rv).String()
}
func (m MLLinkedModel) SetModelFileName(value string) {
	objc.SendIfResponds[struct{}](m.ID, objc.Sel("setModelFileName:"), objc.String(value))
}
func (m MLLinkedModel) ModelSearchPath() string {
	rv := objc.SendIfResponds[objc.ID](m.ID, objc.Sel("modelSearchPath"))
	return foundation.NSStringFromID(rv).String()
}
func (m MLLinkedModel) SetModelSearchPath(value string) {
	objc.SendIfResponds[struct{}](m.ID, objc.Sel("setModelSearchPath:"), objc.String(value))
}
