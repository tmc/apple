...
func (mc MLModelAssetResourceFactoryInMemoryImplClass) Alloc() MLModelAssetResourceFactoryInMemoryImpl {
	rv := objc.SendIfResponds[MLModelAssetResourceFactoryInMemoryImpl](objc.ID(mc.class), objc.Sel("alloc"))
	return rv
}
...
func (m MLModelAssetResourceFactoryInMemoryImpl) Init() MLModelAssetResourceFactoryInMemoryImpl {
	rv := objc.SendIfResponds[MLModelAssetResourceFactoryInMemoryImpl](m.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (m MLModelAssetResourceFactoryInMemoryImpl) Autorelease() MLModelAssetResourceFactoryInMemoryImpl {
	rv := objc.SendIfResponds[MLModelAssetResourceFactoryInMemoryImpl](m.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewMLModelAssetResourceFactoryInMemoryImpl() MLModelAssetResourceFactoryInMemoryImpl {
	...
	rv := objc.SendIfResponds[MLModelAssetResourceFactoryInMemoryImpl](objc.ID(class.class), objc.Sel("new"))
	return rv
}

func NewMLModelAssetResourceFactoryInMemoryImplWithArchiveData(data objectivec.IObject) MLModelAssetResourceFactoryInMemoryImpl {
...
func (m MLModelAssetResourceFactoryInMemoryImpl) InitWithArchiveData(data objectivec.IObject) MLModelAssetResourceFactoryInMemoryImpl {
	rv := objc.SendIfResponds[MLModelAssetResourceFactoryInMemoryImpl](m.ID, objc.Sel("initWithArchiveData:"), data)
	return rv
}
