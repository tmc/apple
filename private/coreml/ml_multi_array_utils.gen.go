...
func (mc MLMultiArrayUtilsClass) Alloc() MLMultiArrayUtils {
	rv := objc.SendIfResponds[MLMultiArrayUtils](objc.ID(mc.class), objc.Sel("alloc"))
	return rv
}
...
func (m MLMultiArrayUtils) Init() MLMultiArrayUtils {
	rv := objc.SendIfResponds[MLMultiArrayUtils](m.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (m MLMultiArrayUtils) Autorelease() MLMultiArrayUtils {
	rv := objc.SendIfResponds[MLMultiArrayUtils](m.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewMLMultiArrayUtils() MLMultiArrayUtils {
	...
	rv := objc.SendIfResponds[MLMultiArrayUtils](objc.ID(class.class), objc.Sel("new"))
	return rv
}

func (_MLMultiArrayUtilsClass MLMultiArrayUtilsClass) StringForDataType(type_ int64) objectivec.IObject {
	rv := objc.SendIfResponds[objc.ID](objc.ID(_MLMultiArrayUtilsClass.class), objc.Sel("stringForDataType:"), type_)
