...
func (mc MLNonMaximumSuppressionParametersClass) Alloc() MLNonMaximumSuppressionParameters {
	rv := objc.SendIfResponds[MLNonMaximumSuppressionParameters](objc.ID(mc.class), objc.Sel("alloc"))
	return rv
}
...
func (m MLNonMaximumSuppressionParameters) Init() MLNonMaximumSuppressionParameters {
	rv := objc.SendIfResponds[MLNonMaximumSuppressionParameters](m.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (m MLNonMaximumSuppressionParameters) Autorelease() MLNonMaximumSuppressionParameters {
	rv := objc.SendIfResponds[MLNonMaximumSuppressionParameters](m.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewMLNonMaximumSuppressionParameters() MLNonMaximumSuppressionParameters {
	...
	rv := objc.SendIfResponds[MLNonMaximumSuppressionParameters](objc.ID(class.class), objc.Sel("new"))
	return rv
}
...
func (m MLNonMaximumSuppressionParameters) ConfidenceInputFeatureName() string {
	rv := objc.SendIfResponds[objc.ID](m.ID, objc.Sel("confidenceInputFeatureName"))
	return foundation.NSStringFromID(rv).String()
}
func (m MLNonMaximumSuppressionParameters) SetConfidenceInputFeatureName(value string) {
	objc.SendIfResponds[struct{}](m.ID, objc.Sel("setConfidenceInputFeatureName:"), objc.String(value))
}
func (m MLNonMaximumSuppressionParameters) ConfidenceOutputFeatureName() string {
	rv := objc.SendIfResponds[objc.ID](m.ID, objc.Sel("confidenceOutputFeatureName"))
	return foundation.NSStringFromID(rv).String()
}
func (m MLNonMaximumSuppressionParameters) SetConfidenceOutputFeatureName(value string) {
	objc.SendIfResponds[struct{}](m.ID, objc.Sel("setConfidenceOutputFeatureName:"), objc.String(value))
}
func (m MLNonMaximumSuppressionParameters) ConfidenceThreshold() float64 {
	rv := objc.SendIfResponds[float64](m.ID, objc.Sel("confidenceThreshold"))
	return rv
}
func (m MLNonMaximumSuppressionParameters) SetConfidenceThreshold(value float64) {
	objc.SendIfResponds[struct{}](m.ID, objc.Sel("setConfidenceThreshold:"), value)
}
func (m MLNonMaximumSuppressionParameters) ConfidenceThresholdInputFeatureName() string {
	rv := objc.SendIfResponds[objc.ID](m.ID, objc.Sel("confidenceThresholdInputFeatureName"))
	return foundation.NSStringFromID(rv).String()
}
func (m MLNonMaximumSuppressionParameters) SetConfidenceThresholdInputFeatureName(value string) {
	objc.SendIfResponds[struct{}](m.ID, objc.Sel("setConfidenceThresholdInputFeatureName:"), objc.String(value))
}
func (m MLNonMaximumSuppressionParameters) CoordinatesInputFeatureName() string {
	rv := objc.SendIfResponds[objc.ID](m.ID, objc.Sel("coordinatesInputFeatureName"))
	return foundation.NSStringFromID(rv).String()
}
func (m MLNonMaximumSuppressionParameters) SetCoordinatesInputFeatureName(value string) {
	objc.SendIfResponds[struct{}](m.ID, objc.Sel("setCoordinatesInputFeatureName:"), objc.String(value))
}
func (m MLNonMaximumSuppressionParameters) CoordinatesOutputFeatureName() string {
	rv := objc.SendIfResponds[objc.ID](m.ID, objc.Sel("coordinatesOutputFeatureName"))
	return foundation.NSStringFromID(rv).String()
}
func (m MLNonMaximumSuppressionParameters) SetCoordinatesOutputFeatureName(value string) {
	objc.SendIfResponds[struct{}](m.ID, objc.Sel("setCoordinatesOutputFeatureName:"), objc.String(value))
}
func (m MLNonMaximumSuppressionParameters) IouThreshold() float64 {
	rv := objc.SendIfResponds[float64](m.ID, objc.Sel("iouThreshold"))
	return rv
}
func (m MLNonMaximumSuppressionParameters) SetIouThreshold(value float64) {
	objc.SendIfResponds[struct{}](m.ID, objc.Sel("setIouThreshold:"), value)
}
func (m MLNonMaximumSuppressionParameters) IouThresholdInputFeatureName() string {
	rv := objc.SendIfResponds[objc.ID](m.ID, objc.Sel("iouThresholdInputFeatureName"))
	return foundation.NSStringFromID(rv).String()
}
func (m MLNonMaximumSuppressionParameters) SetIouThresholdInputFeatureName(value string) {
	objc.SendIfResponds[struct{}](m.ID, objc.Sel("setIouThresholdInputFeatureName:"), objc.String(value))
}
...
func (m MLNonMaximumSuppressionParameters) MaxBoxes() int64 {
	rv := objc.SendIfResponds[int64](m.ID, objc.Sel("maxBoxes"))
	return rv
}
func (m MLNonMaximumSuppressionParameters) SetMaxBoxes(value int64) {
	objc.SendIfResponds[struct{}](m.ID, objc.Sel("setMaxBoxes:"), value)
}
func (m MLNonMaximumSuppressionParameters) MinBoxes() uint64 {
	rv := objc.SendIfResponds[uint64](m.ID, objc.Sel("minBoxes"))
	return rv
}
func (m MLNonMaximumSuppressionParameters) SetMinBoxes(value uint64) {
	objc.SendIfResponds[struct{}](m.ID, objc.Sel("setMinBoxes:"), value)
}
...
func (m MLNonMaximumSuppressionParameters) PerClass() bool {
	rv := objc.SendIfResponds[bool](m.ID, objc.Sel("perClass"))
	return rv
}
