...
func (mc MLPixelBufferPoolClass) Alloc() MLPixelBufferPool {
	rv := objc.SendIfResponds[MLPixelBufferPool](objc.ID(mc.class), objc.Sel("alloc"))
	return rv
}
...
func (m MLPixelBufferPool) Init() MLPixelBufferPool {
	rv := objc.SendIfResponds[MLPixelBufferPool](m.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (m MLPixelBufferPool) Autorelease() MLPixelBufferPool {
	rv := objc.SendIfResponds[MLPixelBufferPool](m.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewMLPixelBufferPool() MLPixelBufferPool {
	...
	rv := objc.SendIfResponds[MLPixelBufferPool](objc.ID(class.class), objc.Sel("new"))
	return rv
}
...
func (m MLPixelBufferPool) PixelBufferPoolCache() foundation.INSDictionary {
	rv := objc.SendIfResponds[objc.ID](m.ID, objc.Sel("pixelBufferPoolCache"))
