...
func (mc MLPowBroadcastableBrickClass) Alloc() MLPowBroadcastableBrick {
	rv := objc.SendIfResponds[MLPowBroadcastableBrick](objc.ID(mc.class), objc.Sel("alloc"))
	return rv
}
...
func (m MLPowBroadcastableBrick) Init() MLPowBroadcastableBrick {
	rv := objc.SendIfResponds[MLPowBroadcastableBrick](m.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (m MLPowBroadcastableBrick) Autorelease() MLPowBroadcastableBrick {
	rv := objc.SendIfResponds[MLPowBroadcastableBrick](m.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewMLPowBroadcastableBrick() MLPowBroadcastableBrick {
	...
	rv := objc.SendIfResponds[MLPowBroadcastableBrick](objc.ID(class.class), objc.Sel("new"))
	return rv
}

func NewMLPowBroadcastableBrickWithParameters(parameters objectivec.IObject) MLPowBroadcastableBrick {
...
func (m MLPowBroadcastableBrick) InitWithParameters(parameters objectivec.IObject) MLPowBroadcastableBrick {
	rv := objc.SendIfResponds[MLPowBroadcastableBrick](m.ID, objc.Sel("initWithParameters:"), parameters)
	return rv
}
...
func (m MLPowBroadcastableBrick) Superclass() objectivec.Class {
