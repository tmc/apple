...
func (mc MLProgramEngineClass) Alloc() MLProgramEngine {
	rv := objc.SendIfResponds[MLProgramEngine](objc.ID(mc.class), objc.Sel("alloc"))
	return rv
}
...
func (m MLProgramEngine) Init() MLProgramEngine {
	rv := objc.SendIfResponds[MLProgramEngine](m.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (m MLProgramEngine) Autorelease() MLProgramEngine {
	rv := objc.SendIfResponds[MLProgramEngine](m.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewMLProgramEngine() MLProgramEngine {
	...
	rv := objc.SendIfResponds[MLProgramEngine](objc.ID(class.class), objc.Sel("new"))
	return rv
}
...
func NewProgramEngineWithContainerConfigurationError(container objectivec.IObject, configuration objectivec.IObject) (MLProgramEngine, error) {
	...
	if rv == 0 {
		return MLProgramEngine{}, objc.ErrInitFailed
	}
