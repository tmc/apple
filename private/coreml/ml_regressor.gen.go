...
func (mc MLRegressorClass) Alloc() MLRegressor {
	rv := objc.SendIfResponds[MLRegressor](objc.ID(mc.class), objc.Sel("alloc"))
	return rv
}
...
func (m MLRegressor) Init() MLRegressor {
	rv := objc.SendIfResponds[MLRegressor](m.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (m MLRegressor) Autorelease() MLRegressor {
	rv := objc.SendIfResponds[MLRegressor](m.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewMLRegressor() MLRegressor {
	...
	rv := objc.SendIfResponds[MLRegressor](objc.ID(class.class), objc.Sel("new"))
	return rv
}
