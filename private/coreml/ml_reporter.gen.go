...
func (mc MLReporterClass) Alloc() MLReporter {
	rv := objc.SendIfResponds[MLReporter](objc.ID(mc.class), objc.Sel("alloc"))
	return rv
}
...
func (m MLReporter) Init() MLReporter {
	rv := objc.SendIfResponds[MLReporter](m.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (m MLReporter) Autorelease() MLReporter {
	rv := objc.SendIfResponds[MLReporter](m.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewMLReporter() MLReporter {
	...
	rv := objc.SendIfResponds[MLReporter](objc.ID(class.class), objc.Sel("new"))
	return rv
}

func (m MLReporter) LogMetric(metric objectivec.IObject) {
	objc.SendIfResponds[objc.ID](m.ID, objc.Sel("logMetric:"), metric)
}

func (_MLReporterClass MLReporterClass) Reporter() objectivec.IObject {
	rv := objc.SendIfResponds[objc.ID](objc.ID(_MLReporterClass.class), objc.Sel("reporter"))
