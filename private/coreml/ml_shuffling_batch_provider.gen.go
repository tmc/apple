...
func (mc MLShufflingBatchProviderClass) Alloc() MLShufflingBatchProvider {
	rv := objc.SendIfResponds[MLShufflingBatchProvider](objc.ID(mc.class), objc.Sel("alloc"))
	return rv
}
...
func (m MLShufflingBatchProvider) Init() MLShufflingBatchProvider {
	rv := objc.SendIfResponds[MLShufflingBatchProvider](m.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (m MLShufflingBatchProvider) Autorelease() MLShufflingBatchProvider {
	rv := objc.SendIfResponds[MLShufflingBatchProvider](m.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewMLShufflingBatchProvider() MLShufflingBatchProvider {
	...
	rv := objc.SendIfResponds[MLShufflingBatchProvider](objc.ID(class.class), objc.Sel("new"))
	return rv
}
...
func (m MLShufflingBatchProvider) Shuffle() {
	objc.SendIfResponds[objc.ID](m.ID, objc.Sel("shuffle"))
}
func (m MLShufflingBatchProvider) InitWithBatchProviderSeed(provider objectivec.IObject, seed objectivec.IObject) MLShufflingBatchProvider {
	rv := objc.SendIfResponds[MLShufflingBatchProvider](m.ID, objc.Sel("initWithBatchProvider:seed:"), provider, seed)
	return rv
}
...
func (m MLShufflingBatchProvider) SetBatchProvider(value unsafe.Pointer) {
	objc.SendIfResponds[struct{}](m.ID, objc.Sel("setBatchProvider:"), value)
}
