...
func (mc MLStackNDBrickClass) Alloc() MLStackNDBrick {
	rv := objc.SendIfResponds[MLStackNDBrick](objc.ID(mc.class), objc.Sel("alloc"))
	return rv
}
...
func (m MLStackNDBrick) Init() MLStackNDBrick {
	rv := objc.SendIfResponds[MLStackNDBrick](m.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (m MLStackNDBrick) Autorelease() MLStackNDBrick {
	rv := objc.SendIfResponds[MLStackNDBrick](m.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewMLStackNDBrick() MLStackNDBrick {
	...
	rv := objc.SendIfResponds[MLStackNDBrick](objc.ID(class.class), objc.Sel("new"))
	return rv
}

func NewMLStackNDBrickWithParameters(parameters objectivec.IObject) MLStackNDBrick {
...
func (m MLStackNDBrick) InitWithParameters(parameters objectivec.IObject) MLStackNDBrick {
	rv := objc.SendIfResponds[MLStackNDBrick](m.ID, objc.Sel("initWithParameters:"), parameters)
	return rv
}
