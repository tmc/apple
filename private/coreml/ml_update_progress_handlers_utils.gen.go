...
func (mc MLUpdateProgressHandlersUtilsClass) Alloc() MLUpdateProgressHandlersUtils {
	rv := objc.SendIfResponds[MLUpdateProgressHandlersUtils](objc.ID(mc.class), objc.Sel("alloc"))
	return rv
}
...
func (m MLUpdateProgressHandlersUtils) Init() MLUpdateProgressHandlersUtils {
	rv := objc.SendIfResponds[MLUpdateProgressHandlersUtils](m.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (m MLUpdateProgressHandlersUtils) Autorelease() MLUpdateProgressHandlersUtils {
	rv := objc.SendIfResponds[MLUpdateProgressHandlersUtils](m.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewMLUpdateProgressHandlersUtils() MLUpdateProgressHandlersUtils {
	...
	rv := objc.SendIfResponds[MLUpdateProgressHandlersUtils](objc.ID(class.class), objc.Sel("new"))
	return rv
}
...
func (_MLUpdateProgressHandlersUtilsClass MLUpdateProgressHandlersUtilsClass) ProgressEventsToString(string_ int64) objectivec.IObject {
	rv := objc.SendIfResponds[objc.ID](objc.ID(_MLUpdateProgressHandlersUtilsClass.class), objc.Sel("progressEventsToString:"), string_)
