...
func (mc MLSVRLoaderClass) Alloc() MLSVRLoader {
	rv := objc.SendIfResponds[MLSVRLoader](objc.ID(mc.class), objc.Sel("alloc"))
	return rv
}
...
func (m MLSVRLoader) Init() MLSVRLoader {
	rv := objc.SendIfResponds[MLSVRLoader](m.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (m MLSVRLoader) Autorelease() MLSVRLoader {
	rv := objc.SendIfResponds[MLSVRLoader](m.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewMLSVRLoader() MLSVRLoader {
	...
	rv := objc.SendIfResponds[MLSVRLoader](objc.ID(class.class), objc.Sel("new"))
	return rv
}
