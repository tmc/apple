...
type IMLVNFrameworkHandle interface {
	...
	VNImageBufferClass() objectivec.Class
	...
	CreatePixelBufferFromImageAtURLConstraintCropRectCropAndScaleOptionOptionsError(url foundation.NSURL, constraint objectivec.IObject, rect corefoundation.CGRect, option uint64, options objectivec.IObject) (corevideo.CVImageBufferRef, error)
...
func (m MLVNFrameworkHandle) CreatePixelBufferFromImageAtURLConstraintCropRectCropAndScaleOptionOptionsError(url foundation.NSURL, constraint objectivec.IObject, rect corefoundation.CGRect, option uint64, options objectivec.IObject) (corevideo.CVImageBufferRef, error) {
	var errorPtr objc.ID
