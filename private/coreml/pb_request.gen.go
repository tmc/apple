...
func (pc PBRequestClass) Alloc() PBRequest {
	rv := objc.SendIfResponds[PBRequest](objc.ID(pc.class), objc.Sel("alloc"))
	return rv
}
...
func (p PBRequest) Init() PBRequest {
	rv := objc.SendIfResponds[PBRequest](p.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (p PBRequest) Autorelease() PBRequest {
	rv := objc.SendIfResponds[PBRequest](p.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewPBRequest() PBRequest {
	...
	rv := objc.SendIfResponds[PBRequest](objc.ID(class.class), objc.Sel("new"))
	return rv
}
