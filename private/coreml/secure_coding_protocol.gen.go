...
//
// See: https://developer.apple.com/documentation/CoreML/NSSecureCoding
type NSSecureCoding interface {
	objectivec.IObject

	// SupportsSecureCoding protocol.
	//
	// See: https://developer.apple.com/documentation/CoreML/NSSecureCoding/supportsSecureCoding
