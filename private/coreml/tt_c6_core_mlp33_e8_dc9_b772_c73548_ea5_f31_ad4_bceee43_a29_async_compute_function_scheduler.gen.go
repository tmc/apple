...
func (ec EA5F31AD4BCEEE43A29AsyncComputeFunctionSchedulerClass) Alloc() EA5F31AD4BCEEE43A29AsyncComputeFunctionScheduler {
	rv := objc.Send[EA5F31AD4BCEEE43A29AsyncComputeFunctionScheduler](objc.ID(ec.class), objc.Sel("alloc"))
	return rv
}
...
// NOTE: EA5F31AD4BCEEE43A29AsyncComputeFunctionScheduler struct embeds objectivec.Object (parent type unavailable) but
// IEA5F31AD4BCEEE43A29AsyncComputeFunctionScheduler embeds the parent interface; skip compile-time assertion.
...
func (e EA5F31AD4BCEEE43A29AsyncComputeFunctionScheduler) Init() EA5F31AD4BCEEE43A29AsyncComputeFunctionScheduler {
	rv := objc.Send[EA5F31AD4BCEEE43A29AsyncComputeFunctionScheduler](e.ID, objc.Sel("init"))
	return rv
}
...
func (e EA5F31AD4BCEEE43A29AsyncComputeFunctionScheduler) Autorelease() EA5F31AD4BCEEE43A29AsyncComputeFunctionScheduler {
	rv := objc.Send[EA5F31AD4BCEEE43A29AsyncComputeFunctionScheduler](e.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewEA5F31AD4BCEEE43A29AsyncComputeFunctionScheduler() EA5F31AD4BCEEE43A29AsyncComputeFunctionScheduler {
	...
	rv := objc.Send[EA5F31AD4BCEEE43A29AsyncComputeFunctionScheduler](objc.ID(class.class), objc.Sel("new"))
	return rv
}
