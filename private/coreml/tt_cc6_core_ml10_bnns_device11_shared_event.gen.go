...
func getSharedEventClass() SharedEventClass {
	_SharedEventClassOnce.Do(func() {
		_SharedEventClass = SharedEventClass{class: objc.GetClass("_TtCC6CoreML10BNNSDevice11SharedEvent")}
	})
	return _SharedEventClass
}

// GetSharedEventClass returns the class object for _TtCC6CoreML10BNNSDevice11SharedEvent.
func GetSharedEventClass() SharedEventClass {
