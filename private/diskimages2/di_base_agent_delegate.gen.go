...
func (dc DIBaseAgentDelegateClass) Alloc() DIBaseAgentDelegate {
	rv := objc.SendIfResponds[DIBaseAgentDelegate](objc.ID(dc.class), objc.Sel("alloc"))
	return rv
}
...
func (d DIBaseAgentDelegate) Init() DIBaseAgentDelegate {
	rv := objc.SendIfResponds[DIBaseAgentDelegate](d.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (d DIBaseAgentDelegate) Autorelease() DIBaseAgentDelegate {
	rv := objc.SendIfResponds[DIBaseAgentDelegate](d.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewDIBaseAgentDelegate() DIBaseAgentDelegate {
	...
	rv := objc.SendIfResponds[DIBaseAgentDelegate](objc.ID(class.class), objc.Sel("new"))
	return rv
}
