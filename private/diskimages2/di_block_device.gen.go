...
func (dc DIBlockDeviceClass) Alloc() DIBlockDevice {
	rv := objc.SendIfResponds[DIBlockDevice](objc.ID(dc.class), objc.Sel("alloc"))
	return rv
}
...
func (d DIBlockDevice) Init() DIBlockDevice {
	rv := objc.SendIfResponds[DIBlockDevice](d.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (d DIBlockDevice) Autorelease() DIBlockDevice {
	rv := objc.SendIfResponds[DIBlockDevice](d.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewDIBlockDevice() DIBlockDevice {
	...
	rv := objc.SendIfResponds[DIBlockDevice](objc.ID(class.class), objc.Sel("new"))
	return rv
}
...
func NewDIBlockDeviceWithClassNameError(name objectivec.IObject) (DIBlockDevice, error) {
	...
	if rv == 0 {
		return DIBlockDevice{}, objc.ErrInitFailed
	}
...
func (d DIBlockDevice) DiskImageDevice() bool {
	rv := objc.SendIfResponds[bool](d.ID, objc.Sel("diskImageDevice"))
	return rv
}
func (d DIBlockDevice) MediumType() string {
	rv := objc.SendIfResponds[objc.ID](d.ID, objc.Sel("mediumType"))
