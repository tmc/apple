...
func (dc DiskImageParamsUDIFXPCClass) Alloc() DiskImageParamsUDIFXPC {
	rv := objc.SendIfResponds[DiskImageParamsUDIFXPC](objc.ID(dc.class), objc.Sel("alloc"))
	return rv
}
...
func (d DiskImageParamsUDIFXPC) Init() DiskImageParamsUDIFXPC {
	rv := objc.SendIfResponds[DiskImageParamsUDIFXPC](d.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (d DiskImageParamsUDIFXPC) Autorelease() DiskImageParamsUDIFXPC {
	rv := objc.SendIfResponds[DiskImageParamsUDIFXPC](d.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewDiskImageParamsUDIFXPC() DiskImageParamsUDIFXPC {
	...
	rv := objc.SendIfResponds[DiskImageParamsUDIFXPC](objc.ID(class.class), objc.Sel("new"))
	return rv
}
