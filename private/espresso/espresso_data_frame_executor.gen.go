...
func (ec EspressoDataFrameExecutorClass) Alloc() EspressoDataFrameExecutor {
	rv := objc.SendIfResponds[EspressoDataFrameExecutor](objc.ID(ec.class), objc.Sel("alloc"))
	return rv
}
...
func (e EspressoDataFrameExecutor) Init() EspressoDataFrameExecutor {
	rv := objc.SendIfResponds[EspressoDataFrameExecutor](e.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (e EspressoDataFrameExecutor) Autorelease() EspressoDataFrameExecutor {
	rv := objc.SendIfResponds[EspressoDataFrameExecutor](e.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewEspressoDataFrameExecutor() EspressoDataFrameExecutor {
	...
	rv := objc.SendIfResponds[EspressoDataFrameExecutor](objc.ID(class.class), objc.Sel("new"))
	return rv
}
...
func (e EspressoDataFrameExecutor) FreeTemporaryResources() {
	objc.SendIfResponds[objc.ID](e.ID, objc.Sel("freeTemporaryResources"))
}
func (e EspressoDataFrameExecutor) UseCVPixelBuffers() bool {
	rv := objc.SendIfResponds[bool](e.ID, objc.Sel("useCVPixelBuffers"))
	return rv
}
func (e EspressoDataFrameExecutor) UseCVPixelBuffersForOutputs(outputs bool) bool {
	rv := objc.SendIfResponds[bool](e.ID, objc.Sel("useCVPixelBuffersForOutputs:"), outputs)
	return rv
}

func (e EspressoDataFrameExecutor) OutputMatchingBuffers() foundation.INSArray {
	rv := objc.SendIfResponds[objc.ID](e.ID, objc.Sel("outputMatchingBuffers"))
