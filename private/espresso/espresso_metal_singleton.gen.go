...
func (ec EspressoMetalSingletonClass) Alloc() EspressoMetalSingleton {
	rv := objc.SendIfResponds[EspressoMetalSingleton](objc.ID(ec.class), objc.Sel("alloc"))
	return rv
}
...
func (e EspressoMetalSingleton) Init() EspressoMetalSingleton {
	rv := objc.SendIfResponds[EspressoMetalSingleton](e.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (e EspressoMetalSingleton) Autorelease() EspressoMetalSingleton {
	rv := objc.SendIfResponds[EspressoMetalSingleton](e.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewEspressoMetalSingleton() EspressoMetalSingleton {
	...
	rv := objc.SendIfResponds[EspressoMetalSingleton](objc.ID(class.class), objc.Sel("new"))
	return rv
}

func (_EspressoMetalSingletonClass EspressoMetalSingletonClass) Shared() EspressoMetalSingleton {
	rv := objc.SendIfResponds[objc.ID](objc.ID(_EspressoMetalSingletonClass.class), objc.Sel("shared"))
