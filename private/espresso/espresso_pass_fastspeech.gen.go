...
func (ec EspressoPassFastspeechClass) Alloc() EspressoPassFastspeech {
	rv := objc.Send[EspressoPassFastspeech](objc.ID(ec.class), objc.Sel("alloc"))
	return rv
}
...
func (e EspressoPassFastspeech) Init() EspressoPassFastspeech {
	rv := objc.Send[EspressoPassFastspeech](e.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (e EspressoPassFastspeech) Autorelease() EspressoPassFastspeech {
	rv := objc.Send[EspressoPassFastspeech](e.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewEspressoPassFastspeech() EspressoPassFastspeech {
	...
	rv := objc.Send[EspressoPassFastspeech](objc.ID(class.class), objc.Sel("new"))
	return rv
}
