...
func (ec EspressoPassRemoveSqueezeClass) Alloc() EspressoPassRemoveSqueeze {
	rv := objc.SendIfResponds[EspressoPassRemoveSqueeze](objc.ID(ec.class), objc.Sel("alloc"))
	return rv
}
...
func (e EspressoPassRemoveSqueeze) Init() EspressoPassRemoveSqueeze {
	rv := objc.SendIfResponds[EspressoPassRemoveSqueeze](e.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (e EspressoPassRemoveSqueeze) Autorelease() EspressoPassRemoveSqueeze {
	rv := objc.SendIfResponds[EspressoPassRemoveSqueeze](e.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewEspressoPassRemoveSqueeze() EspressoPassRemoveSqueeze {
	...
	rv := objc.SendIfResponds[EspressoPassRemoveSqueeze](objc.ID(class.class), objc.Sel("new"))
	return rv
}
