...
func (ec EspressoPassTransformQuantizeKernelClass) Alloc() EspressoPassTransformQuantizeKernel {
	rv := objc.SendIfResponds[EspressoPassTransformQuantizeKernel](objc.ID(ec.class), objc.Sel("alloc"))
	return rv
}
...
func (e EspressoPassTransformQuantizeKernel) Init() EspressoPassTransformQuantizeKernel {
	rv := objc.SendIfResponds[EspressoPassTransformQuantizeKernel](e.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (e EspressoPassTransformQuantizeKernel) Autorelease() EspressoPassTransformQuantizeKernel {
	rv := objc.SendIfResponds[EspressoPassTransformQuantizeKernel](e.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewEspressoPassTransformQuantizeKernel() EspressoPassTransformQuantizeKernel {
	...
	rv := objc.SendIfResponds[EspressoPassTransformQuantizeKernel](objc.ID(class.class), objc.Sel("new"))
	return rv
}
