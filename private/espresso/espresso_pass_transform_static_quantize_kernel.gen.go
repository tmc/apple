...
func (ec EspressoPassTransformStaticQuantizeKernelClass) Alloc() EspressoPassTransformStaticQuantizeKernel {
	rv := objc.SendIfResponds[EspressoPassTransformStaticQuantizeKernel](objc.ID(ec.class), objc.Sel("alloc"))
	return rv
}
...
func (e EspressoPassTransformStaticQuantizeKernel) Init() EspressoPassTransformStaticQuantizeKernel {
	rv := objc.SendIfResponds[EspressoPassTransformStaticQuantizeKernel](e.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (e EspressoPassTransformStaticQuantizeKernel) Autorelease() EspressoPassTransformStaticQuantizeKernel {
	rv := objc.SendIfResponds[EspressoPassTransformStaticQuantizeKernel](e.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewEspressoPassTransformStaticQuantizeKernel() EspressoPassTransformStaticQuantizeKernel {
	...
	rv := objc.SendIfResponds[EspressoPassTransformStaticQuantizeKernel](objc.ID(class.class), objc.Sel("new"))
	return rv
}
