...
func (ec EspressoSharedKernelCacheEntryClass) Alloc() EspressoSharedKernelCacheEntry {
	rv := objc.SendIfResponds[EspressoSharedKernelCacheEntry](objc.ID(ec.class), objc.Sel("alloc"))
	return rv
}
...
func (e EspressoSharedKernelCacheEntry) Init() EspressoSharedKernelCacheEntry {
	rv := objc.SendIfResponds[EspressoSharedKernelCacheEntry](e.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (e EspressoSharedKernelCacheEntry) Autorelease() EspressoSharedKernelCacheEntry {
	rv := objc.SendIfResponds[EspressoSharedKernelCacheEntry](e.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewEspressoSharedKernelCacheEntry() EspressoSharedKernelCacheEntry {
	...
	rv := objc.SendIfResponds[EspressoSharedKernelCacheEntry](objc.ID(class.class), objc.Sel("new"))
	return rv
}

func (e EspressoSharedKernelCacheEntry) Cached() IEspressoMetalKernelsCache {
	rv := objc.SendIfResponds[objc.ID](e.ID, objc.Sel("cached"))
...
func (e EspressoSharedKernelCacheEntry) SetCached(value IEspressoMetalKernelsCache) {
	objc.SendIfResponds[struct{}](e.ID, objc.Sel("setCached:"), value)
}
