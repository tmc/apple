...
func (ec ETDataTensorClass) Alloc() ETDataTensor {
	rv := objc.SendIfResponds[ETDataTensor](objc.ID(ec.class), objc.Sel("alloc"))
	return rv
}
...
type IETDataTensor interface {
	...
	Float_buffer() appleneuralengine.FloatBuffer
	SetFloat_buffer(value appleneuralengine.FloatBuffer)
	ImageBuffer() appleneuralengine.VImageBuffer
	SetImageBuffer(value appleneuralengine.VImageBuffer)
...
func (e ETDataTensor) Init() ETDataTensor {
	rv := objc.SendIfResponds[ETDataTensor](e.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (e ETDataTensor) Autorelease() ETDataTensor {
	rv := objc.SendIfResponds[ETDataTensor](e.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewETDataTensor() ETDataTensor {
	...
	rv := objc.SendIfResponds[ETDataTensor](objc.ID(class.class), objc.Sel("new"))
	return rv
}

func NewETDataTensorWithBlobContainer(container unsafe.Pointer) ETDataTensor {
	instance := getETDataTensorClass().Alloc()
	rv := objc.SendIfResponds[objc.ID](instance.ID, objc.Sel("initWithBlobContainer:"), container)
...
func NewETDataTensorWithBlobContainerDirectBind(container unsafe.Pointer, bind bool) ETDataTensor {
	instance := getETDataTensorClass().Alloc()
	rv := objc.SendIfResponds[objc.ID](instance.ID, objc.Sel("initWithBlobContainer:directBind:"), container, bind)
	return ETDataTensorFromID(rv)
}
...
func NewETDataTensorWithCVPixelBufferImageParametersError(buffer corevideo.CVImageBufferRef, parameters objectivec.IObject) (ETDataTensor, error) {
	...
	instance := getETDataTensorClass().Alloc()
	rv := objc.SendIfResponds[objc.ID](instance.ID, objc.Sel("initWithCVPixelBuffer:imageParameters:error:"), buffer, parameters, unsafe.Pointer(&errorPtr))
	if errorPtr != 0 {
		objc.Send[objc.ID](errorPtr, objc.Sel("retain"))
		return ETDataTensor{}, foundation.NSErrorFrom(errorPtr)
	}
	if rv == 0 {
		return ETDataTensor{}, objc.ErrInitFailed
	}
...
func NewETDataTensorWithDataTypeShapeStrides(data unsafe.Pointer, type_ uint64, shape objectivec.IObject, strides objectivec.IObject) ETDataTensor {
	instance := getETDataTensorClass().Alloc()
	rv := objc.SendIfResponds[objc.ID](instance.ID, objc.Sel("initWithData:type:shape:strides:"), data, type_, shape, strides)
	return ETDataTensorFromID(rv)
}
...
func (e ETDataTensor) InitWithDataTypeShapeStrides(data unsafe.Pointer, type_ uint64, shape objectivec.IObject, strides objectivec.IObject) ETDataTensor {
	rv := objc.SendIfResponds[ETDataTensor](e.ID, objc.Sel("initWithData:type:shape:strides:"), data, type_, shape, strides)
	return rv
}

func (e ETDataTensor) AllocatedImageData() unsafe.Pointer {
	rv := objc.SendIfResponds[unsafe.Pointer](e.ID, objc.Sel("allocatedImageData"))
	return rv
}
func (e ETDataTensor) SetAllocatedImageData(value unsafe.Pointer) {
	objc.SendIfResponds[struct{}](e.ID, objc.Sel("setAllocatedImageData:"), value)
}
func (e ETDataTensor) Blob() unsafe.Pointer {
	rv := objc.SendIfResponds[unsafe.Pointer](e.ID, objc.Sel("blob"))
	return rv
}
func (e ETDataTensor) SetBlob(value unsafe.Pointer) {
	objc.SendIfResponds[struct{}](e.ID, objc.Sel("setBlob:"), value)
}
func (e ETDataTensor) DataArray() foundation.INSArray {
	rv := objc.SendIfResponds[objc.ID](e.ID, objc.Sel("dataArray"))
	return foundation.NSArrayFromID(objc.ID(rv))
}
func (e ETDataTensor) SetDataArray(value foundation.INSArray) {
	objc.SendIfResponds[struct{}](e.ID, objc.Sel("setDataArray:"), value)
}
func (e ETDataTensor) DataPointer() unsafe.Pointer {
	rv := objc.SendIfResponds[unsafe.Pointer](e.ID, objc.Sel("dataPointer"))
	return rv
}
func (e ETDataTensor) SetDataPointer(value unsafe.Pointer) {
	objc.SendIfResponds[struct{}](e.ID, objc.Sel("setDataPointer:"), value)
}
func (e ETDataTensor) Float_buffer() appleneuralengine.FloatBuffer {
	rv := objc.SendIfResponds[appleneuralengine.FloatBuffer](e.ID, objc.Sel("float_buffer"))
	return appleneuralengine.FloatBuffer(rv)
}
func (e ETDataTensor) SetFloat_buffer(value appleneuralengine.FloatBuffer) {
	objc.SendIfResponds[struct{}](e.ID, objc.Sel("setFloat_buffer:"), value)
}
func (e ETDataTensor) ImageBuffer() appleneuralengine.VImageBuffer {
	rv := objc.SendIfResponds[appleneuralengine.VImageBuffer](e.ID, objc.Sel("imageBuffer"))
	return appleneuralengine.VImageBuffer(rv)
}
func (e ETDataTensor) SetImageBuffer(value appleneuralengine.VImageBuffer) {
...
func (e ETDataTensor) Strides() foundation.INSArray {
	rv := objc.SendIfResponds[objc.ID](e.ID, objc.Sel("strides"))
	return foundation.NSArrayFromID(objc.ID(rv))
}
func (e ETDataTensor) SetStrides(value foundation.INSArray) {
	objc.SendIfResponds[struct{}](e.ID, objc.Sel("setStrides:"), value)
}
func (e ETDataTensor) Type() uint64 {
	rv := objc.SendIfResponds[uint64](e.ID, objc.Sel("type"))
	return rv
}
func (e ETDataTensor) SetType(value uint64) {
	objc.SendIfResponds[struct{}](e.ID, objc.Sel("setType:"), value)
}
