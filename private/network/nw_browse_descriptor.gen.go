...
func (nc NWBrowseDescriptorClass) Alloc() NWBrowseDescriptor {
	rv := objc.SendIfResponds[NWBrowseDescriptor](objc.ID(nc.class), objc.Sel("alloc"))
	return rv
}
...
func (n NWBrowseDescriptor) Init() NWBrowseDescriptor {
	rv := objc.SendIfResponds[NWBrowseDescriptor](n.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (n NWBrowseDescriptor) Autorelease() NWBrowseDescriptor {
	rv := objc.SendIfResponds[NWBrowseDescriptor](n.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewNWBrowseDescriptor() NWBrowseDescriptor {
	...
	rv := objc.SendIfResponds[NWBrowseDescriptor](objc.ID(class.class), objc.Sel("new"))
	return rv
}
...
func NewNWBrowseDescriptorWithEncodedData(data objectivec.IObject) NWBrowseDescriptor {
	instance := getNWBrowseDescriptorClass().Alloc()
	rv := objc.SendIfResponds[objc.ID](instance.ID, objc.Sel("initWithEncodedData:"), data)
	return NWBrowseDescriptorFromID(rv)
}

func (n NWBrowseDescriptor) BrowseWithCompletionHandler(handler ErrorHandler) {
	_block0, _ := NewErrorBlock(handler)
	objc.SendIfResponds[objc.ID](n.ID, objc.Sel("browseWithCompletionHandler:"), _block0)
}
...
func (n NWBrowseDescriptor) InitWithDescriptor(descriptor objectivec.IObject) NWBrowseDescriptor {
	rv := objc.SendIfResponds[NWBrowseDescriptor](n.ID, objc.Sel("initWithDescriptor:"), descriptor)
	return rv
}
func (n NWBrowseDescriptor) InitWithEncodedData(data objectivec.IObject) NWBrowseDescriptor {
	rv := objc.SendIfResponds[NWBrowseDescriptor](n.ID, objc.Sel("initWithEncodedData:"), data)
	return rv
}
...
func (_NWBrowseDescriptorClass NWBrowseDescriptorClass) DescriptorType() uint32 {
	rv := objc.SendIfResponds[uint32](objc.ID(_NWBrowseDescriptorClass.class), objc.Sel("descriptorType"))
	return rv
}
func (_NWBrowseDescriptorClass NWBrowseDescriptorClass) DescriptorWithInternalDescriptor(descriptor objectivec.IObject) objectivec.IObject {
	rv := objc.SendIfResponds[objc.ID](objc.ID(_NWBrowseDescriptorClass.class), objc.Sel("descriptorWithInternalDescriptor:"), descriptor)
	return objectivec.Object{ID: rv}
}
func (_NWBrowseDescriptorClass NWBrowseDescriptorClass) DescriptorWithProtocolBufferData(data objectivec.IObject) objectivec.IObject {
	rv := objc.SendIfResponds[objc.ID](objc.ID(_NWBrowseDescriptorClass.class), objc.Sel("descriptorWithProtocolBufferData:"), data)
	return objectivec.Object{ID: rv}
}
func (_NWBrowseDescriptorClass NWBrowseDescriptorClass) SupportsBrowseCallback() bool {
	rv := objc.SendIfResponds[bool](objc.ID(_NWBrowseDescriptorClass.class), objc.Sel("supportsBrowseCallback"))
	return rv
}
