...
// See: https://developer.apple.com/documentation/Network/NWBrowseDescriptor/descriptionWithIndent:showFullContent:
...
func (_NWBrowseDescriptorClass NWBrowseDescriptorClass) CopyClassForDescriptorType(type_ int) objc.Class {
	rv := objc.Send[objc.Class](objc.ID(_NWBrowseDescriptorClass.class), objc.Sel("copyClassForDescriptorType:"), type_)
	return rv
}
...
// See: https://developer.apple.com/documentation/Network/NWBrowseDescriptor/descriptorWithInternalDescriptor:
...
// See: https://developer.apple.com/documentation/Network/NWBrowseDescriptor/descriptorWithProtocolBufferData:
