...
func (nc NWEndpointClass) Alloc() NWEndpoint {
	rv := objc.SendIfResponds[NWEndpoint](objc.ID(nc.class), objc.Sel("alloc"))
	return rv
}
...
func (n NWEndpoint) Init() NWEndpoint {
	rv := objc.SendIfResponds[NWEndpoint](n.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (n NWEndpoint) Autorelease() NWEndpoint {
	rv := objc.SendIfResponds[NWEndpoint](n.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewNWEndpoint() NWEndpoint {
	...
	rv := objc.SendIfResponds[NWEndpoint](objc.ID(class.class), objc.Sel("new"))
	return rv
}
...
func (n NWEndpoint) CopyCEndpoint() objectivec.IObject {
	rv := objc.SendIfResponds[objc.ID](n.ID, objc.Sel("copyCEndpoint"))
...
func (n NWEndpoint) EncodedData() objectivec.IObject {
	rv := objc.SendIfResponds[objc.ID](n.ID, objc.Sel("encodedData"))
	return objectivec.Object{ID: rv}
}
func (n NWEndpoint) InitWithCoder(coder foundation.INSCoder) NWEndpoint {
	rv := objc.SendIfResponds[NWEndpoint](n.ID, objc.Sel("initWithCoder:"), coder)
	return rv
}
func (n NWEndpoint) InitWithEndpoint(endpoint objectivec.IObject) NWEndpoint {
	rv := objc.SendIfResponds[NWEndpoint](n.ID, objc.Sel("initWithEndpoint:"), endpoint)
	return rv
}
...
func (_NWEndpointClass NWEndpointClass) EndpointType() uint32 {
	rv := objc.SendIfResponds[uint32](objc.ID(_NWEndpointClass.class), objc.Sel("endpointType"))
	return rv
}
func (_NWEndpointClass NWEndpointClass) EndpointWithCEndpoint(cEndpoint objectivec.IObject) objectivec.IObject {
	rv := objc.SendIfResponds[objc.ID](objc.ID(_NWEndpointClass.class), objc.Sel("endpointWithCEndpoint:"), cEndpoint)
	return objectivec.Object{ID: rv}
}
func (_NWEndpointClass NWEndpointClass) EndpointWithInternalEndpoint(endpoint objectivec.IObject) objectivec.IObject {
	rv := objc.SendIfResponds[objc.ID](objc.ID(_NWEndpointClass.class), objc.Sel("endpointWithInternalEndpoint:"), endpoint)
	return objectivec.Object{ID: rv}
}
func (_NWEndpointClass NWEndpointClass) EndpointWithProtocolBufferData(data objectivec.IObject) objectivec.IObject {
	rv := objc.SendIfResponds[objc.ID](objc.ID(_NWEndpointClass.class), objc.Sel("endpointWithProtocolBufferData:"), data)
	return objectivec.Object{ID: rv}
}
func (_NWEndpointClass NWEndpointClass) SupportsResolverCallback() bool {
	rv := objc.SendIfResponds[bool](objc.ID(_NWEndpointClass.class), objc.Sel("supportsResolverCallback"))
	return rv
}
func (_NWEndpointClass NWEndpointClass) SupportsSecureCoding() bool {
	rv := objc.SendIfResponds[bool](objc.ID(_NWEndpointClass.class), objc.Sel("supportsSecureCoding"))
	return rv
}

func (n NWEndpoint) AlternatePort() uint16 {
	rv := objc.SendIfResponds[uint16](n.ID, objc.Sel("alternatePort"))
	return rv
}
func (n NWEndpoint) SetAlternatePort(value uint16) {
	objc.SendIfResponds[struct{}](n.ID, objc.Sel("setAlternatePort:"), value)
}
...
func (n NWEndpoint) SetInterface(value INWInterface) {
	objc.SendIfResponds[struct{}](n.ID, objc.Sel("setInterface:"), value)
}
func (n NWEndpoint) InternalEndpoint() objectivec.Object {
	rv := objc.SendIfResponds[objc.ID](n.ID, objc.Sel("internalEndpoint"))
	return objectivec.ObjectFromID(objc.ID(rv))
}
func (n NWEndpoint) SetInternalEndpoint(value objectivec.Object) {
	objc.SendIfResponds[struct{}](n.ID, objc.Sel("setInternalEndpoint:"), value)
}
func (n NWEndpoint) ParentEndpointDomain() string {
	rv := objc.SendIfResponds[objc.ID](n.ID, objc.Sel("parentEndpointDomain"))
...
func (n NWEndpoint) RemoteInterfaceType() int64 {
	rv := objc.SendIfResponds[int64](n.ID, objc.Sel("remoteInterfaceType"))
	return rv
}
