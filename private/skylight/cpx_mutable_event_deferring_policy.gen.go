...
func (cc CPXMutableEventDeferringPolicyClass) Alloc() CPXMutableEventDeferringPolicy {
	rv := objc.SendIfResponds[CPXMutableEventDeferringPolicy](objc.ID(cc.class), objc.Sel("alloc"))
	return rv
}
...
func (c CPXMutableEventDeferringPolicy) Init() CPXMutableEventDeferringPolicy {
	rv := objc.SendIfResponds[CPXMutableEventDeferringPolicy](c.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (c CPXMutableEventDeferringPolicy) Autorelease() CPXMutableEventDeferringPolicy {
	rv := objc.SendIfResponds[CPXMutableEventDeferringPolicy](c.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewCPXMutableEventDeferringPolicy() CPXMutableEventDeferringPolicy {
	...
	rv := objc.SendIfResponds[CPXMutableEventDeferringPolicy](objc.ID(class.class), objc.Sel("new"))
	return rv
}
