...
func (sc SLContentStreamUpdateClass) Alloc() SLContentStreamUpdate {
	rv := objc.SendIfResponds[SLContentStreamUpdate](objc.ID(sc.class), objc.Sel("alloc"))
	return rv
}
...
func (s SLContentStreamUpdate) Init() SLContentStreamUpdate {
	rv := objc.SendIfResponds[SLContentStreamUpdate](s.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (s SLContentStreamUpdate) Autorelease() SLContentStreamUpdate {
	rv := objc.SendIfResponds[SLContentStreamUpdate](s.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewSLContentStreamUpdate() SLContentStreamUpdate {
	...
	rv := objc.SendIfResponds[SLContentStreamUpdate](objc.ID(class.class), objc.Sel("new"))
	return rv
}
...
func (s SLContentStreamUpdate) BoundingRect() corefoundation.CGRect {
	rv := objc.SendIfResponds[corefoundation.CGRect](s.ID, objc.Sel("boundingRect"))
	return corefoundation.CGRect(rv)
}
func (s SLContentStreamUpdate) ContentRect() corefoundation.CGRect {
	rv := objc.SendIfResponds[corefoundation.CGRect](s.ID, objc.Sel("contentRect"))
	return corefoundation.CGRect(rv)
}
func (s SLContentStreamUpdate) ContentScale() float64 {
	rv := objc.SendIfResponds[float64](s.ID, objc.Sel("contentScale"))
	return rv
}
func (s SLContentStreamUpdate) CornerRadius() float64 {
	rv := objc.SendIfResponds[float64](s.ID, objc.Sel("cornerRadius"))
	return rv
}
func (s SLContentStreamUpdate) DirtyRects() foundation.INSArray {
	rv := objc.SendIfResponds[objc.ID](s.ID, objc.Sel("dirtyRects"))
	return foundation.NSArrayFromID(objc.ID(rv))
}
func (s SLContentStreamUpdate) DisplayResolution() float64 {
	rv := objc.SendIfResponds[float64](s.ID, objc.Sel("displayResolution"))
	return rv
}
func (s SLContentStreamUpdate) DisplayTime() uint64 {
	rv := objc.SendIfResponds[uint64](s.ID, objc.Sel("displayTime"))
	return rv
}
func (s SLContentStreamUpdate) DropCount() uint64 {
	rv := objc.SendIfResponds[uint64](s.ID, objc.Sel("dropCount"))
	return rv
}
...
func (s SLContentStreamUpdate) SetMetaData(value foundation.INSDictionary) {
	objc.SendIfResponds[struct{}](s.ID, objc.Sel("setMetaData:"), value)
}
...
func (s SLContentStreamUpdate) UpdateRef() coregraphics.CGDisplayStreamUpdateRef {
	rv := objc.SendIfResponds[coregraphics.CGDisplayStreamUpdateRef](s.ID, objc.Sel("updateRef"))
...
func (s SLContentStreamUpdate) SetUpdateRef(value coregraphics.CGDisplayStreamUpdateRef) {
	objc.SendIfResponds[struct{}](s.ID, objc.Sel("setUpdateRef:"), value)
}
