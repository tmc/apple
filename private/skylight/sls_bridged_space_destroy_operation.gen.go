...
func (sc SLSBridgedSpaceDestroyOperationClass) Alloc() SLSBridgedSpaceDestroyOperation {
	rv := objc.SendIfResponds[SLSBridgedSpaceDestroyOperation](objc.ID(sc.class), objc.Sel("alloc"))
	return rv
}
...
func (s SLSBridgedSpaceDestroyOperation) Init() SLSBridgedSpaceDestroyOperation {
	rv := objc.SendIfResponds[SLSBridgedSpaceDestroyOperation](s.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (s SLSBridgedSpaceDestroyOperation) Autorelease() SLSBridgedSpaceDestroyOperation {
	rv := objc.SendIfResponds[SLSBridgedSpaceDestroyOperation](s.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewSLSBridgedSpaceDestroyOperation() SLSBridgedSpaceDestroyOperation {
	...
	rv := objc.SendIfResponds[SLSBridgedSpaceDestroyOperation](objc.ID(class.class), objc.Sel("new"))
	return rv
}
...
func (s SLSBridgedSpaceDestroyOperation) InitWithSpaceID(id uint64) SLSBridgedSpaceDestroyOperation {
	rv := objc.SendIfResponds[SLSBridgedSpaceDestroyOperation](s.ID, objc.Sel("initWithSpaceID:"), id)
	return rv
}
