...
func (sc SLSDisplayManagerClass) Alloc() SLSDisplayManager {
	rv := objc.SendIfResponds[SLSDisplayManager](objc.ID(sc.class), objc.Sel("alloc"))
	return rv
}
...
func (s SLSDisplayManager) Init() SLSDisplayManager {
	rv := objc.SendIfResponds[SLSDisplayManager](s.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (s SLSDisplayManager) Autorelease() SLSDisplayManager {
	rv := objc.SendIfResponds[SLSDisplayManager](s.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewSLSDisplayManager() SLSDisplayManager {
	...
	rv := objc.SendIfResponds[SLSDisplayManager](objc.ID(class.class), objc.Sel("new"))
	return rv
}

func NewSLSDisplayManagerWith(with []objectivec.IObject) SLSDisplayManager {
	instance := getSLSDisplayManagerClass().Alloc()
	rv := objc.SendIfResponds[objc.ID](instance.ID, objc.Sel("initWith:"), objectivec.IObjectSliceToNSArray(with))
...
func (s SLSDisplayManager) DeliverPowerStateNotificationPayload(notification byte, payload objectivec.IObject) {
	objc.SendIfResponds[objc.ID](s.ID, objc.Sel("deliverPowerStateNotification:payload:"), notification, payload)
}
func (s SLSDisplayManager) DispatchPowerStateNotificationPayload(notification byte, payload objectivec.IObject) {
	objc.SendIfResponds[objc.ID](s.ID, objc.Sel("dispatchPowerStateNotification:payload:"), notification, payload)
}
func (s SLSDisplayManager) IdleDisplays(displays []objectivec.IObject) bool {
	rv := objc.SendIfResponds[bool](s.ID, objc.Sel("idleDisplays:"), objectivec.IObjectSliceToNSArray(displays))
	return rv
}
func (s SLSDisplayManager) RegisterPowerStateNotificationRegistrationIDSendInitialStateQueueRefconNotificationOptionNotificationBlockNotificationPayloadBlock(notification []objectivec.IObject, id objectivec.IObject, state bool, queue objectivec.IObject, refcon uintptr, option uint32, block VoidHandler, block2 VoidHandler) bool {
	...
	rv := objc.SendIfResponds[bool](s.ID, objc.Sel("registerPowerStateNotification:registrationID:sendInitialState:queue:refcon:notificationOption:notificationBlock:notificationPayloadBlock:"), notification, id, state, queue, refcon, option, _block6, _block7)
	return rv
}
func (s SLSDisplayManager) UnregisterPowerStateNotificationRegistrationIDNotificationOption(notification []objectivec.IObject, id objectivec.IObject, option uint32) bool {
	rv := objc.SendIfResponds[bool](s.ID, objc.Sel("unregisterPowerStateNotification:registrationID:notificationOption:"), objectivec.IObjectSliceToNSArray(notification), id, option)
	return rv
}
func (s SLSDisplayManager) InitWith(with []objectivec.IObject) SLSDisplayManager {
	rv := objc.SendIfResponds[SLSDisplayManager](s.ID, objc.Sel("initWith:"), objectivec.IObjectSliceToNSArray(with))
	return rv
}
...
func (_SLSDisplayManagerClass SLSDisplayManagerClass) BroadcastPowerStateChangeEventPayload(event byte, payload objectivec.IObject) {
	objc.SendIfResponds[objc.ID](objc.ID(_SLSDisplayManagerClass.class), objc.Sel("broadcastPowerStateChangeEvent:payload:"), event, payload)
}

func (s SLSDisplayManager) Client() ISLSGUIClient {
	rv := objc.SendIfResponds[objc.ID](s.ID, objc.Sel("client"))
	return SLSGUIClientFromID(objc.ID(rv))
}
func (s SLSDisplayManager) SetClient(value ISLSGUIClient) {
	objc.SendIfResponds[struct{}](s.ID, objc.Sel("setClient:"), value)
}
...
func (s SLSDisplayManager) LastPowerStateNotification() byte {
	rv := objc.SendIfResponds[byte](s.ID, objc.Sel("lastPowerStateNotification"))
	return rv
}
func (s SLSDisplayManager) SetLastPowerStateNotification(value byte) {
	objc.SendIfResponds[struct{}](s.ID, objc.Sel("setLastPowerStateNotification:"), value)
}
func (s SLSDisplayManager) RegisteredNotifiers() unsafe.Pointer {
	rv := objc.SendIfResponds[unsafe.Pointer](s.ID, objc.Sel("registeredNotifiers"))
	return rv
}
func (s SLSDisplayManager) SetRegisteredNotifiers(value unsafe.Pointer) {
	objc.SendIfResponds[struct{}](s.ID, objc.Sel("setRegisteredNotifiers:"), value)
}
func (s SLSDisplayManager) RunningInServer() bool {
	rv := objc.SendIfResponds[bool](s.ID, objc.Sel("runningInServer"))
	return rv
}
func (s SLSDisplayManager) SetRunningInServer(value bool) {
	objc.SendIfResponds[struct{}](s.ID, objc.Sel("setRunningInServer:"), value)
}
