...
func (sc SLSDisplayWallClass) Alloc() SLSDisplayWall {
	rv := objc.SendIfResponds[SLSDisplayWall](objc.ID(sc.class), objc.Sel("alloc"))
	return rv
}
...
func (s SLSDisplayWall) Init() SLSDisplayWall {
	rv := objc.SendIfResponds[SLSDisplayWall](s.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (s SLSDisplayWall) Autorelease() SLSDisplayWall {
	rv := objc.SendIfResponds[SLSDisplayWall](s.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewSLSDisplayWall() SLSDisplayWall {
	...
	rv := objc.SendIfResponds[SLSDisplayWall](objc.ID(class.class), objc.Sel("new"))
	return rv
}
...
func (_SLSDisplayWallClass SLSDisplayWallClass) IsDisplayWall(wall objectivec.IObject) bool {
	rv := objc.SendIfResponds[bool](objc.ID(_SLSDisplayWallClass.class), objc.Sel("isDisplayWall:"), wall)
	return rv
}
func (_SLSDisplayWallClass SLSDisplayWallClass) ValidateDisplayWallConfiguration(configuration objectivec.IObject) bool {
	rv := objc.SendIfResponds[bool](objc.ID(_SLSDisplayWallClass.class), objc.Sel("validateDisplayWallConfiguration:"), configuration)
	return rv
}
