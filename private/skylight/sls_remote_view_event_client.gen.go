...
func (sc SLSRemoteViewEventClientClass) Alloc() SLSRemoteViewEventClient {
	rv := objc.SendIfResponds[SLSRemoteViewEventClient](objc.ID(sc.class), objc.Sel("alloc"))
	return rv
}
...
type ISLSRemoteViewEventClient interface {
	...
	DeferringEnvironmentFromEvent(event *CGEvent) objectivec.IObject
	DeferringTokenFromEvent(event *CGEvent) objectivec.IObject
	Delegate() unsafe.Pointer
	SetDelegate(value unsafe.Pointer)
	Invalidate()
	SendEventToHostFullDispatchReply(host objectivec.IObject, dispatch objectivec.IObject, reply VoidHandler)
	ServicePassEventUpstreamToHostFullDispatchReply(host *CGEvent, dispatch bool, reply VoidHandler)
	SetDeferringTokenAndEnvironmentInEvent(token objectivec.IObject, environment objectivec.IObject, event *CGEvent)
...
func (s SLSRemoteViewEventClient) Init() SLSRemoteViewEventClient {
	rv := objc.SendIfResponds[SLSRemoteViewEventClient](s.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (s SLSRemoteViewEventClient) Autorelease() SLSRemoteViewEventClient {
	rv := objc.SendIfResponds[SLSRemoteViewEventClient](s.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewSLSRemoteViewEventClient() SLSRemoteViewEventClient {
	...
	rv := objc.SendIfResponds[SLSRemoteViewEventClient](objc.ID(class.class), objc.Sel("new"))
	return rv
}
...
func (s SLSRemoteViewEventClient) ActivateWithHandlerInvalidationHandler(handler VoidHandler, handler2 VoidHandler) {
	...
	objc.SendIfResponds[objc.ID](s.ID, objc.Sel("activateWithHandler:invalidationHandler:"), _block0, _block1)
}
func (s SLSRemoteViewEventClient) DeferringEnvironmentFromEvent(event *CGEvent) objectivec.IObject {
	rv := objc.SendIfResponds[objc.ID](s.ID, objc.Sel("deferringEnvironmentFromEvent:"), event)
	return objectivec.Object{ID: rv}
}
func (s SLSRemoteViewEventClient) DeferringTokenFromEvent(event *CGEvent) objectivec.IObject {
	rv := objc.SendIfResponds[objc.ID](s.ID, objc.Sel("deferringTokenFromEvent:"), event)
	return objectivec.Object{ID: rv}
}
...
func (s SLSRemoteViewEventClient) SendEventToHostFullDispatchReply(host objectivec.IObject, dispatch objectivec.IObject, reply VoidHandler) {
	...
	objc.SendIfResponds[objc.ID](s.ID, objc.Sel("sendEventToHost:fullDispatch:reply:"), host, dispatch, _block2)
}
func (s SLSRemoteViewEventClient) ServicePassEventUpstreamToHostFullDispatchReply(host *CGEvent, dispatch bool, reply VoidHandler) {
	_block2, _ := NewVoidBlock(reply)
	objc.SendIfResponds[objc.ID](s.ID, objc.Sel("servicePassEventUpstreamToHost:fullDispatch:reply:"), host, dispatch, _block2)
}
func (s SLSRemoteViewEventClient) SetDeferringTokenAndEnvironmentInEvent(token objectivec.IObject, environment objectivec.IObject, event *CGEvent) {
	objc.SendIfResponds[objc.ID](s.ID, objc.Sel("setDeferringToken:andEnvironment:inEvent:"), token, environment, event)
}
func (s SLSRemoteViewEventClient) InitWithConfig(config objectivec.IObject) SLSRemoteViewEventClient {
	rv := objc.SendIfResponds[SLSRemoteViewEventClient](s.ID, objc.Sel("initWithConfig:"), config)
	return rv
}
...
func (_SLSRemoteViewEventClientClass SLSRemoteViewEventClientClass) PossibleEventDescriptorForVirtualKeyCode(code uint32) objectivec.IObject {
	rv := objc.SendIfResponds[objc.ID](objc.ID(_SLSRemoteViewEventClientClass.class), objc.Sel("possibleEventDescriptorForVirtualKeyCode:"), code)
	return objectivec.Object{ID: rv}
}
func (_SLSRemoteViewEventClientClass SLSRemoteViewEventClientClass) SharedInstance() SLSRemoteViewEventClient {
	rv := objc.SendIfResponds[objc.ID](objc.ID(_SLSRemoteViewEventClientClass.class), objc.Sel("sharedInstance"))
	return SLSRemoteViewEventClientFromID(rv)
}
...
// It blocks until the completion handler fires or the context is cancelled.
func (s SLSRemoteViewEventClient) ServicePassEventUpstreamToHostFullDispatchReplySync(ctx context.Context, host *CGEvent, dispatch bool) error {
	done := make(chan struct{}, 1)
