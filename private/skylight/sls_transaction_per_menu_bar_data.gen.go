...
func (sc SLSTransactionPerMenuBarDataClass) Alloc() SLSTransactionPerMenuBarData {
	rv := objc.SendIfResponds[SLSTransactionPerMenuBarData](objc.ID(sc.class), objc.Sel("alloc"))
	return rv
}
...
func (s SLSTransactionPerMenuBarData) Init() SLSTransactionPerMenuBarData {
	rv := objc.SendIfResponds[SLSTransactionPerMenuBarData](s.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (s SLSTransactionPerMenuBarData) Autorelease() SLSTransactionPerMenuBarData {
	rv := objc.SendIfResponds[SLSTransactionPerMenuBarData](s.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewSLSTransactionPerMenuBarData() SLSTransactionPerMenuBarData {
	...
	rv := objc.SendIfResponds[SLSTransactionPerMenuBarData](objc.ID(class.class), objc.Sel("new"))
	return rv
}
