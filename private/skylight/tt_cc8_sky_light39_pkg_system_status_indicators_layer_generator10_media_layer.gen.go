...
func (mc MediaLayerClass) Alloc() MediaLayer {
	rv := objc.Send[MediaLayer](objc.ID(mc.class), objc.Sel("alloc"))
	return rv
}
...
func (m MediaLayer) Init() MediaLayer {
	rv := objc.Send[MediaLayer](m.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (m MediaLayer) Autorelease() MediaLayer {
	rv := objc.Send[MediaLayer](m.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewMediaLayer() MediaLayer {
	...
	rv := objc.Send[MediaLayer](objc.ID(class.class), objc.Sel("new"))
	return rv
}
