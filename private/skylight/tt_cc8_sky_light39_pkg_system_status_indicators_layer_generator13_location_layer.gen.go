...
func (lc LocationLayerClass) Alloc() LocationLayer {
	rv := objc.Send[LocationLayer](objc.ID(lc.class), objc.Sel("alloc"))
	return rv
}
...
func (l LocationLayer) Init() LocationLayer {
	rv := objc.Send[LocationLayer](l.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (l LocationLayer) Autorelease() LocationLayer {
	rv := objc.Send[LocationLayer](l.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewLocationLayer() LocationLayer {
	...
	rv := objc.Send[LocationLayer](objc.ID(class.class), objc.Sel("new"))
	return rv
}
