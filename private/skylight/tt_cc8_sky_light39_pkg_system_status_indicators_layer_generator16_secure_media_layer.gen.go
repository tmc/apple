...
func (sc SecureMediaLayerClass) Alloc() SecureMediaLayer {
	rv := objc.SendIfResponds[SecureMediaLayer](objc.ID(sc.class), objc.Sel("alloc"))
	return rv
}
...
func (s SecureMediaLayer) Init() SecureMediaLayer {
	rv := objc.SendIfResponds[SecureMediaLayer](s.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (s SecureMediaLayer) Autorelease() SecureMediaLayer {
	rv := objc.SendIfResponds[SecureMediaLayer](s.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewSecureMediaLayer() SecureMediaLayer {
	...
	rv := objc.SendIfResponds[SecureMediaLayer](objc.ID(class.class), objc.Sel("new"))
	return rv
}
