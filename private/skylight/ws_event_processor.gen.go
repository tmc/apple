...
func (w WSEventProcessor) AnnotateAnnotationParams(annotate *SLSEventRecord, params objectivec.IObject) int32 {
	rv := objc.SendIfResponds[int32](w.ID, objc.Sel("annotate:annotationParams:"), unsafe.Pointer(annotate), params)
	return rv
}
func (w WSEventProcessor) Annotate_internalAnnotationParamsWindowConnEventRegionIDIsCapturedDefaultWindowOverrideCaptureCid(annotate_internal *SLSEventRecord, params objectivec.IObject, conn uint32, id *uint64, captured bool, window bool, cid *bool) int32 {
