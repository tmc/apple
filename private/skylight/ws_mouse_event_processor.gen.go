...
func (wc WSMouseEventProcessorClass) Alloc() WSMouseEventProcessor {
	rv := objc.SendIfResponds[WSMouseEventProcessor](objc.ID(wc.class), objc.Sel("alloc"))
	return rv
}
...
func (w WSMouseEventProcessor) Init() WSMouseEventProcessor {
	rv := objc.SendIfResponds[WSMouseEventProcessor](w.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (w WSMouseEventProcessor) Autorelease() WSMouseEventProcessor {
	rv := objc.SendIfResponds[WSMouseEventProcessor](w.ID, objc.Sel("autorelease"))
	return rv
}
