...
func (wc WSTouchBarEventProcessorClass) Alloc() WSTouchBarEventProcessor {
	rv := objc.SendIfResponds[WSTouchBarEventProcessor](objc.ID(wc.class), objc.Sel("alloc"))
	return rv
}
...
func (w WSTouchBarEventProcessor) Init() WSTouchBarEventProcessor {
	rv := objc.SendIfResponds[WSTouchBarEventProcessor](w.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (w WSTouchBarEventProcessor) Autorelease() WSTouchBarEventProcessor {
	rv := objc.SendIfResponds[WSTouchBarEventProcessor](w.ID, objc.Sel("autorelease"))
	return rv
}
