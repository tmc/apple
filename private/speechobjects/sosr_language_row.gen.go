...
func (sc SOSRLanguageRowClass) Alloc() SOSRLanguageRow {
	rv := objc.SendIfResponds[SOSRLanguageRow](objc.ID(sc.class), objc.Sel("alloc"))
	return rv
}
...
func (s SOSRLanguageRow) Init() SOSRLanguageRow {
	rv := objc.SendIfResponds[SOSRLanguageRow](s.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (s SOSRLanguageRow) Autorelease() SOSRLanguageRow {
	rv := objc.SendIfResponds[SOSRLanguageRow](s.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewSOSRLanguageRow() SOSRLanguageRow {
	...
	rv := objc.SendIfResponds[SOSRLanguageRow](objc.ID(class.class), objc.Sel("new"))
	return rv
}
...
func NewSOSRLanguageRowWithTitleSrLanguageItem(title objectivec.IObject, item objectivec.IObject) SOSRLanguageRow {
	...
	rv := objc.SendIfResponds[objc.ID](instance.ID, objc.Sel("initWithTitle:srLanguageItem:"), title, item)
	return SOSRLanguageRowFromID(rv)
}

func (s SOSRLanguageRow) IsGroupRow() bool {
	rv := objc.SendIfResponds[bool](s.ID, objc.Sel("isGroupRow"))
	return rv
}
func (s SOSRLanguageRow) IsSelected() bool {
	rv := objc.SendIfResponds[bool](s.ID, objc.Sel("isSelected"))
	return rv
}
func (s SOSRLanguageRow) SetSelectedUsingLanguageCodeOnlyToSelectItems(items bool) {
	objc.SendIfResponds[objc.ID](s.ID, objc.Sel("setSelectedUsingLanguageCodeOnlyToSelectItems:"), items)
}
func (s SOSRLanguageRow) InitWithTitleSrLanguageItem(title objectivec.IObject, item objectivec.IObject) SOSRLanguageRow {
	rv := objc.SendIfResponds[SOSRLanguageRow](s.ID, objc.Sel("initWithTitle:srLanguageItem:"), title, item)
	return rv
}
...
func (_SOSRLanguageRowClass SOSRLanguageRowClass) ArrangedRowsFromSRLanguageItemsGroupCountriesUseLanguageCodeOnlyToSelectItemsShowCurrentLocaleAtTop(items objectivec.IObject, countries bool, items2 bool, top bool) objectivec.IObject {
	rv := objc.SendIfResponds[objc.ID](objc.ID(_SOSRLanguageRowClass.class), objc.Sel("arrangedRowsFromSRLanguageItems:groupCountries:useLanguageCodeOnlyToSelectItems:showCurrentLocaleAtTop:"), items, countries, items2, top)
	return objectivec.Object{ID: rv}
}

func (s SOSRLanguageRow) GroupRow() bool {
	rv := objc.SendIfResponds[bool](s.ID, objc.Sel("groupRow"))
	return rv
}
func (s SOSRLanguageRow) SetGroupRow(value bool) {
	objc.SendIfResponds[struct{}](s.ID, objc.Sel("setGroupRow:"), value)
}
func (s SOSRLanguageRow) Selected() bool {
	rv := objc.SendIfResponds[bool](s.ID, objc.Sel("selected"))
	return rv
}
func (s SOSRLanguageRow) SetSelected(value bool) {
	objc.SendIfResponds[struct{}](s.ID, objc.Sel("setSelected:"), value)
}
func (s SOSRLanguageRow) SrLanguageItem() ISOSRLanguageItem {
	rv := objc.SendIfResponds[objc.ID](s.ID, objc.Sel("srLanguageItem"))
	return SOSRLanguageItemFromID(objc.ID(rv))
}
func (s SOSRLanguageRow) TableIndex() uint64 {
	rv := objc.SendIfResponds[uint64](s.ID, objc.Sel("tableIndex"))
	return rv
}
func (s SOSRLanguageRow) SetTableIndex(value uint64) {
	objc.SendIfResponds[struct{}](s.ID, objc.Sel("setTableIndex:"), value)
}
