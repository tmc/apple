...
func (ac AVSpeechSynthesisProviderAudioUnitClass) Alloc() AVSpeechSynthesisProviderAudioUnit {
	rv := objc.SendIfResponds[AVSpeechSynthesisProviderAudioUnit](objc.ID(ac.class), objc.Sel("alloc"))
	return rv
}
...
func (a AVSpeechSynthesisProviderAudioUnit) Init() AVSpeechSynthesisProviderAudioUnit {
	rv := objc.SendIfResponds[AVSpeechSynthesisProviderAudioUnit](a.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (a AVSpeechSynthesisProviderAudioUnit) Autorelease() AVSpeechSynthesisProviderAudioUnit {
	rv := objc.SendIfResponds[AVSpeechSynthesisProviderAudioUnit](a.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewAVSpeechSynthesisProviderAudioUnit() AVSpeechSynthesisProviderAudioUnit {
	...
	rv := objc.SendIfResponds[AVSpeechSynthesisProviderAudioUnit](objc.ID(class.class), objc.Sel("new"))
	return rv
}
