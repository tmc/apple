...
// NOTE: TextToSpeechVoiceDatabase struct embeds objectivec.Object (parent type unavailable) but
// ITextToSpeechVoiceDatabase embeds the parent interface; skip compile-time assertion.
