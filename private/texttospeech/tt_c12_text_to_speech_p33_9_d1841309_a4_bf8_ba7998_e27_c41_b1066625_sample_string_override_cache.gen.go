...
func (sc SampleStringOverrideCacheClass) Alloc() SampleStringOverrideCache {
	rv := objc.Send[SampleStringOverrideCache](objc.ID(sc.class), objc.Sel("alloc"))
	return rv
}
...
// NOTE: SampleStringOverrideCache struct embeds objectivec.Object (parent type unavailable) but
// ISampleStringOverrideCache embeds the parent interface; skip compile-time assertion.
...
func (s SampleStringOverrideCache) Init() SampleStringOverrideCache {
	rv := objc.Send[SampleStringOverrideCache](s.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (s SampleStringOverrideCache) Autorelease() SampleStringOverrideCache {
	rv := objc.Send[SampleStringOverrideCache](s.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewSampleStringOverrideCache() SampleStringOverrideCache {
	...
	rv := objc.Send[SampleStringOverrideCache](objc.ID(class.class), objc.Sel("new"))
	return rv
}
