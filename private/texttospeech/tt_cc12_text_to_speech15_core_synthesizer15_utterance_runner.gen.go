...
func (uc UtteranceRunnerClass) Alloc() UtteranceRunner {
	rv := objc.Send[UtteranceRunner](objc.ID(uc.class), objc.Sel("alloc"))
	return rv
}
...
// NOTE: UtteranceRunner struct embeds objectivec.Object (parent type unavailable) but
// IUtteranceRunner embeds the parent interface; skip compile-time assertion.
...
func (u UtteranceRunner) Init() UtteranceRunner {
	rv := objc.Send[UtteranceRunner](u.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (u UtteranceRunner) Autorelease() UtteranceRunner {
	rv := objc.Send[UtteranceRunner](u.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewUtteranceRunner() UtteranceRunner {
	...
	rv := objc.Send[UtteranceRunner](objc.ID(class.class), objc.Sel("new"))
	return rv
}
