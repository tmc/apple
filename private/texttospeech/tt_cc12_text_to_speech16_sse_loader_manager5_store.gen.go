...
func getStoreClass() StoreClass {
	_StoreClassOnce.Do(func() {
		_StoreClass = StoreClass{class: objc.GetClass("_TtCC12TextToSpeech16SSELoaderManager5Store")}
	})
	return _StoreClass
}

// GetStoreClass returns the class object for _TtCC12TextToSpeech16SSELoaderManager5Store.
func GetStoreClass() StoreClass {
