...
func (cc ClientClass) Alloc() Client {
	rv := objc.Send[Client](objc.ID(cc.class), objc.Sel("alloc"))
	return rv
}
...
// NOTE: Client struct embeds objectivec.Object (parent type unavailable) but
// IClient embeds the parent interface; skip compile-time assertion.
...
func (c Client) Init() Client {
	rv := objc.Send[Client](c.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (c Client) Autorelease() Client {
	rv := objc.Send[Client](c.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewClient() Client {
	...
	rv := objc.Send[Client](objc.ID(class.class), objc.Sel("new"))
	return rv
}
