...
func (sc ServerClass) Alloc() Server {
	rv := objc.SendIfResponds[Server](objc.ID(sc.class), objc.Sel("alloc"))
	return rv
}
...
// Ensure Server implements IServer.
...
func (s Server) Init() Server {
	rv := objc.SendIfResponds[Server](s.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (s Server) Autorelease() Server {
	rv := objc.SendIfResponds[Server](s.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewServer() Server {
	...
	rv := objc.SendIfResponds[Server](objc.ID(class.class), objc.Sel("new"))
	return rv
}
