...
func (rc RequestHandlerClass) Alloc() RequestHandler {
	rv := objc.SendIfResponds[RequestHandler](objc.ID(rc.class), objc.Sel("alloc"))
	return rv
}
...
// Ensure RequestHandler implements IRequestHandler.
var _ IRequestHandler = RequestHandler{}
...
func (r RequestHandler) Init() RequestHandler {
	rv := objc.SendIfResponds[RequestHandler](r.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (r RequestHandler) Autorelease() RequestHandler {
	rv := objc.SendIfResponds[RequestHandler](r.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewRequestHandler() RequestHandler {
	...
	rv := objc.SendIfResponds[RequestHandler](objc.ID(class.class), objc.Sel("new"))
	return rv
}
