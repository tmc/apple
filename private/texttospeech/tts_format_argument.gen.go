...
func (tc TTSFormatArgumentClass) Alloc() TTSFormatArgument {
	rv := objc.SendIfResponds[TTSFormatArgument](objc.ID(tc.class), objc.Sel("alloc"))
	return rv
}
...
func (t TTSFormatArgument) Init() TTSFormatArgument {
	rv := objc.SendIfResponds[TTSFormatArgument](t.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (t TTSFormatArgument) Autorelease() TTSFormatArgument {
	rv := objc.SendIfResponds[TTSFormatArgument](t.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewTTSFormatArgument() TTSFormatArgument {
	...
	rv := objc.SendIfResponds[TTSFormatArgument](objc.ID(class.class), objc.Sel("new"))
	return rv
}
