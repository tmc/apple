...
func (tc TTSRuleGroupClass) Alloc() TTSRuleGroup {
	rv := objc.SendIfResponds[TTSRuleGroup](objc.ID(tc.class), objc.Sel("alloc"))
	return rv
}
...
func (t TTSRuleGroup) Init() TTSRuleGroup {
	rv := objc.SendIfResponds[TTSRuleGroup](t.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (t TTSRuleGroup) Autorelease() TTSRuleGroup {
	rv := objc.SendIfResponds[TTSRuleGroup](t.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewTTSRuleGroup() TTSRuleGroup {
	...
	rv := objc.SendIfResponds[TTSRuleGroup](objc.ID(class.class), objc.Sel("new"))
	return rv
}

func (t TTSRuleGroup) EndIndex() uint64 {
	rv := objc.SendIfResponds[uint64](t.ID, objc.Sel("endIndex"))
	return rv
}
func (t TTSRuleGroup) SetEndIndex(value uint64) {
	objc.SendIfResponds[struct{}](t.ID, objc.Sel("setEndIndex:"), value)
}
func (t TTSRuleGroup) Key() string {
	rv := objc.SendIfResponds[objc.ID](t.ID, objc.Sel("key"))
	return foundation.NSStringFromID(rv).String()
}
func (t TTSRuleGroup) SetKey(value string) {
	objc.SendIfResponds[struct{}](t.ID, objc.Sel("setKey:"), objc.String(value))
}
func (t TTSRuleGroup) StartIndex() uint64 {
	rv := objc.SendIfResponds[uint64](t.ID, objc.Sel("startIndex"))
	return rv
}
func (t TTSRuleGroup) SetStartIndex(value uint64) {
	objc.SendIfResponds[struct{}](t.ID, objc.Sel("setStartIndex:"), value)
}
