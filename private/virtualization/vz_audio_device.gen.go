...
func (vc VZAudioDeviceClass) Alloc() VZAudioDevice {
	rv := objc.SendIfResponds[VZAudioDevice](objc.ID(vc.class), objc.Sel("alloc"))
	return rv
}
...
func (v VZAudioDevice) Init() VZAudioDevice {
	rv := objc.SendIfResponds[VZAudioDevice](v.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (v VZAudioDevice) Autorelease() VZAudioDevice {
	rv := objc.SendIfResponds[VZAudioDevice](v.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewVZAudioDevice() VZAudioDevice {
	...
	rv := objc.SendIfResponds[VZAudioDevice](objc.ID(class.class), objc.Sel("new"))
	return rv
}

func (v VZAudioDevice) _initWithVirtualMachineAudioDeviceIndex(machine objectivec.IObject, index uint64) objectivec.IObject {
	rv := objc.SendIfResponds[objc.ID](v.ID, objc.Sel("_initWithVirtualMachine:audioDeviceIndex:"), machine, index)
