...
func (vc VZAudioInputStreamSourceClass) Alloc() VZAudioInputStreamSource {
	rv := objc.SendIfResponds[VZAudioInputStreamSource](objc.ID(vc.class), objc.Sel("alloc"))
	return rv
}
...
func (v VZAudioInputStreamSource) Init() VZAudioInputStreamSource {
	rv := objc.SendIfResponds[VZAudioInputStreamSource](v.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (v VZAudioInputStreamSource) Autorelease() VZAudioInputStreamSource {
	rv := objc.SendIfResponds[VZAudioInputStreamSource](v.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewVZAudioInputStreamSource() VZAudioInputStreamSource {
	...
	rv := objc.SendIfResponds[VZAudioInputStreamSource](objc.ID(class.class), objc.Sel("new"))
	return rv
}
