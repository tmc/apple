...
func (vc VZCapsLockIndicatorControllerClass) Alloc() VZCapsLockIndicatorController {
	rv := objc.SendIfResponds[VZCapsLockIndicatorController](objc.ID(vc.class), objc.Sel("alloc"))
	return rv
}
...
func (v VZCapsLockIndicatorController) Init() VZCapsLockIndicatorController {
	rv := objc.SendIfResponds[VZCapsLockIndicatorController](v.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (v VZCapsLockIndicatorController) Autorelease() VZCapsLockIndicatorController {
	rv := objc.SendIfResponds[VZCapsLockIndicatorController](v.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewVZCapsLockIndicatorController() VZCapsLockIndicatorController {
	...
	rv := objc.SendIfResponds[VZCapsLockIndicatorController](objc.ID(class.class), objc.Sel("new"))
	return rv
}
