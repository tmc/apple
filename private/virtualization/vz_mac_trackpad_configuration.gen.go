...
func (vc VZMacTrackpadConfigurationClass) Alloc() VZMacTrackpadConfiguration {
	rv := objc.SendIfResponds[VZMacTrackpadConfiguration](objc.ID(vc.class), objc.Sel("alloc"))
	return rv
}
...
func (v VZMacTrackpadConfiguration) Init() VZMacTrackpadConfiguration {
	rv := objc.SendIfResponds[VZMacTrackpadConfiguration](v.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (v VZMacTrackpadConfiguration) Autorelease() VZMacTrackpadConfiguration {
	rv := objc.SendIfResponds[VZMacTrackpadConfiguration](v.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewVZMacTrackpadConfiguration() VZMacTrackpadConfiguration {
	...
	rv := objc.SendIfResponds[VZMacTrackpadConfiguration](objc.ID(class.class), objc.Sel("new"))
	return rv
}
