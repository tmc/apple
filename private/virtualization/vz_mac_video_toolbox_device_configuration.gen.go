...
func (vc VZMacVideoToolboxDeviceConfigurationClass) Alloc() VZMacVideoToolboxDeviceConfiguration {
	rv := objc.SendIfResponds[VZMacVideoToolboxDeviceConfiguration](objc.ID(vc.class), objc.Sel("alloc"))
	return rv
}
...
func (v VZMacVideoToolboxDeviceConfiguration) Init() VZMacVideoToolboxDeviceConfiguration {
	rv := objc.SendIfResponds[VZMacVideoToolboxDeviceConfiguration](v.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (v VZMacVideoToolboxDeviceConfiguration) Autorelease() VZMacVideoToolboxDeviceConfiguration {
	rv := objc.SendIfResponds[VZMacVideoToolboxDeviceConfiguration](v.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewVZMacVideoToolboxDeviceConfiguration() VZMacVideoToolboxDeviceConfiguration {
	...
	rv := objc.SendIfResponds[VZMacVideoToolboxDeviceConfiguration](objc.ID(class.class), objc.Sel("new"))
	return rv
}

func (_VZMacVideoToolboxDeviceConfigurationClass VZMacVideoToolboxDeviceConfigurationClass) _isSupported() bool {
	rv := objc.SendIfResponds[bool](objc.ID(_VZMacVideoToolboxDeviceConfigurationClass.class), objc.Sel("_isSupported"))
	return rv
}
