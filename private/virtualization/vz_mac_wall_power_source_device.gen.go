...
func (vc VZMacWallPowerSourceDeviceClass) Alloc() VZMacWallPowerSourceDevice {
	rv := objc.SendIfResponds[VZMacWallPowerSourceDevice](objc.ID(vc.class), objc.Sel("alloc"))
	return rv
}
...
func (v VZMacWallPowerSourceDevice) Init() VZMacWallPowerSourceDevice {
	rv := objc.SendIfResponds[VZMacWallPowerSourceDevice](v.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (v VZMacWallPowerSourceDevice) Autorelease() VZMacWallPowerSourceDevice {
	rv := objc.SendIfResponds[VZMacWallPowerSourceDevice](v.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewVZMacWallPowerSourceDevice() VZMacWallPowerSourceDevice {
	...
	rv := objc.SendIfResponds[VZMacWallPowerSourceDevice](objc.ID(class.class), objc.Sel("new"))
	return rv
}
