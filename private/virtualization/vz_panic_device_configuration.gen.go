...
func (vc VZPanicDeviceConfigurationClass) Alloc() VZPanicDeviceConfiguration {
	rv := objc.SendIfResponds[VZPanicDeviceConfiguration](objc.ID(vc.class), objc.Sel("alloc"))
	return rv
}
...
func (v VZPanicDeviceConfiguration) Init() VZPanicDeviceConfiguration {
	rv := objc.SendIfResponds[VZPanicDeviceConfiguration](v.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (v VZPanicDeviceConfiguration) Autorelease() VZPanicDeviceConfiguration {
	rv := objc.SendIfResponds[VZPanicDeviceConfiguration](v.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewVZPanicDeviceConfiguration() VZPanicDeviceConfiguration {
	...
	rv := objc.SendIfResponds[VZPanicDeviceConfiguration](objc.ID(class.class), objc.Sel("new"))
	return rv
}
