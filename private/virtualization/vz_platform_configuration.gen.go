...
func (vc VZPlatformConfigurationClass) Alloc() VZPlatformConfiguration {
	rv := objc.SendIfResponds[VZPlatformConfiguration](objc.ID(vc.class), objc.Sel("alloc"))
	return rv
}
...
func (v VZPlatformConfiguration) Init() VZPlatformConfiguration {
	rv := objc.SendIfResponds[VZPlatformConfiguration](v.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (v VZPlatformConfiguration) Autorelease() VZPlatformConfiguration {
	rv := objc.SendIfResponds[VZPlatformConfiguration](v.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewVZPlatformConfiguration() VZPlatformConfiguration {
	...
	rv := objc.SendIfResponds[VZPlatformConfiguration](objc.ID(class.class), objc.Sel("new"))
	return rv
}
...
func (v VZPlatformConfiguration) _platform() unsafe.Pointer {
	rv := objc.SendIfResponds[unsafe.Pointer](v.ID, objc.Sel("_platform"))
	return rv
}
