...
func (vc VZTouchClass) Alloc() VZTouch {
	rv := objc.SendIfResponds[VZTouch](objc.ID(vc.class), objc.Sel("alloc"))
	return rv
}
...
func (v VZTouch) Init() VZTouch {
	rv := objc.SendIfResponds[VZTouch](v.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (v VZTouch) Autorelease() VZTouch {
	rv := objc.SendIfResponds[VZTouch](v.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewVZTouch() VZTouch {
	...
	rv := objc.SendIfResponds[VZTouch](objc.ID(class.class), objc.Sel("new"))
	return rv
}
...
func NewVZTouchWithViewIndexPhaseLocationSwipeAimTimestamp(view objectivec.IObject, index byte, phase int64, location corefoundation.CGPoint, aim int64, timestamp float64) VZTouch {
	...
	rv := objc.SendIfResponds[objc.ID](instance.ID, objc.Sel("initWithView:index:phase:location:swipeAim:timestamp:"), view, index, phase, location, aim, timestamp)
...
func (v VZTouch) InitWithViewIndexPhaseLocationSwipeAimTimestamp(view objectivec.IObject, index byte, phase int64, location corefoundation.CGPoint, aim int64, timestamp float64) VZTouch {
	rv := objc.SendIfResponds[VZTouch](v.ID, objc.Sel("initWithView:index:phase:location:swipeAim:timestamp:"), view, index, phase, location, aim, timestamp)
	return rv
}

func (v VZTouch) Index() byte {
	rv := objc.SendIfResponds[byte](v.ID, objc.Sel("index"))
	return rv
}
...
func (v VZTouch) Phase() int64 {
	rv := objc.SendIfResponds[int64](v.ID, objc.Sel("phase"))
	return rv
}
func (v VZTouch) SwipeAim() int64 {
	rv := objc.SendIfResponds[int64](v.ID, objc.Sel("swipeAim"))
	return rv
}
func (v VZTouch) Timestamp() float64 {
	rv := objc.SendIfResponds[float64](v.ID, objc.Sel("timestamp"))
	return rv
}
