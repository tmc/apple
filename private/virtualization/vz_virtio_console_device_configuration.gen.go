...
func (vc VZVirtioConsoleDeviceConfigurationClass) Alloc() VZVirtioConsoleDeviceConfiguration {
	rv := objc.SendIfResponds[VZVirtioConsoleDeviceConfiguration](objc.ID(vc.class), objc.Sel("alloc"))
	return rv
}
...
func (v VZVirtioConsoleDeviceConfiguration) Init() VZVirtioConsoleDeviceConfiguration {
	rv := objc.SendIfResponds[VZVirtioConsoleDeviceConfiguration](v.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (v VZVirtioConsoleDeviceConfiguration) Autorelease() VZVirtioConsoleDeviceConfiguration {
	rv := objc.SendIfResponds[VZVirtioConsoleDeviceConfiguration](v.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewVZVirtioConsoleDeviceConfiguration() VZVirtioConsoleDeviceConfiguration {
	...
	rv := objc.SendIfResponds[VZVirtioConsoleDeviceConfiguration](objc.ID(class.class), objc.Sel("new"))
	return rv
}
