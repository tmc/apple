...
func (vc VZVirtioEntropyDeviceConfigurationClass) Alloc() VZVirtioEntropyDeviceConfiguration {
	rv := objc.SendIfResponds[VZVirtioEntropyDeviceConfiguration](objc.ID(vc.class), objc.Sel("alloc"))
	return rv
}
...
func (v VZVirtioEntropyDeviceConfiguration) Init() VZVirtioEntropyDeviceConfiguration {
	rv := objc.SendIfResponds[VZVirtioEntropyDeviceConfiguration](v.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (v VZVirtioEntropyDeviceConfiguration) Autorelease() VZVirtioEntropyDeviceConfiguration {
	rv := objc.SendIfResponds[VZVirtioEntropyDeviceConfiguration](v.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewVZVirtioEntropyDeviceConfiguration() VZVirtioEntropyDeviceConfiguration {
	...
	rv := objc.SendIfResponds[VZVirtioEntropyDeviceConfiguration](objc.ID(class.class), objc.Sel("new"))
	return rv
}
