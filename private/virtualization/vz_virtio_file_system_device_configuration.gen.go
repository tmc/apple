...
func (vc VZVirtioFileSystemDeviceConfigurationClass) Alloc() VZVirtioFileSystemDeviceConfiguration {
	rv := objc.SendIfResponds[VZVirtioFileSystemDeviceConfiguration](objc.ID(vc.class), objc.Sel("alloc"))
	return rv
}
...
func (v VZVirtioFileSystemDeviceConfiguration) Init() VZVirtioFileSystemDeviceConfiguration {
	rv := objc.SendIfResponds[VZVirtioFileSystemDeviceConfiguration](v.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (v VZVirtioFileSystemDeviceConfiguration) Autorelease() VZVirtioFileSystemDeviceConfiguration {
	rv := objc.SendIfResponds[VZVirtioFileSystemDeviceConfiguration](v.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewVZVirtioFileSystemDeviceConfiguration() VZVirtioFileSystemDeviceConfiguration {
	...
	rv := objc.SendIfResponds[VZVirtioFileSystemDeviceConfiguration](objc.ID(class.class), objc.Sel("new"))
	return rv
}
