...
func (v VZVirtualMachine) _serviceProcessIdentifier() int32 {
	rv := objc.SendIfResponds[int32](v.ID, objc.Sel("_serviceProcessIdentifier"))
	return rv
}
...
func (v VZVirtualMachine) ServiceProcessIdentifier() (int32, error) {
