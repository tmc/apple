...
func (vc VZHIDEventMonitorClass) Alloc() VZHIDEventMonitor {
	rv := objc.SendIfResponds[VZHIDEventMonitor](objc.ID(vc.class), objc.Sel("alloc"))
	return rv
}
...
func (v VZHIDEventMonitor) Init() VZHIDEventMonitor {
	rv := objc.SendIfResponds[VZHIDEventMonitor](v.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (v VZHIDEventMonitor) Autorelease() VZHIDEventMonitor {
	rv := objc.SendIfResponds[VZHIDEventMonitor](v.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewVZHIDEventMonitor() VZHIDEventMonitor {
	...
	rv := objc.SendIfResponds[VZHIDEventMonitor](objc.ID(class.class), objc.Sel("new"))
	return rv
}
