...
func (o GTMioHeatmapObject) GenerateImage(image uint64) CGImage {
	rv := objc.SendIfResponds[CGImage](o.ID, objc.Sel("generateImage:"), image)
	return rv
}
...
func (o GTMioHeatmapObject) ThreadPositionForPixelXPixelYSliceXYZ(x uint64, y uint64, slice uint64, x2 *uint32, y2 *uint32, z *uint32) bool {
	rv := objc.SendIfResponds[bool](o.ID, objc.Sel("threadPositionForPixelX:pixelY:slice:x:y:z:"), x, y, slice, x2, y2, z)
	return rv
}
func (o GTMioHeatmapObject) ThreadRangeForPixelXPixelYSliceMinXMaxXMinYMaxYMinZMaxZ(x uint64, y uint64, slice uint64, x2 *uint32, x3 *uint32, y2 *uint32, y3 *uint32, z *uint32, z2 *uint32) bool {
	rv := objc.SendIfResponds[bool](o.ID, objc.Sel("threadRangeForPixelX:pixelY:slice:minX:maxX:minY:maxY:minZ:maxZ:"), x, y, slice, x2, x3, y2, y3, z, z2)
	return rv
}
