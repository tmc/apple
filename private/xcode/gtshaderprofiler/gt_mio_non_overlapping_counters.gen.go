...
type IGTMioNonOverlappingCounters interface {
	...
	CounterValuesForGPUCommandAtFunctionIndexSubCommandIndex(index uint32, index2 int32) unsafe.Pointer
...
func (g GTMioNonOverlappingCounters) CounterValuesForGPUCommandAtFunctionIndexSubCommandIndex(index uint32, index2 int32) unsafe.Pointer {
