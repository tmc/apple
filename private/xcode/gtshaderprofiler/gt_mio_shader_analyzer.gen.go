...
func (gc GTMioShaderAnalyzerClass) Alloc() GTMioShaderAnalyzer {
	rv := objc.SendIfResponds[GTMioShaderAnalyzer](objc.ID(gc.class), objc.Sel("alloc"))
	return rv
}
...
func (g GTMioShaderAnalyzer) Init() GTMioShaderAnalyzer {
	rv := objc.SendIfResponds[GTMioShaderAnalyzer](g.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (g GTMioShaderAnalyzer) Autorelease() GTMioShaderAnalyzer {
	rv := objc.SendIfResponds[GTMioShaderAnalyzer](g.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewGTMioShaderAnalyzer() GTMioShaderAnalyzer {
	...
	rv := objc.SendIfResponds[GTMioShaderAnalyzer](objc.ID(class.class), objc.Sel("new"))
	return rv
}
...
func NewGTMioShaderAnalyzerWithDrawIndexProgramTypeUseBaseProgramTypeTraceData(index uint32, type_ uint16, type_2 bool, data objectivec.IObject) GTMioShaderAnalyzer {
	...
	rv := objc.SendIfResponds[objc.ID](instance.ID, objc.Sel("initWithDrawIndex:programType:useBaseProgramType:traceData:"), index, type_, type_2, data)
...
func NewGTMioShaderAnalyzerWithEncoderFunctionIndexProgramTypeUseBaseProgramTypeTraceData(index uint32, type_ uint16, type_2 bool, data objectivec.IObject) GTMioShaderAnalyzer {
	instance := getGTMioShaderAnalyzerClass().Alloc()
	rv := objc.SendIfResponds[objc.ID](instance.ID, objc.Sel("initWithEncoderFunctionIndex:programType:useBaseProgramType:traceData:"), index, type_, type_2, data)
	return GTMioShaderAnalyzerFromID(rv)
}
...
func NewGTMioShaderAnalyzerWithPipelineStateIdProgramTypeUseBaseProgramTypeTraceData(id uint64, type_ uint16, type_2 bool, data objectivec.IObject) GTMioShaderAnalyzer {
	instance := getGTMioShaderAnalyzerClass().Alloc()
	rv := objc.SendIfResponds[objc.ID](instance.ID, objc.Sel("initWithPipelineStateId:programType:useBaseProgramType:traceData:"), id, type_, type_2, data)
	return GTMioShaderAnalyzerFromID(rv)
}

func (g GTMioShaderAnalyzer) BuildDrawProgramTypeTraceData(draw uint32, type_ uint16, data objectivec.IObject) bool {
	rv := objc.SendIfResponds[bool](g.ID, objc.Sel("buildDraw:programType:traceData:"), draw, type_, data)
	return rv
}
func (g GTMioShaderAnalyzer) BuildEncoderProgramTypeTraceData(encoder uint32, type_ uint16, data objectivec.IObject) bool {
	rv := objc.SendIfResponds[bool](g.ID, objc.Sel("buildEncoder:programType:traceData:"), encoder, type_, data)
	return rv
}
func (g GTMioShaderAnalyzer) BuildPipelineProgramTypeTraceData(pipeline uint64, type_ uint16, data objectivec.IObject) bool {
	rv := objc.SendIfResponds[bool](g.ID, objc.Sel("buildPipeline:programType:traceData:"), pipeline, type_, data)
	return rv
}
func (g GTMioShaderAnalyzer) FinalizeBuild() {
	objc.SendIfResponds[objc.ID](g.ID, objc.Sel("finalizeBuild"))
}
func (g GTMioShaderAnalyzer) HandleBinary(binary objectivec.IObject) {
	objc.SendIfResponds[objc.ID](g.ID, objc.Sel("handleBinary:"), binary)
}
func (g GTMioShaderAnalyzer) InitWithDrawIndexProgramTypeUseBaseProgramTypeTraceData(index uint32, type_ uint16, type_2 bool, data objectivec.IObject) GTMioShaderAnalyzer {
	rv := objc.SendIfResponds[GTMioShaderAnalyzer](g.ID, objc.Sel("initWithDrawIndex:programType:useBaseProgramType:traceData:"), index, type_, type_2, data)
	return rv
}
func (g GTMioShaderAnalyzer) InitWithEncoderFunctionIndexProgramTypeUseBaseProgramTypeTraceData(index uint32, type_ uint16, type_2 bool, data objectivec.IObject) GTMioShaderAnalyzer {
	rv := objc.SendIfResponds[GTMioShaderAnalyzer](g.ID, objc.Sel("initWithEncoderFunctionIndex:programType:useBaseProgramType:traceData:"), index, type_, type_2, data)
	return rv
}
func (g GTMioShaderAnalyzer) InitWithPipelineStateIdProgramTypeUseBaseProgramTypeTraceData(id uint64, type_ uint16, type_2 bool, data objectivec.IObject) GTMioShaderAnalyzer {
	rv := objc.SendIfResponds[GTMioShaderAnalyzer](g.ID, objc.Sel("initWithPipelineStateId:programType:useBaseProgramType:traceData:"), id, type_, type_2, data)
	return rv
}

func (g GTMioShaderAnalyzer) InstructionDataTypeInfo() unsafe.Pointer {
	rv := objc.SendIfResponds[unsafe.Pointer](g.ID, objc.Sel("instructionDataTypeInfo"))
	return rv
}
func (g GTMioShaderAnalyzer) InstructionMemoryTypeInfo() unsafe.Pointer {
	rv := objc.SendIfResponds[unsafe.Pointer](g.ID, objc.Sel("instructionMemoryTypeInfo"))
	return rv
}
func (g GTMioShaderAnalyzer) InstructionScopeInfo() unsafe.Pointer {
	rv := objc.SendIfResponds[unsafe.Pointer](g.ID, objc.Sel("instructionScopeInfo"))
	return rv
}
func (g GTMioShaderAnalyzer) InstructionTypeInfo() unsafe.Pointer {
	rv := objc.SendIfResponds[unsafe.Pointer](g.ID, objc.Sel("instructionTypeInfo"))
	return rv
}
func (g GTMioShaderAnalyzer) NumInstructionDataTypeInfo() int64 {
	rv := objc.SendIfResponds[int64](g.ID, objc.Sel("numInstructionDataTypeInfo"))
	return rv
}
func (g GTMioShaderAnalyzer) NumInstructionMemoryTypeInfo() int64 {
	rv := objc.SendIfResponds[int64](g.ID, objc.Sel("numInstructionMemoryTypeInfo"))
	return rv
}
func (g GTMioShaderAnalyzer) NumInstructionScopeInfo() int64 {
	rv := objc.SendIfResponds[int64](g.ID, objc.Sel("numInstructionScopeInfo"))
	return rv
}
func (g GTMioShaderAnalyzer) NumInstructionTypeInfo() int64 {
	rv := objc.SendIfResponds[int64](g.ID, objc.Sel("numInstructionTypeInfo"))
	return rv
}
...
func (g GTMioShaderAnalyzer) ScopeIdentifier() uint64 {
	rv := objc.SendIfResponds[uint64](g.ID, objc.Sel("scopeIdentifier"))
	return rv
}
...
func (g GTMioShaderAnalyzer) UseBaseProgramType() bool {
	rv := objc.SendIfResponds[bool](g.ID, objc.Sel("useBaseProgramType"))
	return rv
}
