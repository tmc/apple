...
type IGTMioShaderBinaryData interface {
	...
	ProgramType() uint16
	RegisterCountForInstructionAtIndexType(index uint32, type_ uint32) int32
...
func (g GTMioShaderBinaryData) AllocatedRegisterCount() int32 {
	rv := objc.SendIfResponds[int32](g.ID, objc.Sel("allocatedRegisterCount"))
	return rv
}
...
func (g GTMioShaderBinaryData) CachedISAFileURL() foundation.NSURL {
	rv := objc.SendIfResponds[foundation.NSURL](g.ID, objc.Sel("cachedISAFileURL"))
...
func (g GTMioShaderBinaryData) CostForBinaryRangeScopeScopeIdentifierCostNumInstructions(range_ uint32, scope uint16, identifier uint64, cost *GTMioCostInfo, instructions *uint32) bool {
	rv := objc.SendIfResponds[bool](g.ID, objc.Sel("costForBinaryRange:scope:scopeIdentifier:cost:numInstructions:"), range_, scope, identifier, unsafe.Pointer(cost), instructions)
	return rv
}
func (g GTMioShaderBinaryData) CostForLineFullPathIndexScopeScopeIdentifierCostNumInstructions(line uint32, index uint32, scope uint16, identifier uint64, cost *GTMioCostInfo, instructions *uint32) bool {
	rv := objc.SendIfResponds[bool](g.ID, objc.Sel("costForLine:fullPathIndex:scope:scopeIdentifier:cost:numInstructions:"), line, index, scope, identifier, unsafe.Pointer(cost), instructions)
	return rv
}
...
func (g GTMioShaderBinaryData) RegisterCountForInstructionAtIndexType(index uint32, type_ uint32) int32 {
	rv := objc.SendIfResponds[int32](g.ID, objc.Sel("registerCountForInstructionAtIndex:type:"), index, type_)
	return rv
}
...
func (g GTMioShaderBinaryData) TracesForProgramTypeCount(type_ uint16, count *uint64) *GTMioBinaryTrace {
	rv := objc.SendIfResponds[unsafe.Pointer](g.ID, objc.Sel("tracesForProgramType:count:"), type_, count)
