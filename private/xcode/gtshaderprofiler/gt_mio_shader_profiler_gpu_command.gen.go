...
func (gc GTMioShaderProfilerGPUCommandClass) Alloc() GTMioShaderProfilerGPUCommand {
	rv := objc.SendIfResponds[GTMioShaderProfilerGPUCommand](objc.ID(gc.class), objc.Sel("alloc"))
	return rv
}
...
func (g GTMioShaderProfilerGPUCommand) Init() GTMioShaderProfilerGPUCommand {
	rv := objc.SendIfResponds[GTMioShaderProfilerGPUCommand](g.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (g GTMioShaderProfilerGPUCommand) Autorelease() GTMioShaderProfilerGPUCommand {
	rv := objc.SendIfResponds[GTMioShaderProfilerGPUCommand](g.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewGTMioShaderProfilerGPUCommand() GTMioShaderProfilerGPUCommand {
	...
	rv := objc.SendIfResponds[GTMioShaderProfilerGPUCommand](objc.ID(class.class), objc.Sel("new"))
	return rv
}
...
func NewGTMioShaderProfilerGPUCommandWithMioGPUCommandStreamGPUCommandTraceData(gPUCommand *GTMioDrawMetadata, gPUCommand2 unsafe.Pointer, data objectivec.IObject) GTMioShaderProfilerGPUCommand {
	...
	rv := objc.SendIfResponds[objc.ID](instance.ID, objc.Sel("initWithMioGPUCommand:streamGPUCommand:traceData:"), unsafe.Pointer(gPUCommand), gPUCommand2, data)
...
func (g GTMioShaderProfilerGPUCommand) InitWithMioGPUCommandStreamGPUCommandTraceData(gPUCommand *GTMioDrawMetadata, gPUCommand2 unsafe.Pointer, data objectivec.IObject) GTMioShaderProfilerGPUCommand {
	rv := objc.SendIfResponds[GTMioShaderProfilerGPUCommand](g.ID, objc.Sel("initWithMioGPUCommand:streamGPUCommand:traceData:"), unsafe.Pointer(gPUCommand), gPUCommand2, data)
	return rv
}
...
func (g GTMioShaderProfilerGPUCommand) SubCommandIndex() int32 {
