...
func (gc GTMioShaderProfilerShaderFunctionClass) Alloc() GTMioShaderProfilerShaderFunction {
	rv := objc.SendIfResponds[GTMioShaderProfilerShaderFunction](objc.ID(gc.class), objc.Sel("alloc"))
	return rv
}
...
func (g GTMioShaderProfilerShaderFunction) Init() GTMioShaderProfilerShaderFunction {
	rv := objc.SendIfResponds[GTMioShaderProfilerShaderFunction](g.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (g GTMioShaderProfilerShaderFunction) Autorelease() GTMioShaderProfilerShaderFunction {
	rv := objc.SendIfResponds[GTMioShaderProfilerShaderFunction](g.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewGTMioShaderProfilerShaderFunction() GTMioShaderProfilerShaderFunction {
	...
	rv := objc.SendIfResponds[GTMioShaderProfilerShaderFunction](objc.ID(class.class), objc.Sel("new"))
	return rv
}
...
func (g GTMioShaderProfilerShaderFunction) InitWithInfoTraceData(info unsafe.Pointer, data objectivec.IObject) GTMioShaderProfilerShaderFunction {
	rv := objc.SendIfResponds[GTMioShaderProfilerShaderFunction](g.ID, objc.Sel("initWithInfo:traceData:"), info, data)
	return rv
}
