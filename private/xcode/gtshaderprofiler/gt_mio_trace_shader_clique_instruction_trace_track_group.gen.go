...
func NewGTMioTraceShaderCliqueInstructionTraceTrackGroupWithIdScopeScopeIdentifierLevelLevelIdentifier(id int32, scope uint16, identifier uint64, level uint16, identifier2 uint32) GTMioTraceShaderCliqueInstructionTraceTrackGroup {
