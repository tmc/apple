...
type IGTMioTraceTrack interface {
	...
	FirstIndex() uint64
	IsEmpty() bool
	LaneIdForStartEnd(start uint64, end uint64) int32
	Lanes() foundation.INSArray
	StartTimestamp() uint64
	TakeEndIndex(take uint64, end uint64, index uint64)
	TakeEndIndexLaneId(take uint64, end uint64, index uint64, id int32)
	TakeEndIndexesBeginIndexesEndLaneId(take uint64, end uint64, begin uint64, end2 uint64, id int32)
	TrackId() int32
	InitWithIdScopeScopeIdentifierLevelLevelIdentifier(id int32, scope uint16, identifier uint64, level uint16, identifier2 uint32) GTMioTraceTrack
}
...
func NewGTMioTraceTrackWithIdScopeScopeIdentifierLevelLevelIdentifier(id int32, scope uint16, identifier uint64, level uint16, identifier2 uint32) GTMioTraceTrack {
...
func (g GTMioTraceTrack) LaneIdForStartEnd(start uint64, end uint64) int32 {
	rv := objc.SendIfResponds[int32](g.ID, objc.Sel("laneIdForStart:end:"), start, end)
	return rv
}
...
func (g GTMioTraceTrack) TakeEndIndexLaneId(take uint64, end uint64, index uint64, id int32) {
	objc.SendIfResponds[objc.ID](g.ID, objc.Sel("take:end:index:laneId:"), take, end, index, id)
}
func (g GTMioTraceTrack) TakeEndIndexesBeginIndexesEndLaneId(take uint64, end uint64, begin uint64, end2 uint64, id int32) {
	objc.SendIfResponds[objc.ID](g.ID, objc.Sel("take:end:indexesBegin:indexesEnd:laneId:"), take, end, begin, end2, id)
}
func (g GTMioTraceTrack) InitWithIdScopeScopeIdentifierLevelLevelIdentifier(id int32, scope uint16, identifier uint64, level uint16, identifier2 uint32) GTMioTraceTrack {
...
func (g GTMioTraceTrack) TrackId() int32 {
	rv := objc.SendIfResponds[int32](g.ID, objc.Sel("trackId"))
	return rv
}
