...
type IGTMioTraceTrackLane interface {
	...
	IsEmpty() bool
	LaneId() int32
	InitWithId(id int32) GTMioTraceTrackLane
}
...
func NewGTMioTraceTrackLaneWithId(id int32) GTMioTraceTrackLane {
...
func (g GTMioTraceTrackLane) InitWithId(id int32) GTMioTraceTrackLane {
...
func (g GTMioTraceTrackLane) LaneId() int32 {
	rv := objc.SendIfResponds[int32](g.ID, objc.Sel("laneId"))
	return rv
}
