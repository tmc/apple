...
func (gc GTMioUSCTraceDataClass) Alloc() GTMioUSCTraceData {
	rv := objc.SendIfResponds[GTMioUSCTraceData](objc.ID(gc.class), objc.Sel("alloc"))
	return rv
}
...
type IGTMioUSCTraceData interface {
	...
	InstructionTraceInfoForClique(clique *GTMioUSCCliqueMetadata) *GTMioUSCInstructionTraceInfo
	InstructionTraceInfoForCliqueAtIndex(index uint32) *GTMioUSCInstructionTraceInfo
...
func (g GTMioUSCTraceData) Init() GTMioUSCTraceData {
	rv := objc.SendIfResponds[GTMioUSCTraceData](g.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (g GTMioUSCTraceData) Autorelease() GTMioUSCTraceData {
	rv := objc.SendIfResponds[GTMioUSCTraceData](g.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewGTMioUSCTraceData() GTMioUSCTraceData {
	...
	rv := objc.SendIfResponds[GTMioUSCTraceData](objc.ID(class.class), objc.Sel("new"))
	return rv
}
...
func NewGTMioUSCTraceDataWithUSCDataMGPUIndexParent(uSCData unsafe.Pointer, gPUIndex uint64, parent objectivec.IObject) GTMioUSCTraceData {
	...
	rv := objc.SendIfResponds[objc.ID](instance.ID, objc.Sel("initWithUSCData:mGPUIndex:parent:"), uSCData, gPUIndex, parent)
	return GTMioUSCTraceDataFromID(rv)
}

func (g GTMioUSCTraceData) ChildCliqueOfClique(clique *GTMioUSCCliqueMetadata) *GTMioUSCCliqueMetadata {
...
func (g GTMioUSCTraceData) EnumerateCliquesForTimeRangeBeginEndEnumerator(begin uint64, end uint64, enumerator VoidHandler) {
	...
	objc.SendIfResponds[objc.ID](g.ID, objc.Sel("enumerateCliquesForTimeRangeBegin:end:enumerator:"), begin, end, _block2)
}
func (g GTMioUSCTraceData) EnumerateInstructionTracesForCliqueRequiresTimestampsEnumerator(clique *GTMioUSCCliqueMetadata, timestamps bool, enumerator VoidHandler) {
	_block2, _ := NewVoidBlock(enumerator)
	objc.SendIfResponds[objc.ID](g.ID, objc.Sel("enumerateInstructionTracesForClique:requiresTimestamps:enumerator:"), clique, timestamps, _block2)
}
...
func (g GTMioUSCTraceData) EnumerateKickCliquesEnumerator(cliques *GTMioUSCKickMetadata, enumerator VoidHandler) {
	_block1, _ := NewVoidBlock(enumerator)
	objc.SendIfResponds[objc.ID](g.ID, objc.Sel("enumerateKickCliques:enumerator:"), cliques, _block1)
}
func (g GTMioUSCTraceData) EnumerateKickCliquesAtFunctionIndexDataMasterEnumerator(index uint32, master uint16, enumerator VoidHandler) {
	_block2, _ := NewVoidBlock(enumerator)
	objc.SendIfResponds[objc.ID](g.ID, objc.Sel("enumerateKickCliquesAtFunctionIndex:dataMaster:enumerator:"), index, master, _block2)
}
func (g GTMioUSCTraceData) EnumerateKickTilesEnumerator(tiles *GTMioUSCKickMetadata, enumerator VoidHandler) {
	_block1, _ := NewVoidBlock(enumerator)
	objc.SendIfResponds[objc.ID](g.ID, objc.Sel("enumerateKickTiles:enumerator:"), tiles, _block1)
}
func (g GTMioUSCTraceData) EnumerateKickTilesAtFunctionIndexDataMasterEnumerator(index uint32, master uint16, enumerator VoidHandler) {
	_block2, _ := NewVoidBlock(enumerator)
	objc.SendIfResponds[objc.ID](g.ID, objc.Sel("enumerateKickTilesAtFunctionIndex:dataMaster:enumerator:"), index, master, _block2)
}
func (g GTMioUSCTraceData) EnumerateTileCliquesEnumerator(cliques *GTMioUSCTileMetadata, enumerator VoidHandler) {
	_block1, _ := NewVoidBlock(enumerator)
	objc.SendIfResponds[objc.ID](g.ID, objc.Sel("enumerateTileCliques:enumerator:"), cliques, _block1)
}
func (g GTMioUSCTraceData) FirstBinaryAddressForCliqueAtIndex(index uint32) uint64 {
	rv := objc.SendIfResponds[uint64](g.ID, objc.Sel("firstBinaryAddressForCliqueAtIndex:"), index)
	return rv
}
func (g GTMioUSCTraceData) FirstBinaryIndexForCliqueAtIndex(index uint32) uint32 {
	rv := objc.SendIfResponds[uint32](g.ID, objc.Sel("firstBinaryIndexForCliqueAtIndex:"), index)
	return rv
}
func (g GTMioUSCTraceData) FirstPCForCliqueAtIndex(index uint32) uint64 {
	rv := objc.SendIfResponds[uint64](g.ID, objc.Sel("firstPCForCliqueAtIndex:"), index)
	return rv
}
...
func (g GTMioUSCTraceData) InstructionTraceInfoForClique(clique *GTMioUSCCliqueMetadata) *GTMioUSCInstructionTraceInfo {
	rv := objc.SendIfResponds[unsafe.Pointer](g.ID, objc.Sel("instructionTraceInfoForClique:"), unsafe.Pointer(clique))
	return (*GTMioUSCInstructionTraceInfo)(rv)
}
func (g GTMioUSCTraceData) InstructionTraceInfoForCliqueAtIndex(index uint32) *GTMioUSCInstructionTraceInfo {
	rv := objc.SendIfResponds[unsafe.Pointer](g.ID, objc.Sel("instructionTraceInfoForCliqueAtIndex:"), index)
	return (*GTMioUSCInstructionTraceInfo)(rv)
}
...
func (g GTMioUSCTraceData) PcForInstructionBinaryIndex(instruction uint32, index uint32) uint64 {
	rv := objc.SendIfResponds[uint64](g.ID, objc.Sel("pcForInstruction:binaryIndex:"), instruction, index)
	return rv
}
func (g GTMioUSCTraceData) PipelineStateIdForCliqueAtIndex(index uint32) uint64 {
	rv := objc.SendIfResponds[uint64](g.ID, objc.Sel("pipelineStateIdForCliqueAtIndex:"), index)
	return rv
}
...
func (g GTMioUSCTraceData) InitWithUSCDataMGPUIndexParent(uSCData unsafe.Pointer, gPUIndex uint64, parent objectivec.IObject) GTMioUSCTraceData {
	rv := objc.SendIfResponds[GTMioUSCTraceData](g.ID, objc.Sel("initWithUSCData:mGPUIndex:parent:"), uSCData, gPUIndex, parent)
	return rv
}

func (g GTMioUSCTraceData) BinaryTrace() *GTMioBinaryTrace {
	rv := objc.SendIfResponds[unsafe.Pointer](g.ID, objc.Sel("binaryTrace"))
	return (*GTMioBinaryTrace)(rv)
}
func (g GTMioUSCTraceData) BinaryTraceCount() uint64 {
	rv := objc.SendIfResponds[uint64](g.ID, objc.Sel("binaryTraceCount"))
	return rv
}
func (g GTMioUSCTraceData) CliqueFirstPCCount() uint64 {
	rv := objc.SendIfResponds[uint64](g.ID, objc.Sel("cliqueFirstPCCount"))
	return rv
}
func (g GTMioUSCTraceData) CliqueFirstPCs() unsafe.Pointer {
	rv := objc.SendIfResponds[unsafe.Pointer](g.ID, objc.Sel("cliqueFirstPCs"))
	return rv
}
func (g GTMioUSCTraceData) Cliques() *GTMioUSCCliqueMetadata {
	rv := objc.SendIfResponds[unsafe.Pointer](g.ID, objc.Sel("cliques"))
	return (*GTMioUSCCliqueMetadata)(rv)
}
func (g GTMioUSCTraceData) CliquesCount() uint64 {
	rv := objc.SendIfResponds[uint64](g.ID, objc.Sel("cliquesCount"))
	return rv
}
...
func (g GTMioUSCTraceData) Costs() *GTMioCostInfo {
...
func (g GTMioUSCTraceData) DrawTrace() *GTMioDrawTrace {
	rv := objc.SendIfResponds[unsafe.Pointer](g.ID, objc.Sel("drawTrace"))
...
func (g GTMioUSCTraceData) KickCliqueIndexes() unsafe.Pointer {
	rv := objc.SendIfResponds[unsafe.Pointer](g.ID, objc.Sel("kickCliqueIndexes"))
	return rv
}
func (g GTMioUSCTraceData) KickCliqueIndexesCount() uint64 {
	rv := objc.SendIfResponds[uint64](g.ID, objc.Sel("kickCliqueIndexesCount"))
	return rv
}
func (g GTMioUSCTraceData) KickTileIndexes() unsafe.Pointer {
	rv := objc.SendIfResponds[unsafe.Pointer](g.ID, objc.Sel("kickTileIndexes"))
	return rv
}
func (g GTMioUSCTraceData) KickTileIndexesCount() uint64 {
	rv := objc.SendIfResponds[uint64](g.ID, objc.Sel("kickTileIndexesCount"))
	return rv
}
func (g GTMioUSCTraceData) Kicks() *GTMioUSCKickMetadata {
	rv := objc.SendIfResponds[unsafe.Pointer](g.ID, objc.Sel("kicks"))
	return (*GTMioUSCKickMetadata)(rv)
}
...
func (g GTMioUSCTraceData) MGPUIndex() uint64 {
	rv := objc.SendIfResponds[uint64](g.ID, objc.Sel("mGPUIndex"))
	return rv
}
...
func (g GTMioUSCTraceData) TileCliqueIndexes() unsafe.Pointer {
	rv := objc.SendIfResponds[unsafe.Pointer](g.ID, objc.Sel("tileCliqueIndexes"))
	return rv
}
func (g GTMioUSCTraceData) TileCliqueIndexesCount() uint64 {
	rv := objc.SendIfResponds[uint64](g.ID, objc.Sel("tileCliqueIndexesCount"))
	return rv
}
func (g GTMioUSCTraceData) Tiles() *GTMioUSCTileMetadata {
	rv := objc.SendIfResponds[unsafe.Pointer](g.ID, objc.Sel("tiles"))
	return (*GTMioUSCTileMetadata)(rv)
}
func (g GTMioUSCTraceData) TilesCount() uint64 {
	rv := objc.SendIfResponds[uint64](g.ID, objc.Sel("tilesCount"))
	return rv
}
...
func (g GTMioUSCTraceData) UscCost() *GTMioCostInfo {
	rv := objc.SendIfResponds[unsafe.Pointer](g.ID, objc.Sel("uscCost"))
	return (*GTMioCostInfo)(rv)
}
