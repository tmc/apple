...
func (_GTShaderProfilerBinaryAnalysisResultClass GTShaderProfilerBinaryAnalysisResultClass) AnalyzeBinaryTargetIndexIsaPrinter(binary objectivec.IObject, index int32, printer objectivec.IObject) objectivec.IObject {
...
func (g GTShaderProfilerBinaryAnalysisResult) BinaryLocationData() foundation.NSData {
	rv := objc.SendIfResponds[foundation.NSData](g.ID, objc.Sel("binaryLocationData"))
...
func (g GTShaderProfilerBinaryAnalysisResult) BinaryRangeData() foundation.NSData {
	rv := objc.SendIfResponds[foundation.NSData](g.ID, objc.Sel("binaryRangeData"))
	return foundation.NSData(rv)
}
...
func (g GTShaderProfilerBinaryAnalysisResult) BranchTargetData() foundation.NSData {
	rv := objc.SendIfResponds[foundation.NSData](g.ID, objc.Sel("branchTargetData"))
	return foundation.NSData(rv)
}
...
func (g GTShaderProfilerBinaryAnalysisResult) ClauseData() foundation.NSData {
	rv := objc.SendIfResponds[foundation.NSData](g.ID, objc.Sel("clauseData"))
	return foundation.NSData(rv)
}
...
func (g GTShaderProfilerBinaryAnalysisResult) InstructionData() foundation.NSData {
	rv := objc.SendIfResponds[foundation.NSData](g.ID, objc.Sel("instructionData"))
	return foundation.NSData(rv)
}
...
func (g GTShaderProfilerBinaryAnalysisResult) RegisterInfoData() foundation.NSData {
	rv := objc.SendIfResponds[foundation.NSData](g.ID, objc.Sel("registerInfoData"))
	return foundation.NSData(rv)
}
