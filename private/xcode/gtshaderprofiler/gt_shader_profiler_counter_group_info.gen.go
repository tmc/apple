...
func (gc GTShaderProfilerCounterGroupInfoClass) Alloc() GTShaderProfilerCounterGroupInfo {
	rv := objc.SendIfResponds[GTShaderProfilerCounterGroupInfo](objc.ID(gc.class), objc.Sel("alloc"))
	return rv
}
...
func (g GTShaderProfilerCounterGroupInfo) Init() GTShaderProfilerCounterGroupInfo {
	rv := objc.SendIfResponds[GTShaderProfilerCounterGroupInfo](g.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (g GTShaderProfilerCounterGroupInfo) Autorelease() GTShaderProfilerCounterGroupInfo {
	rv := objc.SendIfResponds[GTShaderProfilerCounterGroupInfo](g.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewGTShaderProfilerCounterGroupInfo() GTShaderProfilerCounterGroupInfo {
	...
	rv := objc.SendIfResponds[GTShaderProfilerCounterGroupInfo](objc.ID(class.class), objc.Sel("new"))
	return rv
}
...
func (g GTShaderProfilerCounterGroupInfo) InitWithSpecParent(spec objectivec.IObject, parent objectivec.IObject) GTShaderProfilerCounterGroupInfo {
	rv := objc.SendIfResponds[GTShaderProfilerCounterGroupInfo](g.ID, objc.Sel("initWithSpec:parent:"), spec, parent)
	return rv
}
...
func (_GTShaderProfilerCounterGroupInfoClass GTShaderProfilerCounterGroupInfoClass) StringToResourceLink(link objectivec.IObject) uint64 {
	rv := objc.SendIfResponds[uint64](objc.ID(_GTShaderProfilerCounterGroupInfoClass.class), objc.Sel("stringToResourceLink:"), link)
	return rv
}

func (g GTShaderProfilerCounterGroupInfo) BasisCondition() int32 {
	rv := objc.SendIfResponds[int32](g.ID, objc.Sel("basisCondition"))
	return rv
}
func (g GTShaderProfilerCounterGroupInfo) BasisCounter() string {
	rv := objc.SendIfResponds[objc.ID](g.ID, objc.Sel("basisCounter"))
...
func (g GTShaderProfilerCounterGroupInfo) ResourceLink() uint64 {
	rv := objc.SendIfResponds[uint64](g.ID, objc.Sel("resourceLink"))
	return rv
}
func (g GTShaderProfilerCounterGroupInfo) SumCounterIndex() uint64 {
	rv := objc.SendIfResponds[uint64](g.ID, objc.Sel("sumCounterIndex"))
	return rv
}
func (g GTShaderProfilerCounterGroupInfo) ValueRange() foundation.NSRange {
	rv := objc.SendIfResponds[foundation.NSRange](g.ID, objc.Sel("valueRange"))
