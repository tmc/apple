...
func (g GTShaderProfilerDeviceInfo) Platform() int32 {
	rv := objc.SendIfResponds[int32](g.ID, objc.Sel("platform"))
	return rv
}
func (g GTShaderProfilerDeviceInfo) SetPlatform(value int32) {
