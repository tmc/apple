...
type IGTShaderProfilerStreamData interface {
	...
	GPUCommandInfoFromFunctionIndexSubCommandIndex(index uint32, index2 int32) unsafe.Pointer
...
func (g GTShaderProfilerStreamData) GPUCommandInfoFromFunctionIndexSubCommandIndex(index uint32, index2 int32) unsafe.Pointer {
...
func (g GTShaderProfilerStreamData) CommandBufferInfoData() foundation.NSData {
	rv := objc.SendIfResponds[foundation.NSData](g.ID, objc.Sel("commandBufferInfoData"))
...
func (g GTShaderProfilerStreamData) DataFileURL() foundation.NSURL {
	rv := objc.SendIfResponds[foundation.NSURL](g.ID, objc.Sel("dataFileURL"))
...
func (g GTShaderProfilerStreamData) EncoderInfoData() foundation.NSData {
	rv := objc.SendIfResponds[foundation.NSData](g.ID, objc.Sel("encoderInfoData"))
	return foundation.NSData(rv)
}
...
func (g GTShaderProfilerStreamData) FunctionInfoData() foundation.NSData {
	rv := objc.SendIfResponds[foundation.NSData](g.ID, objc.Sel("functionInfoData"))
	return foundation.NSData(rv)
}
...
func (g GTShaderProfilerStreamData) GpuCommandInfoData() foundation.NSData {
	rv := objc.SendIfResponds[foundation.NSData](g.ID, objc.Sel("gpuCommandInfoData"))
	return foundation.NSData(rv)
}
...
func (g GTShaderProfilerStreamData) PipelineStateInfoData() foundation.NSData {
	rv := objc.SendIfResponds[foundation.NSData](g.ID, objc.Sel("pipelineStateInfoData"))
	return foundation.NSData(rv)
}
...
func (g GTShaderProfilerStreamData) PreSiBundleURL() foundation.NSURL {
	rv := objc.SendIfResponds[foundation.NSURL](g.ID, objc.Sel("preSiBundleURL"))
	return foundation.NSURL(rv)
}
