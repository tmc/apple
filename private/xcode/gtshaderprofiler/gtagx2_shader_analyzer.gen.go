...
type IGTAGX2ShaderAnalyzer interface {
	...
	_calculatePerDrawCallWithGRCSampleDataTargetIndexShaderBinary(data objectivec.IObject, index int32, binary objectivec.IObject)
	_calculatePerLineCostWithSampleDataAnalysisResultTargetIndexWithALUBlocksBinaryInfo(data objectivec.IObject, result objectivec.IObject, index int32, aLUBlocks unsafe.Pointer, info objectivec.IObject) objectivec.IObject
	AnalyzedBinaryProcessedUscSamplesTargetIndexWithALUBlocksBinaryInfo(binary objectivec.IObject, samples objectivec.IObject, index int32, aLUBlocks unsafe.Pointer, info objectivec.IObject) objectivec.IObject
	DisassembleBinary(binary objectivec.IObject) objectivec.IObject
	GetShaderBinaryForTargetIndexBinaryInfo(binary objectivec.IObject, index int32, info objectivec.IObject) objectivec.IObject
}
...
func (g GTAGX2ShaderAnalyzer) _calculatePerDrawCallWithGRCSampleDataTargetIndexShaderBinary(data objectivec.IObject, index int32, binary objectivec.IObject) {
...
func (g GTAGX2ShaderAnalyzer) CalculatePerDrawCallWithGRCSampleDataTargetIndexShaderBinary(data objectivec.IObject, index int32, binary objectivec.IObject) error {
...
func (g GTAGX2ShaderAnalyzer) _calculatePerLineCostWithSampleDataAnalysisResultTargetIndexWithALUBlocksBinaryInfo(data objectivec.IObject, result objectivec.IObject, index int32, aLUBlocks unsafe.Pointer, info objectivec.IObject) objectivec.IObject {
...
func (g GTAGX2ShaderAnalyzer) CalculatePerLineCostWithSampleDataAnalysisResultTargetIndexWithALUBlocksBinaryInfo(data objectivec.IObject, result objectivec.IObject, index int32, aLUBlocks unsafe.Pointer, info objectivec.IObject) (objectivec.IObject, error) {
...
func (g GTAGX2ShaderAnalyzer) AnalyzedBinaryProcessedUscSamplesTargetIndexWithALUBlocksBinaryInfo(binary objectivec.IObject, samples objectivec.IObject, index int32, aLUBlocks unsafe.Pointer, info objectivec.IObject) objectivec.IObject {
...
func (g GTAGX2ShaderAnalyzer) GetShaderBinaryForTargetIndexBinaryInfo(binary objectivec.IObject, index int32, info objectivec.IObject) objectivec.IObject {
