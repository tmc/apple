...
type IGTAGX2ShaderBinary interface {
	...
	AddBinaryRangeColumnAddrStartAddrEndFunctionNameFullPath(range_ int32, column int32, start uint32, end uint32, name objectivec.IObject, path objectivec.IObject) objectivec.IObject
	...
	SetKey(value string)
	LineMax() int32
	SetLineMax(value int32)
	LineMin() int32
	SetLineMin(value int32)
	NumSamples() uint64
...
func (g GTAGX2ShaderBinary) AddBinaryRangeColumnAddrStartAddrEndFunctionNameFullPath(range_ int32, column int32, start uint32, end uint32, name objectivec.IObject, path objectivec.IObject) objectivec.IObject {
...
func (g GTAGX2ShaderBinary) LineMax() int32 {
	rv := objc.SendIfResponds[int32](g.ID, objc.Sel("lineMax"))
	return rv
}
func (g GTAGX2ShaderBinary) SetLineMax(value int32) {
	objc.SendIfResponds[struct{}](g.ID, objc.Sel("setLineMax:"), value)
}
func (g GTAGX2ShaderBinary) LineMin() int32 {
	rv := objc.SendIfResponds[int32](g.ID, objc.Sel("lineMin"))
	return rv
}
func (g GTAGX2ShaderBinary) SetLineMin(value int32) {
