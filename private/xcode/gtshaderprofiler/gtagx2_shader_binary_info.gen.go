...
func (gc GTAGX2ShaderBinaryInfoClass) Alloc() GTAGX2ShaderBinaryInfo {
	rv := objc.SendIfResponds[GTAGX2ShaderBinaryInfo](objc.ID(gc.class), objc.Sel("alloc"))
	return rv
}
...
type IGTAGX2ShaderBinaryInfo interface {
	...
	Binary() foundation.NSData
	SetBinary(value foundation.NSData)
...
func (g GTAGX2ShaderBinaryInfo) Init() GTAGX2ShaderBinaryInfo {
	rv := objc.SendIfResponds[GTAGX2ShaderBinaryInfo](g.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (g GTAGX2ShaderBinaryInfo) Autorelease() GTAGX2ShaderBinaryInfo {
	rv := objc.SendIfResponds[GTAGX2ShaderBinaryInfo](g.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewGTAGX2ShaderBinaryInfo() GTAGX2ShaderBinaryInfo {
	...
	rv := objc.SendIfResponds[GTAGX2ShaderBinaryInfo](objc.ID(class.class), objc.Sel("new"))
	return rv
}
...
func NewGTAGX2ShaderBinaryInfoWithKeyBinaryTypeDylibAnalysisResult(key objectivec.IObject, binary objectivec.IObject, type_ objectivec.IObject, dylib objectivec.IObject, result objectivec.IObject) GTAGX2ShaderBinaryInfo {
	...
	rv := objc.SendIfResponds[objc.ID](instance.ID, objc.Sel("initWithKey:binary:type:dylib:analysisResult:"), key, binary, type_, dylib, result)
...
func (g GTAGX2ShaderBinaryInfo) InitWithKeyBinaryTypeDylibAnalysisResult(key objectivec.IObject, binary objectivec.IObject, type_ objectivec.IObject, dylib objectivec.IObject, result objectivec.IObject) GTAGX2ShaderBinaryInfo {
	rv := objc.SendIfResponds[GTAGX2ShaderBinaryInfo](g.ID, objc.Sel("initWithKey:binary:type:dylib:analysisResult:"), key, binary, type_, dylib, result)
	return rv
}

func (g GTAGX2ShaderBinaryInfo) AluBlockCount() uint32 {
	rv := objc.SendIfResponds[uint32](g.ID, objc.Sel("aluBlockCount"))
	return rv
}
...
func (g GTAGX2ShaderBinaryInfo) Binary() foundation.NSData {
	rv := objc.SendIfResponds[foundation.NSData](g.ID, objc.Sel("binary"))
	return foundation.NSData(rv)
}
func (g GTAGX2ShaderBinaryInfo) SetBinary(value foundation.NSData) {
	objc.SendIfResponds[struct{}](g.ID, objc.Sel("setBinary:"), value)
}
func (g GTAGX2ShaderBinaryInfo) Dylib() foundation.NSNumber {
	rv := objc.SendIfResponds[foundation.NSNumber](g.ID, objc.Sel("dylib"))
	return foundation.NSNumber(rv)
}
func (g GTAGX2ShaderBinaryInfo) SetDylib(value foundation.NSNumber) {
	objc.SendIfResponds[struct{}](g.ID, objc.Sel("setDylib:"), value)
}
...
func (g GTAGX2ShaderBinaryInfo) Type() string {
	rv := objc.SendIfResponds[objc.ID](g.ID, objc.Sel("type"))
	return foundation.NSStringFromID(rv).String()
}
func (g GTAGX2ShaderBinaryInfo) SetType(value string) {
	objc.SendIfResponds[struct{}](g.ID, objc.Sel("setType:"), objc.String(value))
}
func (g GTAGX2ShaderBinaryInfo) UscSamples() foundation.NSMutableData {
	rv := objc.SendIfResponds[foundation.NSMutableData](g.ID, objc.Sel("uscSamples"))
	return foundation.NSMutableData(rv)
}
func (g GTAGX2ShaderBinaryInfo) SetUscSamples(value foundation.NSMutableData) {
	objc.SendIfResponds[struct{}](g.ID, objc.Sel("setUscSamples:"), value)
}
