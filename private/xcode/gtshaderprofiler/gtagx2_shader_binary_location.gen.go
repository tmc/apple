...
type IGTAGX2ShaderBinaryLocation interface {
	...
	InitWithFunctionNameIndexFullPathIndexLineColumnBinary(index uint64, index2 uint64, line int32, column int32, binary objectivec.IObject) GTAGX2ShaderBinaryLocation
...
func NewGTAGX2ShaderBinaryLocationWithFunctionNameIndexFullPathIndexLineColumnBinary(index uint64, index2 uint64, line int32, column int32, binary objectivec.IObject) GTAGX2ShaderBinaryLocation {
	instance := getGTAGX2ShaderBinaryLocationClass().Alloc()
...
func (g GTAGX2ShaderBinaryLocation) InitWithFunctionNameIndexFullPathIndexLineColumnBinary(index uint64, index2 uint64, line int32, column int32, binary objectivec.IObject) GTAGX2ShaderBinaryLocation {
...
func (g GTAGX2ShaderBinaryLocation) Column() int32 {
	rv := objc.SendIfResponds[int32](g.ID, objc.Sel("column"))
	return rv
}
func (g GTAGX2ShaderBinaryLocation) SetColumn(value int32) {
...
func (g GTAGX2ShaderBinaryLocation) Line() int32 {
	rv := objc.SendIfResponds[int32](g.ID, objc.Sel("line"))
	return rv
}
func (g GTAGX2ShaderBinaryLocation) SetLine(value int32) {
