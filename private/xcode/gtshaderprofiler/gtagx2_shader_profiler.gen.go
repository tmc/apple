...
func (gc GTAGX2ShaderProfilerClass) Alloc() GTAGX2ShaderProfiler {
	rv := objc.SendIfResponds[GTAGX2ShaderProfiler](objc.ID(gc.class), objc.Sel("alloc"))
	return rv
}
...
type IGTAGX2ShaderProfiler interface {
	...
	_dumpShaderBinaries()
	_dumpTraceBufferPacketsInFileUsingTracePacketsWithExtractedSamplesWithTraceBufferCountForTargetIndex(file appleneuralengine.SFILE, packets *uint32, samples unsafe.Pointer, count uint32, index int32)
	...
	_processTracePacketsForRenderIndexAndGenerateSampleListForTargetIndexForLimiterIndex(packets *uint32, index uint32, list unsafe.Pointer, index2 int32, index3 uint32)
	...
	InitWithStreamDataForTargetIndex(data objectivec.IObject, index int32) GTAGX2ShaderProfiler
}

// Init initializes the instance.
func (g GTAGX2ShaderProfiler) Init() GTAGX2ShaderProfiler {
	rv := objc.SendIfResponds[GTAGX2ShaderProfiler](g.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (g GTAGX2ShaderProfiler) Autorelease() GTAGX2ShaderProfiler {
	rv := objc.SendIfResponds[GTAGX2ShaderProfiler](g.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewGTAGX2ShaderProfiler() GTAGX2ShaderProfiler {
	...
	rv := objc.SendIfResponds[GTAGX2ShaderProfiler](objc.ID(class.class), objc.Sel("new"))
	return rv
}

func NewGTAGX2ShaderProfilerWithStreamDataForTargetIndex(data objectivec.IObject, index int32) GTAGX2ShaderProfiler {
	instance := getGTAGX2ShaderProfilerClass().Alloc()
	rv := objc.SendIfResponds[objc.ID](instance.ID, objc.Sel("initWithStreamData:forTargetIndex:"), data, index)
	return GTAGX2ShaderProfilerFromID(rv)
}

func (g GTAGX2ShaderProfiler) _analyzeShaderBinaries() {
	objc.SendIfResponds[objc.ID](g.ID, objc.Sel("_analyzeShaderBinaries"))
}
...
func (g GTAGX2ShaderProfiler) _calculateAggregatedEffectiveGPUEncoderCost() {
	objc.SendIfResponds[objc.ID](g.ID, objc.Sel("_calculateAggregatedEffectiveGPUEncoderCost"))
}
...
func (g GTAGX2ShaderProfiler) _calculateAndAppendPerBatchCostsForFrameIndexAtTimestampWithLimiterIndicesWithTimestampBuffersWithActiveBatchesWithPerRingBufferLimiterEncoderCosts(costs unsafe.Pointer, index uint32, timestamp uint64, indices unsafe.Pointer, buffers unsafe.Pointer, batches unsafe.Pointer, costs2 unsafe.Pointer) {
	objc.SendIfResponds[objc.ID](g.ID, objc.Sel("_calculateAndAppendPerBatchCosts:forFrameIndex:atTimestamp:withLimiterIndices:withTimestampBuffers:withActiveBatches:withPerRingBufferLimiterEncoderCosts:"), costs, index, timestamp, indices, buffers, batches, costs2)
}
...
func (g GTAGX2ShaderProfiler) _calculateAverageGPUCommandDuration() {
	objc.SendIfResponds[objc.ID](g.ID, objc.Sel("_calculateAverageGPUCommandDuration"))
}
...
func (g GTAGX2ShaderProfiler) _calculateEffectiveGPUEncoderCostForFrameIndex(index uint32) {
	objc.SendIfResponds[objc.ID](g.ID, objc.Sel("_calculateEffectiveGPUEncoderCostForFrameIndex:"), index)
}
...
func (g GTAGX2ShaderProfiler) _calculatePerDrawCostsResult(costs objectivec.IObject, result objectivec.IObject) {
	objc.SendIfResponds[objc.ID](g.ID, objc.Sel("_calculatePerDrawCosts:result:"), costs, result)
}
...
func (g GTAGX2ShaderProfiler) _cleanup() {
	objc.SendIfResponds[objc.ID](g.ID, objc.Sel("_cleanup"))
}
...
func (g GTAGX2ShaderProfiler) _computeSampleNormFactorForSampleForProgramStartAddressForProgramEndAddress(sample *ShaderProfilerUSCSampleInfo, address uint64, address2 uint64) uint32 {
	rv := objc.SendIfResponds[uint32](g.ID, objc.Sel("_computeSampleNormFactorForSample:forProgramStartAddress:forProgramEndAddress:"), unsafe.Pointer(sample), address, address2)
	return rv
}
...
func (g GTAGX2ShaderProfiler) _conservativeLatencyAdjustmentWithLimiter(adjustment float64, limiter float64) float64 {
	rv := objc.SendIfResponds[float64](g.ID, objc.Sel("_conservativeLatencyAdjustment:withLimiter:"), adjustment, limiter)
	return rv
}
...
func (g GTAGX2ShaderProfiler) _dumpAggregatedGPUTimePerBatchForFrame(frame uint32) {
	objc.SendIfResponds[objc.ID](g.ID, objc.Sel("_dumpAggregatedGPUTimePerBatchForFrame:"), frame)
}
...
func (g GTAGX2ShaderProfiler) _dumpLimiterBatchInfoCostsForRingBufferForFrame(costs unsafe.Pointer, buffer uint32, frame uint32) {
	objc.SendIfResponds[objc.ID](g.ID, objc.Sel("_dumpLimiterBatchInfoCosts:forRingBuffer:forFrame:"), costs, buffer, frame)
}
...
func (g GTAGX2ShaderProfiler) _dumpShaderBinaries() {
	objc.SendIfResponds[objc.ID](g.ID, objc.Sel("_dumpShaderBinaries"))
}
...
func (g GTAGX2ShaderProfiler) _dumpTraceBufferPacketsInFileUsingTracePacketsWithExtractedSamplesWithTraceBufferCountForTargetIndex(file appleneuralengine.SFILE, packets *uint32, samples unsafe.Pointer, count uint32, index int32) {
	objc.SendIfResponds[objc.ID](g.ID, objc.Sel("_dumpTraceBufferPacketsInFile:usingTracePackets:withExtractedSamples:withTraceBufferCount:forTargetIndex:"), file, packets, samples, count, index)
}
...
func (g GTAGX2ShaderProfiler) DumpTraceBufferPacketsInFileUsingTracePacketsWithExtractedSamplesWithTraceBufferCountForTargetIndex(file appleneuralengine.SFILE, packets *uint32, samples unsafe.Pointer, count uint32, index int32) error {
...
func (g GTAGX2ShaderProfiler) _initiateConnectionToLLVMHelper() bool {
	rv := objc.SendIfResponds[bool](g.ID, objc.Sel("_initiateConnectionToLLVMHelper"))
	return rv
}
...
func (g GTAGX2ShaderProfiler) _latencyAdjustmentEstimateWithLimiter(estimate float64, limiter float64) float64 {
	rv := objc.SendIfResponds[float64](g.ID, objc.Sel("_latencyAdjustmentEstimate:withLimiter:"), estimate, limiter)
	return rv
}
...
func (g GTAGX2ShaderProfiler) _latencyAdjustmentFactorWithLimiterDataForIndexWithLimiterTypeIndexMapForLimiterType(data []float64, index uint64, map_ unsafe.Pointer, type_ uint32) float64 {
	rv := objc.SendIfResponds[float64](g.ID, objc.Sel("_latencyAdjustmentFactorWithLimiterData:forIndex:withLimiterTypeIndexMap:forLimiterType:"), data, index, map_, type_)
	return rv
}
...
func (g GTAGX2ShaderProfiler) _latencyAdjustmentFactorWithLimiterDataForIndexWithLimiterTypeIndexMapForLimiterTypeLoadForLimiterTypeStore(data []float64, index uint64, map_ unsafe.Pointer, load uint32, store uint32) float64 {
	rv := objc.SendIfResponds[float64](g.ID, objc.Sel("_latencyAdjustmentFactorWithLimiterData:forIndex:withLimiterTypeIndexMap:forLimiterTypeLoad:forLimiterTypeStore:"), data, index, map_, load, store)
	return rv
}
...
func (g GTAGX2ShaderProfiler) _latencyAdjustmentFactorWithLimiterDataWithLerpForIndexWithLimiterTypeIndexMapForLimiterType(lerp []float64, index uint64, map_ unsafe.Pointer, type_ uint32) float64 {
	rv := objc.SendIfResponds[float64](g.ID, objc.Sel("_latencyAdjustmentFactorWithLimiterDataWithLerp:forIndex:withLimiterTypeIndexMap:forLimiterType:"), lerp, index, map_, type_)
	return rv
}
...
func (g GTAGX2ShaderProfiler) _latencyAdjustmentWithLimiterDataForIndexWithLimiterTypeIndexMap(data []float64, index uint64, map_ unsafe.Pointer) float64 {
	rv := objc.SendIfResponds[float64](g.ID, objc.Sel("_latencyAdjustmentWithLimiterData:forIndex:withLimiterTypeIndexMap:"), data, index, map_)
	return rv
}
...
func (g GTAGX2ShaderProfiler) _mergeLegacyAndNewShadersInShaderInfoDictionary(dictionary objectivec.IObject) objectivec.IObject {
	rv := objc.SendIfResponds[objc.ID](g.ID, objc.Sel("_mergeLegacyAndNewShadersInShaderInfoDictionary:"), dictionary)
...
func (g GTAGX2ShaderProfiler) _processTracePacketsForRenderIndexAndGenerateSampleListForTargetIndexForLimiterIndex(packets *uint32, index uint32, list unsafe.Pointer, index2 int32, index3 uint32) {
	objc.SendIfResponds[objc.ID](g.ID, objc.Sel("_processTracePackets:forRenderIndex:andGenerateSampleList:forTargetIndex:forLimiterIndex:"), packets, index, list, index2, index3)
}
...
func (g GTAGX2ShaderProfiler) ProcessTracePacketsForRenderIndexAndGenerateSampleListForTargetIndexForLimiterIndex(packets *uint32, index uint32, list unsafe.Pointer, index2 int32, index3 uint32) error {
...
func (g GTAGX2ShaderProfiler) _setupShaderBinaryInfoWithBinaryKeyAndNumDraws(info objectivec.IObject, key unsafe.Pointer, draws uint32) {
	objc.SendIfResponds[objc.ID](g.ID, objc.Sel("_setupShaderBinaryInfo:withBinaryKey:andNumDraws:"), info, key, draws)
}
...
func (g GTAGX2ShaderProfiler) _waitLatencyAdjustmentWithLimiterDataForIndexWithLimiterTypeIndexMap(data []float64, index uint64, map_ unsafe.Pointer) float64 {
	rv := objc.SendIfResponds[float64](g.ID, objc.Sel("_waitLatencyAdjustmentWithLimiterData:forIndex:withLimiterTypeIndexMap:"), data, index, map_)
	return rv
}
...
func (g GTAGX2ShaderProfiler) AdjustHWBiasAndFinalizeResultBlitKickIndicesBlitTimesResult(result objectivec.IObject, indices objectivec.IObject, times objectivec.IObject, result2 objectivec.IObject) float64 {
	rv := objc.SendIfResponds[float64](g.ID, objc.Sel("adjustHWBiasAndFinalizeResult:blitKickIndices:blitTimes:result:"), result, indices, times, result2)
	return rv
}
func (g GTAGX2ShaderProfiler) DumpShaderBinarySamples(samples unsafe.Pointer) {
	objc.SendIfResponds[objc.ID](g.ID, objc.Sel("dumpShaderBinarySamples:"), samples)
}
func (g GTAGX2ShaderProfiler) EvaluateStreamingSamplesWithUSCSampleNumWithProgramAddressLUTTargetIndexForRingBufferIndexWithMinEncoderIndexWithMaxEncoderIndexWithEncoderIdToEncoderIndexMapWithProfilingData(samples *uint64, num uint32, lut unsafe.Pointer, index int32, index2 uint32, index3 uint32, index4 uint32, map_ unsafe.Pointer, data objectivec.IObject) {
	objc.SendIfResponds[objc.ID](g.ID, objc.Sel("evaluateStreamingSamples:withUSCSampleNum:withProgramAddressLUT:targetIndex:forRingBufferIndex:withMinEncoderIndex:withMaxEncoderIndex:withEncoderIdToEncoderIndexMap:withProfilingData:"), samples, num, lut, index, index2, index3, index4, map_, data)
}
func (g GTAGX2ShaderProfiler) HandleHarvestedBinaryInfo(info objectivec.IObject) {
	objc.SendIfResponds[objc.ID](g.ID, objc.Sel("handleHarvestedBinaryInfo:"), info)
}
func (g GTAGX2ShaderProfiler) SetRingBufferCount(count uint32) {
	objc.SendIfResponds[objc.ID](g.ID, objc.Sel("setRingBufferCount:"), count)
}
func (g GTAGX2ShaderProfiler) InitWithStreamDataForTargetIndex(data objectivec.IObject, index int32) GTAGX2ShaderProfiler {
	rv := objc.SendIfResponds[GTAGX2ShaderProfiler](g.ID, objc.Sel("initWithStreamData:forTargetIndex:"), data, index)
	return rv
}

func (g GTAGX2ShaderProfiler) AveragePerDrawKickDurations() foundation.INSArray {
	rv := objc.SendIfResponds[objc.ID](g.ID, objc.Sel("averagePerDrawKickDurations"))
	return foundation.NSArrayFromID(objc.ID(rv))
}
func (g GTAGX2ShaderProfiler) EffectiveKickTimes() foundation.INSArray {
	rv := objc.SendIfResponds[objc.ID](g.ID, objc.Sel("effectiveKickTimes"))
	return foundation.NSArrayFromID(objc.ID(rv))
}
...
func (g GTAGX2ShaderProfiler) LoadActionTimes() foundation.INSArray {
	rv := objc.SendIfResponds[objc.ID](g.ID, objc.Sel("loadActionTimes"))
	return foundation.NSArrayFromID(objc.ID(rv))
}
func (g GTAGX2ShaderProfiler) PerRingPerFrameLimiterData() foundation.INSDictionary {
	rv := objc.SendIfResponds[objc.ID](g.ID, objc.Sel("perRingPerFrameLimiterData"))
	return foundation.NSDictionaryFromID(objc.ID(rv))
}
func (g GTAGX2ShaderProfiler) StoreActionTimes() foundation.INSArray {
	rv := objc.SendIfResponds[objc.ID](g.ID, objc.Sel("storeActionTimes"))
	return foundation.NSArrayFromID(objc.ID(rv))
}
