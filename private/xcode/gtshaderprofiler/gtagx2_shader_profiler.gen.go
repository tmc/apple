...
type IGTAGX2ShaderProfiler interface {
	...
	_dumpShaderBinaries()
	_dumpTraceBufferPacketsInFileUsingTracePacketsWithExtractedSamplesWithTraceBufferCountForTargetIndex(file appleneuralengine.SFILE, packets *uint32, samples unsafe.Pointer, count uint32, index int)
...
func (g GTAGX2ShaderProfiler) _dumpTraceBufferPacketsInFileUsingTracePacketsWithExtractedSamplesWithTraceBufferCountForTargetIndex(file appleneuralengine.SFILE, packets *uint32, samples unsafe.Pointer, count uint32, index int) {
	objc.SendIfResponds[objc.ID](g.ID, objc.Sel("_dumpTraceBufferPacketsInFile:usingTracePackets:withExtractedSamples:withTraceBufferCount:forTargetIndex:"), file, unsafe.Pointer(packets), samples, count, index)
}
...
func (g GTAGX2ShaderProfiler) DumpTraceBufferPacketsInFileUsingTracePacketsWithExtractedSamplesWithTraceBufferCountForTargetIndex(file appleneuralengine.SFILE, packets *uint32, samples unsafe.Pointer, count uint32, index int) error {
...
func (g GTAGX2ShaderProfiler) _processTracePacketsForRenderIndexAndGenerateSampleListForTargetIndexForLimiterIndex(packets *uint32, index uint32, list unsafe.Pointer, index2 int, index3 uint32) {
	objc.SendIfResponds[objc.ID](g.ID, objc.Sel("_processTracePackets:forRenderIndex:andGenerateSampleList:forTargetIndex:forLimiterIndex:"), unsafe.Pointer(packets), index, list, index2, index3)
}
...
func (g GTAGX2ShaderProfiler) EvaluateStreamingSamplesWithUSCSampleNumWithProgramAddressLUTTargetIndexForRingBufferIndexWithMinEncoderIndexWithMaxEncoderIndexWithEncoderIdToEncoderIndexMapWithProfilingData(samples *uint64, num uint32, lut unsafe.Pointer, index int, index2 uint32, index3 uint32, index4 uint32, map_ unsafe.Pointer, data objectivec.IObject) {
	objc.SendIfResponds[objc.ID](g.ID, objc.Sel("evaluateStreamingSamples:withUSCSampleNum:withProgramAddressLUT:targetIndex:forRingBufferIndex:withMinEncoderIndex:withMaxEncoderIndex:withEncoderIdToEncoderIndexMap:withProfilingData:"), unsafe.Pointer(samples), num, lut, index, index2, index3, index4, map_, data)
}
