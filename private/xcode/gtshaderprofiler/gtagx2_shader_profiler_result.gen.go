...
type IGTAGX2ShaderProfilerResult interface {
	...
	Gpu() uint32
	GpuCommandForFunctionIndexSubCommandIndex(index uint64, index2 int32) objectivec.IObject
...
func (g GTAGX2ShaderProfilerResult) CacheObjects() error {
...
func (g GTAGX2ShaderProfilerResult) CanCacheObjects() bool {
...
func (g GTAGX2ShaderProfilerResult) GpuCommandForFunctionIndexSubCommandIndex(index uint64, index2 int32) objectivec.IObject {
