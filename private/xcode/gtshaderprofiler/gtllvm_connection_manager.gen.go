...
type IGTLLVMConnectionManager interface {
	...
	TargetIndex() int32
	InitWithGPUNameWithTargetIndexBinaryPathWithGenWithSocketNameForNumClients(gPUName objectivec.IObject, index int32, path objectivec.IObject, gen byte, name objectivec.IObject, clients uint32) GTLLVMConnectionManager
	Version() uint32
}
...
func NewGTLLVMConnectionManagerWithGPUNameWithTargetIndexBinaryPathWithGenWithSocketNameForNumClients(gPUName objectivec.IObject, index int32, path objectivec.IObject, gen byte, name objectivec.IObject, clients uint32) GTLLVMConnectionManager {
...
func (g GTLLVMConnectionManager) InitWithGPUNameWithTargetIndexBinaryPathWithGenWithSocketNameForNumClients(gPUName objectivec.IObject, index int32, path objectivec.IObject, gen byte, name objectivec.IObject, clients uint32) GTLLVMConnectionManager {
...
func (g GTLLVMConnectionManager) TargetIndex() int32 {
	rv := objc.SendIfResponds[int32](g.ID, objc.Sel("targetIndex"))
	return rv
}
