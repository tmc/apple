...
func (gc GTSPStringCacheClass) Alloc() GTSPStringCache {
	rv := objc.SendIfResponds[GTSPStringCache](objc.ID(gc.class), objc.Sel("alloc"))
	return rv
}
...
func (g GTSPStringCache) Init() GTSPStringCache {
	rv := objc.SendIfResponds[GTSPStringCache](g.ID, objc.Sel("init"))
	return rv
}

// Autorelease adds the receiver to the current autorelease pool.
func (g GTSPStringCache) Autorelease() GTSPStringCache {
	rv := objc.SendIfResponds[GTSPStringCache](g.ID, objc.Sel("autorelease"))
	return rv
}
...
func NewGTSPStringCache() GTSPStringCache {
	...
	rv := objc.SendIfResponds[GTSPStringCache](objc.ID(class.class), objc.Sel("new"))
	return rv
}
