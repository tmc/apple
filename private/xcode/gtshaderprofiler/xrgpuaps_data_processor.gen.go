...
//
// See: https://developer.apple.com/documentation/GTShaderProfiler/XRGPUAPSDataProcessor/setConfig:
func (x XRGPUAPSDataProcessor) SetConfig(config objectivec.IObject) {
	objc.Send[objc.ID](x.ID, objc.Sel("setConfig:"), config)
}
//
