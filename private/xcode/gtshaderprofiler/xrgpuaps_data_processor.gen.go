...
type IXRGPUAPSDataProcessor interface {
	...
	AddShaderMapDataVariant(data objectivec.IObject, variant int32)
	...
	GetAPSDerivedCounterDataTimestampsSampleCountCounterIndexCount(data float64, timestamps *uint64, index uint32, count2 uint32) (uint64, bool)
	GetAPSDerivedCounterDataAtUSCIndexBufferTimestampsSampleCountCounterIndexCount(uSCIndex uint32, buffer float64, timestamps *uint64, index uint32, count2 uint32) (uint64, bool)
	GetAPSRawCounterDataTimestampsSampleCountCounterIndexCount(data *uint64, timestamps *uint64, index uint32, count2 uint32) (uint64, bool)
	GetAPSRawCounterDataAtUSCIndexBufferTimestampsSampleCountCounterIndexCount(uSCIndex uint32, buffer *uint64, timestamps *uint64, index uint32, count2 uint32) (uint64, bool)
	GetBufferAtRDESourceIndexRdeBufferIndexBufferLength(index uint32, index2 uint32, buffer *int8) (uint64, bool)
	GetBufferAtUSCIndexBufferLength(uSCIndex uint32, buffer *int8) (uint64, bool)
	...
	GetRDEDerivedCounterAtSourceIndexBufferTimestampsSampleCountCounterIndexCount(index uint32, buffer float64, timestamps *uint64, index2 uint32, count2 uint32) (uint64, bool)
	GetRDEDerivedCounterAtSourceIndexRdeBufferIndexBufferTimestampsSampleCountCounterIndexCount(index uint32, index2 uint32, buffer float64, timestamps *uint64, index3 uint32, count2 uint32) (uint64, bool)
	GetRDERawCounterAtSourceIndexBufferTimestampsSampleCountCounterIndexCount(index uint32, buffer *uint64, timestamps *uint64, index2 uint32, count2 uint32) (uint64, bool)
	GetRDERawCounterAtSourceIndexRdeBufferIndexBufferTimestampsSampleCountCounterIndexCount(index uint32, index2 uint32, buffer *uint64, timestamps *uint64, index3 uint32, count2 uint32) (uint64, bool)
	GetShaderIdsKickTraceIdShaderIdsShaderPCsDataMastersCount(ids unsafe.Pointer, id uint32, ids2 *uint32, pCs *uint64, masters *uint32) (uint64, bool)
	GetShaderIdsShaderIdsShaderPCsDataMastersCount(ids uint32, ids2 *uint32, pCs *uint64, masters *uint32) (uint64, bool)
	GetShaderIdsAtUSCIndexKickTraceIdShaderIdsShaderPCsDataMastersCount(uSCIndex uint32, id uint32, ids *uint32, pCs *uint64, masters *uint32) (uint64, bool)
	...
	PidFromKickTraceId(id uint32) int32
	PulsePeriod() uint64
	...
	ShaderFromPCPidTimeUscIndex(pc uint64, pid int32, time uint64, index uint32) objectivec.IObject
...
func (x XRGPUAPSDataProcessor) _loadJSONShaderMap(map_ objectivec.IObject) {
	objc.SendIfResponds[objc.ID](x.ID, objc.Sel("_loadJSONShaderMap:"), map_)
}
...
func (x XRGPUAPSDataProcessor) _loadOSLogShaderMap(map_ objectivec.IObject) {
	objc.SendIfResponds[objc.ID](x.ID, objc.Sel("_loadOSLogShaderMap:"), map_)
}
...
func (x XRGPUAPSDataProcessor) _supportsDPBRMANCounter() bool {
	rv := objc.SendIfResponds[bool](x.ID, objc.Sel("_supportsDPBRMANCounter"))
	return rv
}
...
func (x XRGPUAPSDataProcessor) AddBufferAtRDESourceIndexRdeBufferIndexBufferLength(index uint32, index2 uint32, buffer string, length uint64) {
	objc.SendIfResponds[objc.ID](x.ID, objc.Sel("addBufferAtRDESourceIndex:rdeBufferIndex:buffer:length:"), index, index2, unsafe.Pointer(unsafe.StringData(buffer+"\x00")), length)
}
func (x XRGPUAPSDataProcessor) AddBufferAtUSCIndexBuffer(uSCIndex uint32, buffer objectivec.IObject) {
	objc.SendIfResponds[objc.ID](x.ID, objc.Sel("addBufferAtUSCIndex:buffer:"), uSCIndex, buffer)
}
func (x XRGPUAPSDataProcessor) AddBufferAtUSCIndexBufferLength(uSCIndex uint32, buffer string, length uint64) {
	objc.SendIfResponds[objc.ID](x.ID, objc.Sel("addBufferAtUSCIndex:buffer:length:"), uSCIndex, unsafe.Pointer(unsafe.StringData(buffer+"\x00")), length)
}
func (x XRGPUAPSDataProcessor) AddShaderMapDataVariant(data objectivec.IObject, variant int32) {
...
func (x XRGPUAPSDataProcessor) AggregateAPSCounters(aPSCounters uint64) bool {
	rv := objc.SendIfResponds[bool](x.ID, objc.Sel("aggregateAPSCounters:"), aPSCounters)
	return rv
}
func (x XRGPUAPSDataProcessor) AggregateRDESourceBuffer(buffer unsafe.Pointer) bool {
	rv := objc.SendIfResponds[bool](x.ID, objc.Sel("aggregateRDESourceBuffer:"), buffer)
	return rv
}
func (x XRGPUAPSDataProcessor) AggregateShaders() {
	objc.SendIfResponds[objc.ID](x.ID, objc.Sel("aggregateShaders"))
}
...
func (x XRGPUAPSDataProcessor) DeriveRDECountersCounterIndexesRawCounterIdsDerivedCounterIdsDeltaSecondsIndex(rDECounters unsafe.Pointer, indexes unsafe.Pointer, ids unsafe.Pointer, ids2 unsafe.Pointer, index uint64) bool {
	rv := objc.SendIfResponds[bool](x.ID, objc.Sel("deriveRDECounters:counterIndexes:rawCounterIds:derivedCounterIds:deltaSecondsIndex:"), rDECounters, indexes, ids, ids2, index)
	return rv
}
func (x XRGPUAPSDataProcessor) DeriveRDESourceBuffer(buffer unsafe.Pointer) bool {
	rv := objc.SendIfResponds[bool](x.ID, objc.Sel("deriveRDESourceBuffer:"), buffer)
	return rv
}
func (x XRGPUAPSDataProcessor) EnableUSCEnable(usc uint32, enable bool) {
	objc.SendIfResponds[objc.ID](x.ID, objc.Sel("enableUSC:enable:"), usc, enable)
}
func (x XRGPUAPSDataProcessor) EncodeRawData() objectivec.IObject {
	rv := objc.SendIfResponds[objc.ID](x.ID, objc.Sel("encodeRawData"))
	return objectivec.Object{ID: rv}
}
func (x XRGPUAPSDataProcessor) EnumerateShaders(shaders VoidHandler) {
	_block0, _ := NewVoidBlock(shaders)
	objc.SendIfResponds[objc.ID](x.ID, objc.Sel("enumerateShaders:"), _block0)
}
func (x XRGPUAPSDataProcessor) GetAPSDerivedCounterDataTimestampsSampleCountCounterIndexCount(data float64, timestamps *uint64, index uint32, count2 uint32) (uint64, bool) {
	var count uint64
	rv := objc.Send[bool](x.ID, objc.Sel("getAPSDerivedCounterData:timestamps:sampleCount:counterIndex:count:"), data, timestamps, unsafe.Pointer(&count), index, count2)
	return count, rv
}
func (x XRGPUAPSDataProcessor) GetAPSDerivedCounterDataAtUSCIndexBufferTimestampsSampleCountCounterIndexCount(uSCIndex uint32, buffer float64, timestamps *uint64, index uint32, count2 uint32) (uint64, bool) {
	var count uint64
	rv := objc.Send[bool](x.ID, objc.Sel("getAPSDerivedCounterDataAtUSCIndex:buffer:timestamps:sampleCount:counterIndex:count:"), uSCIndex, buffer, timestamps, unsafe.Pointer(&count), index, count2)
	return count, rv
}
func (x XRGPUAPSDataProcessor) GetAPSRawCounterDataTimestampsSampleCountCounterIndexCount(data *uint64, timestamps *uint64, index uint32, count2 uint32) (uint64, bool) {
	var count uint64
	rv := objc.Send[bool](x.ID, objc.Sel("getAPSRawCounterData:timestamps:sampleCount:counterIndex:count:"), data, timestamps, unsafe.Pointer(&count), index, count2)
	return count, rv
}
func (x XRGPUAPSDataProcessor) GetAPSRawCounterDataAtUSCIndexBufferTimestampsSampleCountCounterIndexCount(uSCIndex uint32, buffer *uint64, timestamps *uint64, index uint32, count2 uint32) (uint64, bool) {
	var count uint64
	rv := objc.Send[bool](x.ID, objc.Sel("getAPSRawCounterDataAtUSCIndex:buffer:timestamps:sampleCount:counterIndex:count:"), uSCIndex, buffer, timestamps, unsafe.Pointer(&count), index, count2)
	return count, rv
}
func (x XRGPUAPSDataProcessor) GetBufferAtRDESourceIndexRdeBufferIndexBufferLength(index uint32, index2 uint32, buffer *int8) (uint64, bool) {
	var length uint64
...
func (x XRGPUAPSDataProcessor) GetBufferAtUSCIndexBufferLength(uSCIndex uint32, buffer *int8) (uint64, bool) {
	var length uint64
...
func (x XRGPUAPSDataProcessor) GetProfileDataAtUSCIndex(uSCIndex uint64) uint64 {
	rv := objc.SendIfResponds[uint64](x.ID, objc.Sel("getProfileDataAtUSCIndex:"), uSCIndex)
	return rv
}
func (x XRGPUAPSDataProcessor) GetRDEDerivedCounterAtSourceIndexBufferTimestampsSampleCountCounterIndexCount(index uint32, buffer float64, timestamps *uint64, index2 uint32, count2 uint32) (uint64, bool) {
	var count uint64
	rv := objc.Send[bool](x.ID, objc.Sel("getRDEDerivedCounterAtSourceIndex:buffer:timestamps:sampleCount:counterIndex:count:"), index, buffer, timestamps, unsafe.Pointer(&count), index2, count2)
	return count, rv
}
func (x XRGPUAPSDataProcessor) GetRDEDerivedCounterAtSourceIndexRdeBufferIndexBufferTimestampsSampleCountCounterIndexCount(index uint32, index2 uint32, buffer float64, timestamps *uint64, index3 uint32, count2 uint32) (uint64, bool) {
	var count uint64
	rv := objc.Send[bool](x.ID, objc.Sel("getRDEDerivedCounterAtSourceIndex:rdeBufferIndex:buffer:timestamps:sampleCount:counterIndex:count:"), index, index2, buffer, timestamps, unsafe.Pointer(&count), index3, count2)
	return count, rv
}
func (x XRGPUAPSDataProcessor) GetRDERawCounterAtSourceIndexBufferTimestampsSampleCountCounterIndexCount(index uint32, buffer *uint64, timestamps *uint64, index2 uint32, count2 uint32) (uint64, bool) {
	var count uint64
	rv := objc.Send[bool](x.ID, objc.Sel("getRDERawCounterAtSourceIndex:buffer:timestamps:sampleCount:counterIndex:count:"), index, buffer, timestamps, unsafe.Pointer(&count), index2, count2)
	return count, rv
}
func (x XRGPUAPSDataProcessor) GetRDERawCounterAtSourceIndexRdeBufferIndexBufferTimestampsSampleCountCounterIndexCount(index uint32, index2 uint32, buffer *uint64, timestamps *uint64, index3 uint32, count2 uint32) (uint64, bool) {
	var count uint64
	rv := objc.Send[bool](x.ID, objc.Sel("getRDERawCounterAtSourceIndex:rdeBufferIndex:buffer:timestamps:sampleCount:counterIndex:count:"), index, index2, buffer, timestamps, unsafe.Pointer(&count), index3, count2)
	return count, rv
}
func (x XRGPUAPSDataProcessor) GetShaderIdsKickTraceIdShaderIdsShaderPCsDataMastersCount(ids unsafe.Pointer, id uint32, ids2 *uint32, pCs *uint64, masters *uint32) (uint64, bool) {
	var count uint64
	rv := objc.Send[bool](x.ID, objc.Sel("getShaderIds:kickTraceId:shaderIds:shaderPCs:dataMasters:count:"), ids, id, ids2, pCs, masters, unsafe.Pointer(&count))
	return count, rv
}
func (x XRGPUAPSDataProcessor) GetShaderIdsShaderIdsShaderPCsDataMastersCount(ids uint32, ids2 *uint32, pCs *uint64, masters *uint32) (uint64, bool) {
	var count uint64
	rv := objc.Send[bool](x.ID, objc.Sel("getShaderIds:shaderIds:shaderPCs:dataMasters:count:"), ids, ids2, pCs, masters, unsafe.Pointer(&count))
	return count, rv
}
func (x XRGPUAPSDataProcessor) GetShaderIdsAtUSCIndexKickTraceIdShaderIdsShaderPCsDataMastersCount(uSCIndex uint32, id uint32, ids *uint32, pCs *uint64, masters *uint32) (uint64, bool) {
	var count uint64
	rv := objc.Send[bool](x.ID, objc.Sel("getShaderIdsAtUSCIndex:kickTraceId:shaderIds:shaderPCs:dataMasters:count:"), uSCIndex, id, ids, pCs, masters, unsafe.Pointer(&count))
	return count, rv
}
...
func (x XRGPUAPSDataProcessor) IsUSCEnabled(uSCEnabled uint32) bool {
	rv := objc.SendIfResponds[bool](x.ID, objc.Sel("isUSCEnabled:"), uSCEnabled)
	return rv
}
func (x XRGPUAPSDataProcessor) IsValidUSC(usc uint32) bool {
	rv := objc.SendIfResponds[bool](x.ID, objc.Sel("isValidUSC:"), usc)
	return rv
}
...
func (x XRGPUAPSDataProcessor) LoadRDECounters(rDECounters unsafe.Pointer) bool {
	rv := objc.SendIfResponds[bool](x.ID, objc.Sel("loadRDECounters:"), rDECounters)
	return rv
}
func (x XRGPUAPSDataProcessor) LoadShaders() bool {
	rv := objc.SendIfResponds[bool](x.ID, objc.Sel("loadShaders"))
	return rv
}
func (x XRGPUAPSDataProcessor) LoadShadersUscIndex(shaders unsafe.Pointer, index uint32) bool {
	rv := objc.SendIfResponds[bool](x.ID, objc.Sel("loadShaders:uscIndex:"), shaders, index)
	return rv
}
func (x XRGPUAPSDataProcessor) NumRDEBuffersAtSourceIndex(index uint32) uint32 {
	rv := objc.SendIfResponds[uint32](x.ID, objc.Sel("numRDEBuffersAtSourceIndex:"), index)
	return rv
}
func (x XRGPUAPSDataProcessor) ParseData() bool {
	rv := objc.SendIfResponds[bool](x.ID, objc.Sel("parseData"))
	return rv
}
func (x XRGPUAPSDataProcessor) ParseDataLengthUscIndex(data string, length uint64, index uint32) bool {
	rv := objc.SendIfResponds[bool](x.ID, objc.Sel("parseData:length:uscIndex:"), unsafe.Pointer(unsafe.StringData(data+"\x00")), length, index)
	return rv
}
func (x XRGPUAPSDataProcessor) PidFromKickTraceId(id uint32) int32 {
	rv := objc.SendIfResponds[int32](x.ID, objc.Sel("pidFromKickTraceId:"), id)
	return rv
}
func (x XRGPUAPSDataProcessor) RdeDerivedCountersAtSourceIndex(index uint32) objectivec.IObject {
	rv := objc.SendIfResponds[objc.ID](x.ID, objc.Sel("rdeDerivedCountersAtSourceIndex:"), index)
	return objectivec.Object{ID: rv}
}
func (x XRGPUAPSDataProcessor) RdeRawCounterNamesAtSourceIndex(index uint32) objectivec.IObject {
	rv := objc.SendIfResponds[objc.ID](x.ID, objc.Sel("rdeRawCounterNamesAtSourceIndex:"), index)
	return objectivec.Object{ID: rv}
}
func (x XRGPUAPSDataProcessor) ShaderFromId(id uint32) objectivec.IObject {
	rv := objc.SendIfResponds[objc.ID](x.ID, objc.Sel("shaderFromId:"), id)
	return objectivec.Object{ID: rv}
}
func (x XRGPUAPSDataProcessor) ShaderFromPCPidTimeUscIndex(pc uint64, pid int32, time uint64, index uint32) objectivec.IObject {
	rv := objc.SendIfResponds[objc.ID](x.ID, objc.Sel("shaderFromPC:pid:time:uscIndex:"), pc, pid, time, index)
	return objectivec.Object{ID: rv}
}
func (x XRGPUAPSDataProcessor) TimestampRefToNsUscTimeIndexUscIndex(ns uint64, index uint64, index2 uint32) uint64 {
	rv := objc.SendIfResponds[uint64](x.ID, objc.Sel("timestampRefToNs:uscTimeIndex:uscIndex:"), ns, index, index2)
	return rv
}
func (x XRGPUAPSDataProcessor) TimestampRefsToNsCountResultUscIndex(ns unsafe.Pointer, count uint64, result *uint64, index uint32) {
	objc.SendIfResponds[objc.ID](x.ID, objc.Sel("timestampRefsToNs:count:result:uscIndex:"), objc.CArray(ns), count, result, index)
}
...
func (x XRGPUAPSDataProcessor) AllShaders() foundation.INSArray {
	rv := objc.SendIfResponds[objc.ID](x.ID, objc.Sel("allShaders"))
	return foundation.NSArrayFromID(objc.ID(rv))
}
func (x XRGPUAPSDataProcessor) ApsDerivedCounters() foundation.INSArray {
	rv := objc.SendIfResponds[objc.ID](x.ID, objc.Sel("apsDerivedCounters"))
	return foundation.NSArrayFromID(objc.ID(rv))
}
...
func (x XRGPUAPSDataProcessor) Delegate() unsafe.Pointer {
	rv := objc.SendIfResponds[unsafe.Pointer](x.ID, objc.Sel("delegate"))
	return rv
}
func (x XRGPUAPSDataProcessor) SetDelegate(value unsafe.Pointer) {
	objc.SendIfResponds[struct{}](x.ID, objc.Sel("setDelegate:"), value)
}
func (x XRGPUAPSDataProcessor) FirstAPSTimestamp() uint64 {
	rv := objc.SendIfResponds[uint64](x.ID, objc.Sel("firstAPSTimestamp"))
	return rv
}
func (x XRGPUAPSDataProcessor) FirstRDETimestamp() uint64 {
	rv := objc.SendIfResponds[uint64](x.ID, objc.Sel("firstRDETimestamp"))
	return rv
}
func (x XRGPUAPSDataProcessor) LastAPSTimestamp() uint64 {
	rv := objc.SendIfResponds[uint64](x.ID, objc.Sel("lastAPSTimestamp"))
	return rv
}
func (x XRGPUAPSDataProcessor) LastRDETimestamp() uint64 {
	rv := objc.SendIfResponds[uint64](x.ID, objc.Sel("lastRDETimestamp"))
	return rv
}
func (x XRGPUAPSDataProcessor) NumAPSDerivedCounters() uint32 {
	rv := objc.SendIfResponds[uint32](x.ID, objc.Sel("numAPSDerivedCounters"))
	return rv
}
func (x XRGPUAPSDataProcessor) NumAPSRawCounters() uint32 {
	rv := objc.SendIfResponds[uint32](x.ID, objc.Sel("numAPSRawCounters"))
	return rv
}
func (x XRGPUAPSDataProcessor) NumRDESources() uint32 {
	rv := objc.SendIfResponds[uint32](x.ID, objc.Sel("numRDESources"))
	return rv
}
func (x XRGPUAPSDataProcessor) NumUSCs() uint32 {
	rv := objc.SendIfResponds[uint32](x.ID, objc.Sel("numUSCs"))
	return rv
}
func (x XRGPUAPSDataProcessor) NumValidUSCs() uint32 {
	rv := objc.SendIfResponds[uint32](x.ID, objc.Sel("numValidUSCs"))
	return rv
}
func (x XRGPUAPSDataProcessor) PulsePeriod() uint64 {
	rv := objc.SendIfResponds[uint64](x.ID, objc.Sel("pulsePeriod"))
	return rv
}
func (x XRGPUAPSDataProcessor) SampleInterval() uint64 {
	rv := objc.SendIfResponds[uint64](x.ID, objc.Sel("sampleInterval"))
	return rv
}
