...
// # Return Value
//
// true if the layer contents are implicitly flipped when rendered or false if
// they are not. This method returns false by default.
//
// # Discussion
//
...
// # Discussion
//
// Subclasses can override this method and return true if the layer should be
// redisplayed when the value of the specified attribute changes. Animations
// changing the value of the attribute also trigger redisplay.
//
...
// # Discussion
//
// If you subclass [CALayer], you may override this method and use it to
// provide an instance of your specific subclass.
//
// See: https://developer.apple.com/documentation/QuartzCore/CALayer/layer
func (_CALayerClass CALayerClass) Layer() CALayer {
	rv := objc.Send[objc.ID](objc.ID(_CALayerClass.class), objc.Sel("layer"))
	return CALayerFromID(rv)
}
...
// # Discussion
//
// When the value in this property is false, the layer hides its content when
...
// value is true for apps linked against the iOS 7 SDK or later and false for
// apps linked against an earlier SDK.
//
...
// the value of this property to true, you must fill the layer’s bounds with
// opaque content.
//
...
// prior to compositing if certain features of the compositing model (such as
// the inclusion of filters) require it.
//
// The default value of this property is false.
//
...
func (l CALayer) ToneMapMode() CAToneMapMode {
	rv := objc.Send[objc.ID](l.ID, objc.Sel("toneMapMode"))
	return CAToneMapMode(foundation.NSStringFromID(rv).String())
}
func (l CALayer) SetToneMapMode(value CAToneMapMode) {
	objc.Send[struct{}](l.ID, objc.Sel("setToneMapMode:"), objc.String(string(value)))
}
...
//
// [greatestFiniteMagnitude]: https://developer.apple.com/documentation/Swift/Float/greatestFiniteMagnitude
func (o CALayer) SetRepeatCount(value float32) {
...
//
// See: https://developer.apple.com/documentation/QuartzCore/CAMediaTiming/speed
func (o CALayer) SetSpeed(value float32) {
...
//
// See: https://developer.apple.com/documentation/QuartzCore/CAMediaTiming/autoreverses
func (o CALayer) SetAutoreverses(value bool) {
...
func (o CALayer) SetFillMode(value CAMediaTimingFillMode) {
