...
// burdening the CPU or slowing down your app. Core Animation does most of the
// work of drawing each frame of an animation for you. You’re responsible
// for configuring the animation parameters, such as the start and end points,
// and Core Animation does the rest. It accelerates the rendering by handing
// over most of the work to dedicated graphics hardware. For more details, see
...
//   - [CAMetalDisplayLinkUpdate]: Stores information about a single update from a Metal display link instance.
