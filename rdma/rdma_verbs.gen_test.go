...
func TestRDMAExtraStructLayouts(t *testing.T) {
	tests := []struct {
		...
		{"IbvPortAttr.State", unsafe.Offsetof(IbvPortAttr{}.State), 0},
		{"IbvPortAttr.MaxMTU", unsafe.Offsetof(IbvPortAttr{}.MaxMTU), 4},
		...
		{"IbvPortAttr.PortCapFlags", unsafe.Offsetof(IbvPortAttr{}.PortCapFlags), 16},
		{"IbvPortAttr.MaxMsgSz", unsafe.Offsetof(IbvPortAttr{}.MaxMsgSz), 20},
		{"IbvPortAttr.PKeyTblLen", unsafe.Offsetof(IbvPortAttr{}.PKeyTblLen), 32},
		{"IbvPortAttr.LID", unsafe.Offsetof(IbvPortAttr{}.LID), 34},
		{"IbvPortAttr.SMLID", unsafe.Offsetof(IbvPortAttr{}.SMLID), 36},
		{"IbvPortAttr.ActiveWidth", unsafe.Offsetof(IbvPortAttr{}.ActiveWidth), 43},
		{"IbvPortAttr.ActiveSpeed", unsafe.Offsetof(IbvPortAttr{}.ActiveSpeed), 44},
		{"IbvPortAttr.PhysState", unsafe.Offsetof(IbvPortAttr{}.PhysState), 45},
		{"IbvPortAttr.LinkLayer", unsafe.Offsetof(IbvPortAttr{}.LinkLayer), 46},
		{"IbvPortAttr.Flags", unsafe.Offsetof(IbvPortAttr{}.Flags), 47},
		{"IbvPortAttr.PortCapFlags2", unsafe.Offsetof(IbvPortAttr{}.PortCapFlags2), 48},
		{"ibv_context.ops", 8, 8},
