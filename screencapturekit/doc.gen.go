...
//
// Use the ScreenCaptureKit framework to add support for high-performance
// frame capture of screen and audio content to your Mac app. The framework
// gives you fine-grained control to select and stream only the content that
// you want to capture. As a stream captures new video frames and audio
// samples, it passes them to your app as [CMSampleBufferRef] objects that
// contain the media data and its related metadata. ScreenCaptureKit also
// provides a macOS-integrated picker for streaming selection and management,
