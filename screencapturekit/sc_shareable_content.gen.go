...
func (sc SCShareableContentClass) Class() objc.Class {
	return sc.class
}
...
_block0, _ := NewSCShareableContentErrorBlock(completionHandler)
...
_block2, _ := NewSCShareableContentErrorBlock(completionHandler)
