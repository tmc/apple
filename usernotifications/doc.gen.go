...
//
// Push user-facing notifications to the user’s device from a server, or
// generate them locally from your app.
//
// User-facing notifications communicate important information to users of
// your app, regardless of whether your app is running on the user’s device.
// For example, a sports app can let the user know when their favorite team
// scores. Notifications can also tell your app to download information and
// update its interface. Notifications can display an alert, play a sound, or
// badge the app’s icon.
//
// # Essentials
//
