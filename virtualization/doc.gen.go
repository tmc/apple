...
// computers. Use this framework to boot and run macOS or Linux-based
// operating systems in custom environments that you define. The framework
// supports the Virtual I/O Device (VIRTIO) specification, which defines
// standard interfaces for many device types, including network, socket,
...
//   - [VZMacGraphicsDisplayConfiguration] - The configuration for a Mac graphics device.
