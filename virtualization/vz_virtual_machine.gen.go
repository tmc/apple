...
// # Discussion
//
// Call this method to start a VM that’s in the
// [VZVirtualMachineStateStopped] or [VZVirtualMachineStateError] state.
//
...
// trying to restore isn’t in the [VZVirtualMachineStateStopped] state.
//
