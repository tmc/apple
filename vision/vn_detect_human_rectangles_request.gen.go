...
func (vc VNDetectHumanRectanglesRequestClass) Class() objc.Class {
	return vc.class
}
...
func NewDetectHumanRectanglesRequestWithCompletionHandler(completionHandler VNRequestErrorHandler) VNDetectHumanRectanglesRequest {
