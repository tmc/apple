...
func (vc VNImageBasedRequestClass) Class() objc.Class {
	return vc.class
}
...
func NewImageBasedRequestWithCompletionHandler(completionHandler VNRequestErrorHandler) VNImageBasedRequest {
