...
func NewImageRegistrationRequestWithCompletionHandler(completionHandler VNRequestErrorHandler) VNImageRegistrationRequest {
...
func NewImageRegistrationRequestWithTargetedCGImageOptionsCompletionHandler(cgImage coregraphics.CGImageRef, options foundation.INSDictionary, completionHandler VNRequestErrorHandler) VNImageRegistrationRequest {
...
func NewImageRegistrationRequestWithTargetedCGImageOrientationOptions(cgImage coregraphics.CGImageRef, orientation imageio.CGImagePropertyOrientation, options foundation.INSDictionary) VNImageRegistrationRequest {
	instance := getVNImageRegistrationRequestClass().Alloc()
...
//
// [kCGImagePropertyOrientation]: https://developer.apple.com/documentation/ImageIO/kCGImagePropertyOrientation
func NewImageRegistrationRequestWithTargetedCGImageOrientationOptionsCompletionHandler(cgImage coregraphics.CGImageRef, orientation imageio.CGImagePropertyOrientation, options foundation.INSDictionary, completionHandler VNRequestErrorHandler) VNImageRegistrationRequest {
...
//
// [CIImage]: https://developer.apple.com/documentation/CoreImage/CIImage
func NewImageRegistrationRequestWithTargetedCIImageOptionsCompletionHandler(ciImage *coreimage.CIImage, options foundation.INSDictionary, completionHandler VNRequestErrorHandler) VNImageRegistrationRequest {
	_block2, _ := NewVNRequestErrorBlock(completionHandler)
	instance := getVNImageRegistrationRequestClass().Alloc()
...
// [CIImage]: https://developer.apple.com/documentation/CoreImage/CIImage
// [kCGImagePropertyOrientation]: https://developer.apple.com/documentation/ImageIO/kCGImagePropertyOrientation
func NewImageRegistrationRequestWithTargetedCIImageOrientationOptions(ciImage *coreimage.CIImage, orientation imageio.CGImagePropertyOrientation, options foundation.INSDictionary) VNImageRegistrationRequest {
	instance := getVNImageRegistrationRequestClass().Alloc()
...
// [CIImage]: https://developer.apple.com/documentation/CoreImage/CIImage
// [kCGImagePropertyOrientation]: https://developer.apple.com/documentation/ImageIO/kCGImagePropertyOrientation
func NewImageRegistrationRequestWithTargetedCIImageOrientationOptionsCompletionHandler(ciImage *coreimage.CIImage, orientation imageio.CGImagePropertyOrientation, options foundation.INSDictionary, completionHandler VNRequestErrorHandler) VNImageRegistrationRequest {
	_block3, _ := NewVNRequestErrorBlock(completionHandler)
	instance := getVNImageRegistrationRequestClass().Alloc()
...
func NewImageRegistrationRequestWithTargetedCMSampleBufferOptions(sampleBuffer coremedia.CMSampleBufferRef, options foundation.INSDictionary) VNImageRegistrationRequest {
	instance := getVNImageRegistrationRequestClass().Alloc()
...
//
// [imageBuffer]: https://developer.apple.com/documentation/CoreMedia/CMSampleBuffer/imageBuffer
func NewImageRegistrationRequestWithTargetedCMSampleBufferOptionsCompletionHandler(sampleBuffer coremedia.CMSampleBufferRef, options foundation.INSDictionary, completionHandler VNRequestErrorHandler) VNImageRegistrationRequest {
	_block2, _ := NewVNRequestErrorBlock(completionHandler)
	instance := getVNImageRegistrationRequestClass().Alloc()
...
func NewImageRegistrationRequestWithTargetedCMSampleBufferOrientationOptions(sampleBuffer coremedia.CMSampleBufferRef, orientation imageio.CGImagePropertyOrientation, options foundation.INSDictionary) VNImageRegistrationRequest {
	instance := getVNImageRegistrationRequestClass().Alloc()
...
// [imageBuffer]: https://developer.apple.com/documentation/CoreMedia/CMSampleBuffer/imageBuffer
// [CGImagePropertyOrientation]: https://developer.apple.com/documentation/ImageIO/CGImagePropertyOrientation
func NewImageRegistrationRequestWithTargetedCMSampleBufferOrientationOptionsCompletionHandler(sampleBuffer coremedia.CMSampleBufferRef, orientation imageio.CGImagePropertyOrientation, options foundation.INSDictionary, completionHandler VNRequestErrorHandler) VNImageRegistrationRequest {
	_block3, _ := NewVNRequestErrorBlock(completionHandler)
	instance := getVNImageRegistrationRequestClass().Alloc()
...
func NewImageRegistrationRequestWithTargetedCVPixelBufferOptionsCompletionHandler(pixelBuffer corevideo.CVImageBufferRef, options foundation.INSDictionary, completionHandler VNRequestErrorHandler) VNImageRegistrationRequest {
	_block2, _ := NewVNRequestErrorBlock(completionHandler)
	instance := getVNImageRegistrationRequestClass().Alloc()
...
//
// [kCGImagePropertyOrientation]: https://developer.apple.com/documentation/ImageIO/kCGImagePropertyOrientation
func NewImageRegistrationRequestWithTargetedCVPixelBufferOrientationOptions(pixelBuffer corevideo.CVImageBufferRef, orientation imageio.CGImagePropertyOrientation, options foundation.INSDictionary) VNImageRegistrationRequest {
	instance := getVNImageRegistrationRequestClass().Alloc()
...
//
// [kCGImagePropertyOrientation]: https://developer.apple.com/documentation/ImageIO/kCGImagePropertyOrientation
func NewImageRegistrationRequestWithTargetedCVPixelBufferOrientationOptionsCompletionHandler(pixelBuffer corevideo.CVImageBufferRef, orientation imageio.CGImagePropertyOrientation, options foundation.INSDictionary, completionHandler VNRequestErrorHandler) VNImageRegistrationRequest {
	_block3, _ := NewVNRequestErrorBlock(completionHandler)
	instance := getVNImageRegistrationRequestClass().Alloc()
...
func NewImageRegistrationRequestWithTargetedImageDataOptions(imageData foundation.NSData, options foundation.INSDictionary) VNImageRegistrationRequest {
	instance := getVNImageRegistrationRequestClass().Alloc()
...
func NewImageRegistrationRequestWithTargetedImageDataOptionsCompletionHandler(imageData foundation.NSData, options foundation.INSDictionary, completionHandler VNRequestErrorHandler) VNImageRegistrationRequest {
	_block2, _ := NewVNRequestErrorBlock(completionHandler)
	instance := getVNImageRegistrationRequestClass().Alloc()
...
//
// [kCGImagePropertyOrientation]: https://developer.apple.com/documentation/ImageIO/kCGImagePropertyOrientation
func NewImageRegistrationRequestWithTargetedImageDataOrientationOptions(imageData foundation.NSData, orientation imageio.CGImagePropertyOrientation, options foundation.INSDictionary) VNImageRegistrationRequest {
	instance := getVNImageRegistrationRequestClass().Alloc()
...
//
// [kCGImagePropertyOrientation]: https://developer.apple.com/documentation/ImageIO/kCGImagePropertyOrientation
func NewImageRegistrationRequestWithTargetedImageDataOrientationOptionsCompletionHandler(imageData foundation.NSData, orientation imageio.CGImagePropertyOrientation, options foundation.INSDictionary, completionHandler VNRequestErrorHandler) VNImageRegistrationRequest {
	_block3, _ := NewVNRequestErrorBlock(completionHandler)
	instance := getVNImageRegistrationRequestClass().Alloc()
...
func NewImageRegistrationRequestWithTargetedImageURLOptions(imageURL foundation.NSURL, options foundation.INSDictionary) VNImageRegistrationRequest {
	instance := getVNImageRegistrationRequestClass().Alloc()
...
func NewImageRegistrationRequestWithTargetedImageURLOptionsCompletionHandler(imageURL foundation.NSURL, options foundation.INSDictionary, completionHandler VNRequestErrorHandler) VNImageRegistrationRequest {
	_block2, _ := NewVNRequestErrorBlock(completionHandler)
	instance := getVNImageRegistrationRequestClass().Alloc()
...
//
// [kCGImagePropertyOrientation]: https://developer.apple.com/documentation/ImageIO/kCGImagePropertyOrientation
func NewImageRegistrationRequestWithTargetedImageURLOrientationOptions(imageURL foundation.NSURL, orientation imageio.CGImagePropertyOrientation, options foundation.INSDictionary) VNImageRegistrationRequest {
	instance := getVNImageRegistrationRequestClass().Alloc()
...
//
// [kCGImagePropertyOrientation]: https://developer.apple.com/documentation/ImageIO/kCGImagePropertyOrientation
func NewImageRegistrationRequestWithTargetedImageURLOrientationOptionsCompletionHandler(imageURL foundation.NSURL, orientation imageio.CGImagePropertyOrientation, options foundation.INSDictionary, completionHandler VNRequestErrorHandler) VNImageRegistrationRequest {
	_block3, _ := NewVNRequestErrorBlock(completionHandler)
	instance := getVNImageRegistrationRequestClass().Alloc()
