...
func NewRecognizedObjectObservationWithCoder(coder foundation.INSCoder) VNRecognizedObjectObservation {
	instance := getVNRecognizedObjectObservationClass().Alloc()
