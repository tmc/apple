...
var _vmnet_copy_shared_interface_list func() xpc.Xpc_object_t
var _vmnet_copy_shared_interface_listErr error

func tryVmnet_copy_shared_interface_list() (xpc.Xpc_object_t, error) {
	if _vmnet_copy_shared_interface_list == nil {
		return *new(xpc.Xpc_object_t), symbolCallError("vmnet_copy_shared_interface_list", "10.15", _vmnet_copy_shared_interface_listErr)
	}
...
func Vmnet_copy_shared_interface_list() xpc.Xpc_object_t {
...
func tryVmnet_interface_add_ip_port_forwarding_rule(interface_ Interface_ref, protocol_ uint8, external_port uint16, address_family uint8, internal_address unsafe.Pointer, internal_port uint16, handler Vmnet_interface_completion_handler_t) (Vmnet_return_t, error) {
	...
	_block0Value := objc.NewBlock(func(_ objc.Block, blockArg0 Vmnet_return_t) { handler(blockArg0) })
...
var _vmnet_interface_add_port_forwarding_rule func(interface_ Interface_ref, protocol_ uint8, external_port uint16, internal_address kernel.In_addr, internal_port uint16, handler unsafe.Pointer) Vmnet_return_t
var _vmnet_interface_add_port_forwarding_ruleErr error

func tryVmnet_interface_add_port_forwarding_rule(interface_ Interface_ref, protocol_ uint8, external_port uint16, internal_address kernel.In_addr, internal_port uint16, handler Vmnet_interface_completion_handler_t) (Vmnet_return_t, error) {
...
func Vmnet_interface_add_port_forwarding_rule(interface_ Interface_ref, protocol_ uint8, external_port uint16, internal_address kernel.In_addr, internal_port uint16, handler Vmnet_interface_completion_handler_t) Vmnet_return_t {
...
var _vmnet_interface_get_ip_port_forwarding_rules func(interface_ Interface_ref, address_family uint8, handler unsafe.Pointer) Vmnet_return_t
var _vmnet_interface_get_ip_port_forwarding_rulesErr error

func tryVmnet_interface_get_ip_port_forwarding_rules(interface_ Interface_ref, address_family uint8, handler Vmnet_interface_get_ip_port_forwarding_rules_handler_t) (Vmnet_return_t, error) {
...
func Vmnet_interface_get_ip_port_forwarding_rules(interface_ Interface_ref, address_family uint8, handler Vmnet_interface_get_ip_port_forwarding_rules_handler_t) Vmnet_return_t {
...
var _vmnet_interface_start_with_network func(network Vmnet_network_ref, interface_desc xpc.Xpc_object_t, queue uintptr, start_block unsafe.Pointer) Interface_ref
var _vmnet_interface_start_with_networkErr error

func tryVmnet_interface_start_with_network(network Vmnet_network_ref, interface_desc xpc.Xpc_object_t, queue dispatch.Queue, start_block Vmnet_start_interface_completion_handler_t) (Interface_ref, error) {
...
func Vmnet_interface_start_with_network(network Vmnet_network_ref, interface_desc xpc.Xpc_object_t, queue dispatch.Queue, start_block Vmnet_start_interface_completion_handler_t) Interface_ref {
...
var _vmnet_ip_port_forwarding_rule_get_details func(rule xpc.Xpc_object_t, protocol_ *byte, external_port *uint16, address_family uint8, internal_address unsafe.Pointer, internal_port *uint16) Vmnet_return_t
var _vmnet_ip_port_forwarding_rule_get_detailsErr error

func tryVmnet_ip_port_forwarding_rule_get_details(rule xpc.Xpc_object_t, protocol_ []byte, external_port *uint16, address_family uint8, internal_address unsafe.Pointer, internal_port *uint16) (Vmnet_return_t, error) {
...
func Vmnet_ip_port_forwarding_rule_get_details(rule xpc.Xpc_object_t, protocol_ []byte, external_port *uint16, address_family uint8, internal_address unsafe.Pointer, internal_port *uint16) Vmnet_return_t {
...
var _vmnet_network_configuration_add_dhcp_reservation func(config Vmnet_network_configuration_ref, client *[6]byte, reservation *kernel.InAddr) Vmnet_return_t
var _vmnet_network_configuration_add_dhcp_reservationErr error

func tryVmnet_network_configuration_add_dhcp_reservation(config Vmnet_network_configuration_ref, client *[6]byte, reservation *kernel.InAddr) (Vmnet_return_t, error) {
...
func Vmnet_network_configuration_add_dhcp_reservation(config Vmnet_network_configuration_ref, client *[6]byte, reservation *kernel.InAddr) Vmnet_return_t {
...
var _vmnet_network_configuration_set_ipv4_subnet func(config Vmnet_network_configuration_ref, subnet_addr *kernel.InAddr, subnet_mask *kernel.InAddr) Vmnet_return_t
var _vmnet_network_configuration_set_ipv4_subnetErr error

func tryVmnet_network_configuration_set_ipv4_subnet(config Vmnet_network_configuration_ref, subnet_addr *kernel.InAddr, subnet_mask *kernel.InAddr) (Vmnet_return_t, error) {
...
func Vmnet_network_configuration_set_ipv4_subnet(config Vmnet_network_configuration_ref, subnet_addr *kernel.InAddr, subnet_mask *kernel.InAddr) Vmnet_return_t {
...
var _vmnet_network_copy_serialization func(network Vmnet_network_ref, status *Vmnet_return_t) xpc.Xpc_object_t
var _vmnet_network_copy_serializationErr error

func tryVmnet_network_copy_serialization(network Vmnet_network_ref, status *Vmnet_return_t) (xpc.Xpc_object_t, error) {
	if _vmnet_network_copy_serialization == nil {
		return *new(xpc.Xpc_object_t), symbolCallError("vmnet_network_copy_serialization", "26.0", _vmnet_network_copy_serializationErr)
	}
...
func Vmnet_network_copy_serialization(network Vmnet_network_ref, status *Vmnet_return_t) xpc.Xpc_object_t {
...
var _vmnet_network_create_with_serialization func(network xpc.Xpc_object_t, status *Vmnet_return_t) Vmnet_network_ref
var _vmnet_network_create_with_serializationErr error

func tryVmnet_network_create_with_serialization(network xpc.Xpc_object_t, status *Vmnet_return_t) (Vmnet_network_ref, error) {
...
func Vmnet_network_create_with_serialization(network xpc.Xpc_object_t, status *Vmnet_return_t) Vmnet_network_ref {
...
var _vmnet_network_get_ipv4_subnet func(network Vmnet_network_ref, subnet *kernel.InAddr, mask *kernel.InAddr)
var _vmnet_network_get_ipv4_subnetErr error

func tryVmnet_network_get_ipv4_subnet(network Vmnet_network_ref, subnet *kernel.InAddr, mask *kernel.InAddr) error {
...
func Vmnet_network_get_ipv4_subnet(network Vmnet_network_ref, subnet *kernel.InAddr, mask *kernel.InAddr) {
...
var _vmnet_port_forwarding_rule_get_details func(rule xpc.Xpc_object_t, protocol_ *byte, external_port *uint16, internal_address *kernel.InAddr, internal_port *uint16) Vmnet_return_t
var _vmnet_port_forwarding_rule_get_detailsErr error

func tryVmnet_port_forwarding_rule_get_details(rule xpc.Xpc_object_t, protocol_ []byte, external_port *uint16, internal_address *kernel.InAddr, internal_port *uint16) (Vmnet_return_t, error) {
...
func Vmnet_port_forwarding_rule_get_details(rule xpc.Xpc_object_t, protocol_ []byte, external_port *uint16, internal_address *kernel.InAddr, internal_port *uint16) Vmnet_return_t {
...
var _vmnet_read func(interface_ Interface_ref, packets *Vmpktdesc, pktcnt *int32) Vmnet_return_t
var _vmnet_readErr error

func tryVmnet_read(interface_ Interface_ref, packets *Vmpktdesc, pktcnt *int32) (Vmnet_return_t, error) {
	if _vmnet_read == nil {
		return *new(Vmnet_return_t), symbolCallError("vmnet_read", "10.10", _vmnet_readErr)
	}
	return _vmnet_read(interface_, packets, pktcnt), nil
}
...
func Vmnet_read(interface_ Interface_ref, packets *Vmpktdesc, pktcnt *int32) Vmnet_return_t {
...
var _vmnet_start_interface func(interface_desc xpc.Xpc_object_t, queue uintptr, handler unsafe.Pointer) Interface_ref
var _vmnet_start_interfaceErr error

func tryVmnet_start_interface(interface_desc xpc.Xpc_object_t, queue dispatch.Queue, handler Vmnet_start_interface_completion_handler_t) (Interface_ref, error) {
...
func Vmnet_start_interface(interface_desc xpc.Xpc_object_t, queue dispatch.Queue, handler Vmnet_start_interface_completion_handler_t) Interface_ref {
...
var _vmnet_write func(interface_ Interface_ref, packets *Vmpktdesc, pktcnt *int32) Vmnet_return_t
var _vmnet_writeErr error

func tryVmnet_write(interface_ Interface_ref, packets *Vmpktdesc, pktcnt *int32) (Vmnet_return_t, error) {
	if _vmnet_write == nil {
		return *new(Vmnet_return_t), symbolCallError("vmnet_write", "10.10", _vmnet_writeErr)
	}
	return _vmnet_write(interface_, packets, pktcnt), nil
}
...
func Vmnet_write(interface_ Interface_ref, packets *Vmpktdesc, pktcnt *int32) Vmnet_return_t {
