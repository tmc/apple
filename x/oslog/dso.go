...
// _os_log_impl. In C this is &__dso_handle, the header of the calling image;
// there is none in a purego build, so the main executable's header from
// _dyld_get_image_header(0) is used, which the logging system accepts.
var (
	dsoOnce   sync.Once
