...
var rawReachUnresolved = []rawReachEdge{
	{Entry: "(RichError).Error", File: "xpc.highlevel.gen.go", Line: 266, Expr: "e.cause.Error(...)", Kind: "unresolvable receiver expression"},
	{Entry: "NewSharedMemory", File: "xpc.highlevel.gen.go", Line: 185, Expr: "m.Close(...)", Kind: "unresolved receiver type"},
	{Entry: "decodeJSONPayload", File: "xpc.highlevel.gen.go", Line: 751, Expr: "dec.Decode(...)", Kind: "unresolved receiver type"},
	{Entry: "mapShared", File: "xpc.highlevel.gen.go", Line: 2091, Expr: "libcfn_mmap(...)", Kind: "func-value or unknown callee"},
	{Entry: "munmapRegion", File: "xpc.highlevel.gen.go", Line: 2106, Expr: "libcfn_munmap(...)", Kind: "func-value or unknown callee"},
	{Entry: "newListener", File: "xpc.highlevel.gen.go", Line: 1005, Expr: "incoming(...)", Kind: "func-value or unknown callee"},
	{Entry: "newRequirement", File: "xpc.highlevel.gen.go", Line: 608, Expr: "create(...)", Kind: "func-value or unknown callee"},
	{Entry: "targetQueuePointer", File: "xpc.highlevel.gen.go", Line: 439, Expr: "queue.Handle(...)", Kind: "unresolved receiver type"},
	{Entry: "xpcCancelTrampoline", File: "xpc.highlevel.gen.go", Line: 2469, Expr: "handler(...)", Kind: "func-value or unknown callee"},
	{Entry: "xpcIncomingTrampoline", File: "xpc.highlevel.gen.go", Line: 2434, Expr: "handler(...)", Kind: "func-value or unknown callee"},
	{Entry: "xpcIncomingTrampoline", File: "xpc.highlevel.gen.go", Line: 2442, Expr: "err.Error(...)", Kind: "unresolved receiver type"},
	{Entry: "xpcIncomingTrampoline", File: "xpc.highlevel.gen.go", Line: 2447, Expr: "encErr.Error(...)", Kind: "unresolved receiver type"},
	{Entry: "xpcReplyTrampoline", File: "xpc.highlevel.gen.go", Line: 2544, Expr: "reply(...)", Kind: "func-value or unknown callee"},
	{Entry: "xpcReplyTrampoline", File: "xpc.highlevel.gen.go", Line: 2548, Expr: "reply(...)", Kind: "func-value or unknown callee"},
}
